...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `FOCUS` | Главная / тренировка / вопрос | `focus-training.html` | `focus-question.html` | flashcard; MCQ; selected; correct; wrong; explanation; session; empty branches; long/code-heavy | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ◐ | **Parity ✅ (R0.149):** весь state-family live-верифицирован R0.143–149 — MCQ default/selected, post-answer correct/wrong, flashcard-reveal, STUDY learn/check, session-progress, FT-15 long-options, empty-ветки (1+2 live, 3+4 template-edge), error(CSRF); 375→2560, light+dark, a11y, console-clean, 0 overflow. **Final ◐:** остаток DoD #11 (design-swap live) + #12 (zoom200%) → R0.150 свип, затем Final ✅ |
