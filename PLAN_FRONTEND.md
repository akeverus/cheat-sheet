...
| `result.html` | page | ✅ | ✅ | ⏸ | ✅ | ✅ | ✅ | ✅ | ✅ | ◐ | ◐ | ⏸ | ◐ | ◐ | ◐ | ⏸ | Чисто; **R0.126: regenerate-UI (btn+badge) + `.question-side` удалены** (мёртвый AI-путь, app.js v=63/base.css v=94, контракт 10/10); RES-14 снят (код в `.answer`), RES-8 контраст AA все 20; RES-3 favorite=⛔ |
...
| `js/app.js` | script | ✅ | ✅ | ⏸ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ⏸ | ✅ | ◐ | ✅ | ◐ | ✅APP-8 regenerate удалён R0.126 (aria-busy moot); 🌱APP-9 comparison-table th без scope/caption; ⛔APP-5 favorite; **v=63** (regenerate-removal R0.126; был v=62 R0.114) |
