...
- [Vavr User Guide](https://docs.vavr.io/#_introduction) - Руководство пользователя

### См. также
- `../languages/java/java-streams-fp.md` - Java Streams и функциональное программирование
- `../patterns/behavioral/strategy.md` - Функциональные паттерны
...
## Полезные ссылки
- [Официальная документация Vavr](https://docs.vavr.io/)
- [Vavr User Guide](https://docs.vavr.io/#_introduction)
- [GitHub репозиторий](https://github.com/vavr-io/vavr)
- [Vavr Examples](https://github.com/vavr-io/vavr/tree/master/vavr/src/test/java/io/vavr)

## См. также
- [Java Streams](java-basics.md) - Java 8 Streams
- [Functional Programming](patterns.md) - Функциональные паттерны
- [Scala Collections](scala-basics.md) - Scala коллекции
