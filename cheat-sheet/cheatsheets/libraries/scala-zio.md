...
ZIO - это мощная библиотека для функционального программирования в Scala, предоставляющая типобезопасный способ работы с эффектами, ошибками и контекстом. ZIO является альтернативой Cats Effect и других библиотек эффектов.
...
- [ZIO Documentation](https://zio.dev/docs/) - Документация

### См. также
- `../libraries/scala-cats.md` - Cats для функционального программирования
- `../libraries/scala-akka.md` - Akka для конкурентного программирования
...
- [ZIO Examples](https://github.com/zio/zio/tree/master/examples)
