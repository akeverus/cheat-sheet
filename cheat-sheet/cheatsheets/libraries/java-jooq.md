...
### Интеграция
- [Spring Boot jOOQ](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.sql.jooq) - Spring Boot интеграция
...
[⬆️ Наверх](../README.md) | [Предыдущий: MapStruct](../java-mapstruct.md) | [Следующий: HikariCP](../java-hikaricp.md)
