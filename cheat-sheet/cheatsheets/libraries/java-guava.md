...
- [Guava Javadoc](https://guava.dev/releases/snapshot-jre/api/docs/) - API документация
...
- [Guava Gradle](https://github.com/google/guava#gradle) - Gradle настройка
- [Guava with Spring Boot](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.external-config.typesafe-configuration-properties.guava) - Spring Boot интеграция
...
[⬆️ Наверх](../README.md) | [Предыдущий: Lombok](../java-lombok.md) | [Следующий: Apache Commons](../java-apache-commons.md)
