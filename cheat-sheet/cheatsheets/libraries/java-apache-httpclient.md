...
- [Apache HttpClient 5.x](https://hc.apache.org/httpcomponents-client-5.2.x/index.html) - Документация HttpClient 5.x
- [Apache HttpClient 4.x](https://hc.apache.org/httpcomponents-client-4.5.x/index.html) - Документация HttpClient 4.x
...
- [HttpClient Tutorial](https://hc.apache.org/httpcomponents-client-5.2.x/tutorial/html/index.html) - Подробное руководство

### Maven/Gradle
- [Maven Central](https://search.maven.org/artifact/org.apache.httpcomponents.client5/httpclient5) - HttpClient 5.x
- [Maven Central 4.x](https://search.maven.org/artifact/org.apache.httpcomponents/httpclient) - HttpClient 4.x
...
- [Основные HTTP операции](#основные-http-операции)
  - [Простые HTTP запросы](#простые-http-запросы)
  - [Различные HTTP методы](#различные-http-методы)
- [Работа с заголовками и аутентификацией](#работа-с-заголовками-и-аутентификацией)
...
- [Прокси и маршрутизация](#прокси-и-маршрутизация)
  - [Proxy Configuration](#proxy-configuration)
- [Куки и сессии](#куки-и-сессии)
  - [Cookie Management](#cookie-management)
- [Таймауты и конфигурация](#таймауты-и-конфигурация)
...
## Полезные ссылки
- [Официальная документация Apache HttpClient](https://hc.apache.org/httpcomponents-client-5.2.x/index.html)
- [HttpClient 4.x документация](https://hc.apache.org/httpcomponents-client-4.5.x/index.html)
- [GitHub репозиторий](https://github.com/apache/httpcomponents-client)
- [Migration Guide](https://hc.apache.org/httpcomponents-client-5.2.x/migration-guide/index.html)

## См. также
- [OkHttp](java-okhttp.md) - Альтернативный HTTP клиент
- [Retrofit](java-retrofit.md) - Type-safe HTTP клиент
- [WebClient](spring-webflux.md) - Reactive HTTP клиент
