...
- [Retrofit Documentation](https://square.github.io/retrofit/) - Документация

### См. также
- `../libraries/java-okhttp.md` - OkHttp для HTTP запросов
...
- [Gson](java-gson.md) - JSON библиотека для Retrofit
- [RxJava](libraries.md) - Реактивное программирование
