...
- [kotlinx.serialization API](https://kotlinlang.org/api/kotlinx.serialization/) - API документация

### См. также
- `../libraries/jackson.md` - Jackson для JSON
- `../libraries/java-gson.md` - Gson для JSON
- `../libraries/java-protobuf.md` - Protobuf
...
- [Форматы сериализации](#форматы-сериализации)
  ...
  - [HOCON](#hocon)
- [Конфигурация сериализации](#конфигурация-сериализации)
...
- [Serialization Samples](https://github.com/Kotlin/kotlinx.serialization/tree/master/examples)
- [Kotlin Blog - Serialization](https://blog.jetbrains.com/kotlin/category/serialization/)

## См. также
- [Kotlin Basics](kotlin-basics.md) - Основы Kotlin
- [Jackson](jackson.md) - Альтернативная сериализация
- [Gson](java-gson.md) - Другая JSON библиотека
