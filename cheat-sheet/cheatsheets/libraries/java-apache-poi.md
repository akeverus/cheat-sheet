...
### См. также
- `../libraries/java-apache-commons.md` - Apache Commons для работы с файлами
...
- [POI Quick Guide](https://poi.apache.org/components/index.html)
- [GitHub репозиторий](https://github.com/apache/poi)
- [POI Examples](https://github.com/apache/poi/tree/trunk/poi-examples)

## См. также
- [Jackson](jackson.md) - JSON сериализация
- [OpenCSV](libraries.md) - CSV обработка
- [Spring Batch](spring-batch.md) - Пакетная обработка
