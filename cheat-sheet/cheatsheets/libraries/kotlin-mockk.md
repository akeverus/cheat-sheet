...
- [MockK Documentation](https://mockk.io/) - Документация

### См. также
- `../libraries/java-mockito.md` - Mockito для Java
- `../testing/unit-testing/mockk.md` - Unit тестирование с MockK
...
- [AssertJ](testing/assertj.md) - Assertions для тестов
