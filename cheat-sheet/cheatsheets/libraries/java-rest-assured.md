...
- [REST Assured Documentation](https://github.com/rest-assured/rest-assured/wiki/Usage) - Документация

### См. также
- `../testing/integration-testing/rest-assured.md` - Интеграционное тестирование
- `../libraries/java-wiremock.md` - WireMock для мокирования API
...
- [Spring Boot интеграция](https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#testing)
- [Hamcrest matchers](testing/hamcrest.md)

## См. также
- [WireMock](java-wiremock.md) - для mock-серверов
- [Testcontainers](java-testcontainers.md) - для интеграционных тестов
- [JUnit Advanced](testing/junit-advanced.md) - для unit тестирования
