...
- [OpenTelemetry Java](https://opentelemetry.io/docs/java/) - Java документация
- [OpenTelemetry GitHub](https://github.com/open-telemetry) - Репозиторий проекта

### Интеграция
- [Spring Boot OpenTelemetry](https://opentelemetry.io/docs/java/spring-boot-starter/) - Spring Boot starter
- [Micrometer Bridge](https://opentelemetry.io/docs/java/micrometer/) - Интеграция с Micrometer
...
- [Context Propagation](#context-propagation-1)
...
[⬆️ Наверх](../README.md) | [Предыдущий: Micrometer](../java-micrometer.md) | [Следующий: Spring Cloud Sleuth](../java-spring-cloud-sleuth.md)
