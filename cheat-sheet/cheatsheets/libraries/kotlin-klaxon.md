...
- [Kotlin JSON Libraries Comparison](https://blog.jetbrains.com/kotlin/2020/10/kotlinx-datetime-0-1-0-released/)

## См. также
- [kotlinx.serialization](kotlin-kotlinx-serialization.md) - Официальная Kotlin сериализация
- [Gson](java-gson.md) - Google JSON библиотека
- [Jackson](jackson.md) - Jackson JSON процессор
