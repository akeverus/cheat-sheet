...
### Интеграция
- [Spring Boot MapStruct](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.external-config.typesafe-configuration-properties.guava) - Spring Boot интеграция
...
[⬆️ Наверх](../README.md) | [Предыдущий: Apache Commons](../java-apache-commons.md) | [Следующий: jOOQ](../java-jooq.md)
