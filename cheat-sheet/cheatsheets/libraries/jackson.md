...
### Интеграция
- [Spring Boot Jackson](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.json) - Spring Boot интеграция
- [Jackson Modules](https://github.com/FasterXML/jackson#modules) - Список модулей
- [Jackson Annotations](https://github.com/FasterXML/jackson-annotations) - Аннотации
...
[⬆️ Наверх](../README.md) | [Следующий: Lombok](../java-lombok.md)
