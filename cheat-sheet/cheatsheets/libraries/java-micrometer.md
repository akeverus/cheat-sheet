...
### Интеграция
- [Spring Boot Micrometer](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.observability) - Spring Boot интеграция
- [Micrometer Registry](https://micrometer.io/docs/concepts#_meter_registries) - Реестры метрик
...
Micrometer — это современная и мощная библиотека для создания и экспорта метрик в Java приложениях. Она обеспечивает vendor-neutral подход к мониторингу и поддерживает большинство популярных систем мониторинга.
...
[⬆️ Наверх](../README.md) | [Предыдущий: Resilience4j](../java-resilience4j.md) | [Следующий: OpenTelemetry](../java-opentelemetry.md)
