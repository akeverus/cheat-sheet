...
### Интеграция
- [Spring Boot Resilience4j](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.external-config.typesafe-configuration-properties.guava) - Spring Boot интеграция
- [Micrometer Integration](https://resilience4j.readme.io/docs/micrometer) - Метрики
- [Examples](https://github.com/resilience4j/resilience4j-spring-boot2-demo) - Примеры
...
[⬆️ Наверх](../README.md) | [Предыдущий: HikariCP](../java-hikaricp.md) | [Следующий: Micrometer](../java-micrometer.md)
