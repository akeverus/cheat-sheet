...
- [Lombok Features](https://projectlombok.org/features/index.html) - Список всех аннотаций
- [Lombok GitHub](https://github.com/projectlombok/lombok) - Репозиторий проекта

### Интеграция
- [Spring Boot Lombok](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features.developer-tools.lombok) - Spring Boot интеграция
...
- [Getter и Setter](#getter-и-setter)
  - [@Getter и @Setter](#getter-и-setter-1)
...
Lombok — это мощный инструмент для сокращения boilerplate кода в Java проектах. Он значительно улучшает читаемость и поддерживаемость кода, позволяя разработчикам сосредоточиться на бизнес-логике.
...
[⬆️ Наверх](../README.md) | [Предыдущий: Jackson](../jackson.md) | [Следующий: Guava](../java-guava.md)
