...
## Полезные ссылки
- [Официальная документация Kodein](https://kodein.org/)
- [Kodein GitHub](https://github.com/kosi-libs/Kodein)
- [Kodein Samples](https://github.com/kosi-libs/Kodein/tree/main/samples)
- [DI Principles](https://kodein.org/di/core/principles/)

## См. также
- [Dagger](libraries.md) - DI для Java
- [Koin](libraries.md) - DI для Kotlin
- [Guice](libraries.md) - DI для Java
