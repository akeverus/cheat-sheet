...
### См. также
- `../libraries/java-vavr.md` - Vavr для функционального программирования в Java
- `../libraries/kotlin-kotlinx-coroutines.md` - Kotlin Coroutines
...
## См. также
- [Kotlin Coroutines](kotlin-coroutines.md) - Асинхронное программирование в Kotlin
- [Functional Programming](kotlin-fp-basics.md) - Функциональное программирование в Kotlin
- [Railway Oriented Programming](patterns.md) - Паттерны для обработки ошибок
