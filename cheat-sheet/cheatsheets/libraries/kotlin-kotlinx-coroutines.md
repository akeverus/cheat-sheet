...
### См. также
- `../languages/kotlin/kotlin-coroutines.md` - Kotlin Coroutines в языке
- `../libraries/kotlin-arrow.md` - Arrow для функционального программирования
...
- [Reactive Programming](patterns.md) - Реактивные паттерны
- [Async Programming](java-basics.md) - Асинхронное программирование в Java
