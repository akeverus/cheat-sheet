...
- [GraphQL Foundation](https://graphql.org/) - Основной сайт GraphQL
- [GraphQL Java](https://www.graphql-java.com/) - Java реализация GraphQL

### Java интеграции
- [Spring GraphQL](https://docs.spring.io/spring-graphql/docs/current/reference/html/) - Spring Boot интеграция
- [GraphQL Java Tools](https://github.com/graphql-java-kickstart/graphql-java-tools) - Schema-first approach
- [Netflix DGS](https://netflix.github.io/dgs/) - Domain Graph Service

### Клиентские библиотеки
- [Apollo Client](https://www.apollographql.com/docs/react/) - React/Vue clients
- [GraphQL Request](https://github.com/jasonkuhrt/graphql-request) - Simple JS client
- [Spring WebClient](https://docs.spring.io/spring/docs/current/reference/html/web-reactive.html) - Reactive HTTP client

### Best practices
- [GraphQL Best Practices](https://graphql.org/learn/best-practices/) - Официальные рекомендации
- [GraphQL Schema Design](https://www.apollographql.com/docs/technotes/schema-design/) - Дизайн схем
- [Security Best Practices](https://www.apollographql.com/docs/apollo-server/security/security-checklist/) - Безопасность

### См. также
- `api/rest-api-design.md` - REST API дизайн
- `api/grpc.md` - gRPC
- `frameworks/spring/spring-graphql.md` - Spring GraphQL интеграция
- `databases/postgres/` - Базы данных для GraphQL
- `monitoring/observability.md` - Мониторинг GraphQL API
...
#### Federation setup
```java
// Subgraph schema for User service
@Configuration
