...
### Baeldung
- [REST API Design](https://www.baeldung.com/rest-with-spring-series)

### См. также
- `../api/graphql.md` - GraphQL
- `../api/grpc.md` - gRPC
- `../spring/spring-rest.md` - Spring REST
...
- **HEAD**: Безопасен
- **OPTIONS**: Безопасен
- **POST/PUT/PATCH/DELETE**: Не безопасны
...
3. **Дизайн URI иерархично** - `/users/123/posts` вместо `/posts?userId=123`
