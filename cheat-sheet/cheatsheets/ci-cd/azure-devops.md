...
- [Azure DevOps GitHub](https://github.com/microsoft/azure-devops-cli-extension)

## См. также
- [Jenkins](ci-cd/jenkins.md) - Альтернативная CI/CD платформа
- [GitLab CI](ci-cd/gitlab-ci.md) - GitLab CI/CD
- [GitHub Actions](ci-cd/github-actions.md) - CI/CD в GitHub
- [Azure](cloud/azure-basics.md) - Microsoft Azure
