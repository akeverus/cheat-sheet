...
GitLab CI/CD - это встроенная система continuous integration и continuous delivery в GitLab. Она позволяет автоматизировать процесс сборки, тестирования и развертывания приложений с помощью YAML конфигурации. Этот документ охватывает enterprise-grade паттерны, продвинутые pipeline конфигурации и best practices для использования GitLab CI/CD в production средах.
...
## См. также
- [Jenkins](ci-cd/jenkins.md) - Альтернативная CI/CD платформа
- [GitHub Actions](ci-cd/github-actions.md) - CI/CD в GitHub
- [Docker](containers/docker-basics.md) - Контейнеризация
- [Kubernetes](devops/kubernetes-advanced.md) - Оркестрация контейнеров
