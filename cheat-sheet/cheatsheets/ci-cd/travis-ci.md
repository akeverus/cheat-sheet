...
### Миграция с Travis CI .org на .com
```bash
...
## См. также
- [Jenkins](ci-cd/jenkins.md) - Self-hosted CI/CD
- [GitLab CI](ci-cd/gitlab-ci.md) - GitOps CI/CD
- [GitHub Actions](ci-cd/github-actions.md) - GitHub CI/CD
- [CircleCI](ci-cd/circleci.md) - Cloud CI/CD
- [Azure DevOps](ci-cd/azure-devops.md) - Enterprise CI/CD
