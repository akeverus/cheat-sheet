...
- [Linux Kernel Documentation](https://www.kernel.org/doc/) - Документация ядра Linux

### Baeldung
- [Operating System Concepts](https://www.baeldung.com/cs/os-concepts) - Основные концепции ОС

### См. также
- `../computer-science/README.md` - Computer Science основы
