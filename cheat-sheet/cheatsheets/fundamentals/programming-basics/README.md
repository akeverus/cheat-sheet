...
- [Java Language Specification](https://docs.oracle.com/javase/specs/jls/se21/html/index.html) - Спецификация языка Java
...
- `../algorithms/README.md` - Алгоритмы и структуры данных
