...
- [Computer Science Field Guide](https://csfieldguide.org.nz/) - Интерактивное руководство по CS

### Baeldung
- [Introduction to Computer Science](https://www.baeldung.com/cs/computer-science-intro) - Введение в Computer Science

### См. также
- `../programming-basics/README.md` - Базовые концепции программирования
- `../networks/README.md` - Компьютерные сети
- `../operating-systems/README.md` - Операционные системы
...
- [Компьютерные сети](#компьютерные-теоретические-основы-сетей)
