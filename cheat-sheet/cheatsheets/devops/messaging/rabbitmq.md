...
- [AMQP 0-9-1 Protocol](https://www.rabbitmq.com/amqp-0-9-1-reference.html) - Спецификация AMQP протокола
- [RabbitMQ Tutorials](https://www.rabbitmq.com/tutorials/tutorial-one-java.html) - Java туториалы

### Java интеграции
- [Spring AMQP](https://docs.spring.io/spring-amqp/docs/current/reference/html/) - Spring Boot интеграция
- [RabbitMQ Java Client](https://www.rabbitmq.com/java-client.html) - Официальный Java клиент
- [Spring Cloud Stream](https://docs.spring.io/spring-cloud-stream/docs/current/reference/html/) - Reactive streams

### Мониторинг и инструменты
- [RabbitMQ Management Plugin](https://www.rabbitmq.com/management.html) - Web-интерфейс управления
...
- `api/grpc.md` - gRPC
- `messaging/kafka.md` - Kafka для high-throughput
- `frameworks/spring/spring-amqp.md` - Spring AMQP интеграция
- `monitoring/observability.md` - Мониторинг RabbitMQ
