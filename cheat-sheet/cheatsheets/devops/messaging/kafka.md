...
### Java интеграции
- [Spring Kafka](https://docs.spring.io/spring-kafka/docs/current/reference/html/) - Spring Boot интеграция
- [Kafka Java Client](https://kafka.apache.org/30/javadoc/index.html) - Java клиент Kafka
- [Kafka Streams JavaDoc](https://kafka.apache.org/30/javadoc/org/apache/kafka/streams/package-summary.html) - Streams API

### Книги и ресурсы
- [Kafka: The Definitive Guide](https://www.confluent.io/resources/kafka-the-definitive-guide/) - Классическая книга по Kafka
- [Designing Event-Driven Systems](https://www.confluent.io/designing-event-driven-systems/) - Архитектура event-driven систем
- [Kafka Summit](https://www.kafka-summit.org/) - Конференция по Kafka
...
- [Kafka Manager](https://github.com/yahoo/kafka-manager) - Web-интерфейс для управления
- [Burrow](https://github.com/linkedin/Burrow) - Consumer lag мониторинг

### См. также
- `api/rest-api-design.md` - REST API дизайн
- `api/grpc.md` - gRPC
- `messaging/rabbitmq.md` - RabbitMQ
- `frameworks/spring/spring-kafka.md` - Spring Kafka интеграция
- `databases/postgres/` - Базы данных для Kafka
- `monitoring/observability.md` - Мониторинг Kafka
...
- [Kafka Java Producer](#kafka-java-producer)
- [Kafka Java Consumer](#kafka-java-consumer)
- [Spring Kafka интеграция](#spring-kafka-интеграция)
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        for (Map<String, Object> event : events) {
            SourceRecord record = new SourceRecord(
                ...
                null,                              // target partition (let Kafka decide)
