...
- [BuildKit](https://docs.docker.com/develop/buildx/)
- [Docker Compose](https://docs.docker.com/compose/)
- [Docker Swarm](https://docs.docker.com/engine/swarm/)

## См. также
- [Kubernetes](devops/kubernetes-advanced.md) - Оркестрация контейнеров
- [Terraform](devops/terraform.md) - Инфраструктура как код
- [Ansible](devops/ansible.md) - Конфигурационное управление
