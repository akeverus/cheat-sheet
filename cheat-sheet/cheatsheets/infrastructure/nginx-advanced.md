...
- [Nginx Modules Reference](https://nginx.org/en/docs/http/ngx_http_core_module.html)
...
- [Prometheus](monitoring/prometheus.md) - Мониторинг
- [HAProxy](infrastructure/haproxy-advanced.md) - Альтернативный load balancer
