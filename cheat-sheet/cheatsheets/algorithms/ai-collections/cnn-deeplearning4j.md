...
- [Введение в CNN](#�-ведение-в-cnn)
- [Архитектура CNN](#�-�-�-и�-ек�-�-�-а-cnn)
- [Сверточные слои](#�-ве�-�-о�-н�-е-�-лои)
- [Слои подвыборки (пула)](#�-лои-подв�-бо�-ки-п�-ла)
- [Плотные слои](#�-ло�-н�-е-�-лои)
- [Оптимизация и обучение](#�-п�-имиза�-ия-и-об�-�-ение)
- [Java Implementation](#java-implementation)
  - [Подготовка данных](#�-одго�-овка-данн�-�)
