...
- [Slope One Algorithm](https://en.wikipedia.org/wiki/Slope_One)

### См. также
- [Машинное обучение](./spark-mllib.md)
- [Алгоритмы оптимизации](../problems/)

## Содержание

- [Обзор](#обзор)
- [Что такое Collaborative Filtering?](#что-такое-collaborative-filtering)
- [Алгоритм Slope One](#алгоритм-slope-one)
- [Java Implementation](#java-implementation)
- [Kotlin Implementation](#kotlin-implementation)
- [Модель данных](#модель-данных)
- [Расчет матрицы различий](#расчет-матрицы-различий)
- [Прогнозирование рейтингов](#прогнозирование-рейтингов)
