...
- [Atomic Variables in Java](https://docs.oracle.com/javase/tutorial/essential/concurrency/atomicvars.html)
- [ConcurrentLinkedQueue JavaDoc](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedQueue.html)

### См. также
- [Временная сложность коллекций](./collections-complexity.md)
- [Многопоточность в Java](../java/java-concurrency-basics.md)
...
- [Операция сравнения и замены (CAS)](#операция-сравнения-и-замены-cas)
...
### Операция сравнения и замены (CAS)
