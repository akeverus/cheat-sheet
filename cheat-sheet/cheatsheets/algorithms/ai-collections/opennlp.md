...
### См. также
- [Обработка естественного языка](./ai-libraries.md)
...
- [Обнаружение предложений](#обнаружение-предложений)
...
Apache OpenNLP - это мощный инструмент для обработки естественного языка в Java, который позволяет быстро добавлять NLP-функциональность в приложения.
