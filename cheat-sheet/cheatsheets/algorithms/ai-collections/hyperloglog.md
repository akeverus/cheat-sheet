...
- [HLL Library GitHub](https://github.com/aggregateknowledge/hll)

### См. также
- [Практические примеры Big O](./collections-big-o.md)
- [Временная сложность коллекций](./collections-complexity.md)
...
HyperLogLog - это мощный инструмент для работы с большими данными, когда точная кардинальность не критична, но важна экономия памяти.
