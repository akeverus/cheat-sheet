...
A guide to identifying credit card types using regular expressions and validating card numbers using the Luhn algorithm in Java.
...
- [ISO/IEC 7812 - Identification cards](https://www.iso.org/standard/70483.html)
- [Luhn Algorithm - Wikipedia](https://en.wikipedia.org/wiki/Luhn_algorithm)

### See Also
- [Regular Expressions](../strings/regular-expressions.md)
