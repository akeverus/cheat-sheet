...
## См. также
- [Gradle Advanced](build-tools/gradle-advanced.md) - Альтернативная система сборки
- [Spring Boot](frameworks/java-frameworks/spring-boot.md) - Java фреймворк
- [Jenkins](devops/jenkins.md) - CI/CD сервер
- [GitHub Actions](devops/github-actions.md) - CI/CD платформа