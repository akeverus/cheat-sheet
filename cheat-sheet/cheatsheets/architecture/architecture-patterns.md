...
## См. также
- [Microservices](architecture/microservices.md) - Микросервисная архитектура
...
- [Event Sourcing](architecture/event-sourcing.md) - Event Sourcing паттерн
- [DDD](architecture/ddd.md) - Domain-Driven Design
