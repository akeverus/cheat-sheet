...
- [Java Enum](https://docs.oracle.com/javase/8/docs/api/java/lang/Enum.html)
- [Java State Pattern in JDK](https://docs.oracle.com/javase/8/docs/api/java/lang/Thread.State.html)

### См. также
- `../../java/java-concurrency.md` - Java Concurrency
- `../../frameworks/java-frameworks/spring/spring-state-machine.md` - Spring State Machine
...
│  └─────────────────────────────────────────────────────┘    │
│                                                             │
│  // Делегирует запросы текущему объекту State               │
└─────────────────────────────────────────────────────────────┼─┘
                                                              │
┌─────────────────────────────────────────────────────────────┼─┐
│                     State                                 │ │
...
│  │  // ассоциированного с конкретным состоянием Context   │    │ │
│  └─────────────────────────────────────────────────────┘    │ │
└─────────────────────────────────────────────────────────────┘
                                                              │
┌─────────────────────────────────────────────────────────────┼─┐
...
│  │           handle()                                 │    │ │
│  │                                                     │    │ │
│  │  // Реализует поведение, ассоциированное с          │    │ │
│  │  // состоянием Context                               │    │ │
│  └─────────────────────────────────────────────────────┘    │ │
└─────────────────────────────────────────────────────────────┘
                                                              │
...
│  context.request()  // Поведение зависит от текущего State │ │
│                                                             │ │
└─────────────────────────────────────────────────────────────┘
```
