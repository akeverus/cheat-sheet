...
- [Java Collections.sort()](https://docs.oracle.com/javase/8/docs/api/java/util/Collections.html#sort-java.util.List-java.util.Comparator-)

### См. также
- `../../java/java-collections.md` - Java Collections
- `../../java/java-stream-api.md` - Stream API
...
│  └─────────────────────────────────────────────────────┘    │
│                                                             │
│  // Делегирует работу объекту Strategy                      │
└─────────────────────────────────────────────────────────────┼─┘
                                                              │
┌─────────────────────────────────────────────────────────────┼─┐
│                     Strategy                               │ │
...
│  │           algorithmInterface()                     │    │ │
│  │                                                     │    │ │
│  │  // Реализует алгоритм, используя интерфейс Strategy │    │ │
│  └─────────────────────────────────────────────────────┘    │ │
└─────────────────────────────────────────────────────────────┘
```
...
class Lz4CompressionStrategy implements CompressionStrategy {
    ...
    public byte[] compress(byte[] data) {
        ...
        // LZ4 compression logic with level
        return data; // placeholder
    }
