...
- [Java Adapter Pattern](https://docs.oracle.com/javase/8/docs/api/java/util/Collections.html)
- [Java Streams Adapters](https://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html)
