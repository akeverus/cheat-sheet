...
- [Java I/O Streams](https://docs.oracle.com/javase/8/docs/api/java/io/package-summary.html)
- [Java Collections Unmodifiable](https://docs.oracle.com/javase/8/docs/api/java/util/Collections.html#unmodifiableList-java.util.List-)

### См. также
- `adapter.md` - Adapter Pattern
- `../../frameworks/java-frameworks/spring/spring-aop.md` - Spring AOP
- `../../java/java-io.md` - Java I/O
