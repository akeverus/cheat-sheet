...
- [Java Factory Pattern](https://docs.oracle.com/javase/8/docs/api/java/util/ServiceLoader.html)
- [Spring FactoryBean](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/beans/factory/FactoryBean.html)

### См. также
- `abstract-factory.md` - Abstract Factory Pattern
