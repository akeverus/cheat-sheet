...
- [Java Builder Pattern](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuilder.html)
- [Effective Java - Item 2](https://www.amazon.com/Effective-Java-Joshua-Bloch/dp/0134685997)

### См. также
- `factory-method.md` - Factory Method Pattern
- `../../frameworks/java-frameworks/spring/spring-configuration.md` - Spring Configuration
