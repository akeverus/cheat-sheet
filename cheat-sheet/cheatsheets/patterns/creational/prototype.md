...
- [Java Object.clone()](https://docs.oracle.com/javase/8/docs/api/java/lang/Object.html#clone())

### См. также
- `../../java/java-basics.md` - Java Basics
- `../../java/java-memory-model.md` - Java Memory Model
- `factory-method.md` - Factory Method Pattern
...
Prototype паттерн — мощный инструмент для оптимизации создания объектов. Он позволяет избежать дорогостоящей инициализации путем клонирования существующих экземпляров.
