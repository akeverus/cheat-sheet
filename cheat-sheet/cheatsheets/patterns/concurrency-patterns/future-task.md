# Future/Task Pattern (Будущие задачи)
...
- `../producer-consumer.md` - Producer-Consumer Pattern
- `../../java/java-async.md` - Asynchronous Programming
...
│  // Продолжаем работу без блокировки                     │ │
│  // ...                                                   │ │
│  if (future.isDone()) {                                    │ │
│    Result result = future.get(); // Получаем результат    │ │
│  }                                                         │ │
└─────────────────────────────────────────────────────────────┼─┘
                                                              │
┌─────────────────────────────────────────────────────────────┼─┐
