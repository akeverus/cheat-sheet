...
```yaml
# MirrorMaker 2.0 для репликации между кластерами
...
## См. также
- [RabbitMQ](messaging/rabbitmq.md) - Альтернативная система сообщений
- [Spring Kafka](spring-kafka.md) - Spring интеграция
- [Kafka Connect](connect/kafka-connect.md) - ETL для Kafka
- [Monitoring](monitoring/prometheus.md) - Мониторинг инфраструктуры
