...
- [Java NATS Client](https://github.com/nats-io/nats.java)
- [NATS by Example](https://natsbyexample.com/)

## См. также
- [RabbitMQ](messaging/rabbitmq.md) - Надежная система сообщений
- [Kafka](messaging/kafka.md) - Потоковая обработка данных
- [Spring Cloud Stream](frameworks/spring-cloud-stream.md) - Облачные стримы
