...
## См. также
- [Kafka](messaging/kafka.md) - Альтернативная система сообщений
- [Spring Integration](frameworks/spring-integration.md) - Интеграционные паттерны
- [Monitoring](monitoring/prometheus.md) - Система мониторинга
