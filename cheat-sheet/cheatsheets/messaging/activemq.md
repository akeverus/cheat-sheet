...
- [ActiveMQ Configuration](https://activemq.apache.org/components/cms/config-reference)

## См. также
- [RabbitMQ](rabbitmq.md) - Альтернативный message broker
- [Kafka](kafka.md) - High-throughput messaging
- [NATS](nats.md) - Cloud-native messaging
- [JMS](jms.md) - Java Message Service
- [Message Queue Patterns](message-queue-patterns.md) - Паттерны обмена сообщениями