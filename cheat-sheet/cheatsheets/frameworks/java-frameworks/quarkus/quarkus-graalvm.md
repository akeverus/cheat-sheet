...
tags: ["quarkus", "graalvm", "native-image", "compilation", "optimization", "java"]
...
- [Native Image Best Practices](https://www.graalvm.org/latest/reference-manual/native-image/guides/)
- [GraalVM Native Image Configuration](https://www.graalvm.org/latest/reference-manual/native-image/overview/BuildConfiguration/)
