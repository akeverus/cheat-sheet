...
- [Spring Batch Documentation](https://docs.spring.io/spring-batch/docs/current/reference/html/) - Полная документация Spring Batch
...
- [Batch Processing with Spring Batch](https://www.apress.com/gp/book/9781484236966) - Современное руководство
- [Pro Spring Batch](https://www.apress.com/gp/book/9781430234523) - Профессиональное руководство

### Статьи и туториалы
- [Spring Batch Tutorial](https://spring.io/guides/gs/batch-processing/) - Официальный туториал
- [Spring Batch Best Practices](https://docs.spring.io/spring-batch/docs/current/reference/html/best-practices.html) - Лучшие практики
- [Spring Batch Performance Tuning](https://docs.spring.io/spring-batch/docs/current/reference/html/scaling-and-parallel-processing.html) - Производительность

### См. также
- `frameworks/spring/spring-boot.md` - Spring Boot основы
- `databases/postgres/` - Базы данных для batch processing
- `monitoring/observability.md` - Мониторинг batch jobs
- `frameworks/spring/spring-integration.md` - Интеграция с другими системами
