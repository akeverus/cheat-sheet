...
- `../spring/spring-boot.md` - Spring Boot основы
- `../monitoring/observability.md` - мониторинг микросервисов
...
9. **Используйте @LoadBalanced** для автоматического load balancing
