...
### Baeldung
- [Hibernate Tutorials](https://www.baeldung.com/hibernate)
...
- [Hibernate Performance](https://hibernate.org/orm/performance/)
...
- `../spring/spring-data-jpa.md` — Spring Data JPA основы
- `../spring/spring-boot.md` — Spring Boot интеграция
- `../databases/postgres-basics.md` — Работа с PostgreSQL
- `../build-tools/maven.md` — Система сборки Maven