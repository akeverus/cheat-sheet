...
- Bean Definition и BeanFactory.getBean()
...
- Ahead-of-Time (AOT) compilation в Spring 6
...
3. **Используйте @Configuration вместо @Component** для конфигурационных классов
4. **Избегайте циклических зависимостей**
5. **Правильно выбирайте scope бинов**
6. **Используйте @Qualifier** для разрешения неоднозначности
...
4. **Использование @Configuration** для конфигурационных классов
