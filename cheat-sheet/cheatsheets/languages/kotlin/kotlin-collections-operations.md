...
- [Kotlin Collection Operations](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/)
...
- `./kotlin-collections-set.md` - множества (Set)
- `./kotlin-collections-map.md` - словари (Map)
- `./kotlin-collections-sequences.md` - последовательности (Sequences)
- `./kotlin-collections-grouping.md` - группировка и агрегация
