...
- [Kotlin Performance](https://kotlinlang.org/docs/jvm-performance.html)
- [Kotlin Inline Functions](https://kotlinlang.org/docs/inline-functions.html)

### Baeldung
- [Kotlin Performance Tips](https://www.baeldung.com/kotlin/performance)

### См. также
- `./kotlin-basics.md` - основы Kotlin
- `./kotlin-concurrency-basics.md` - корутины
- `../java/java-performance.md` - производительность Java
