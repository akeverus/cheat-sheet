...
Sealed классы и интерфейсы - это мощный инструмент Kotlin для создания типобезопасных ограниченных иерархий типов. Они обеспечивают compile-time проверку полноты when-выражений, что помогает избежать ошибок и делает код более надежным.
...
- [Kotlin Sealed Interfaces](https://kotlinlang.org/docs/sealed-classes.html#sealed-interfaces-and-sealed-classes)
