...
- [Kotlin Grouping API](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-grouping/)
...
- `./kotlin-collections-map.md` - словари (Map)
...
val movingAvg = movingAverage(prices, 3)  // [101.0, 102.0, 103.0, 104.0, 105.0]
...
val product = numbers.accumulate(1) { acc, value -> acc * value }  // 120
