...
Shapeless - это мощная библиотека для generic программирования в Scala, которая позволяет работать с типами на уровне компиляции. Она предоставляет инструменты для автоматической деривации типов, преобразования между типами, работы с HList и создания type-level вычислений.
...
Shapeless - это мощная библиотека для generic программирования в Scala, которая позволяет работать с типами на уровне компиляции. Понимание HList, Generic, Lens, type-level вычислений, автоматической деривации типов, преобразования между типами, копирования с изменениями и их практических применений позволяет создавать типобезопасный, автоматически генерируемый код.
...
- [Type Astronaut's Guide to Shapeless](https://books.underscore.io/shapeless-guide/shapeless-guide.html)
