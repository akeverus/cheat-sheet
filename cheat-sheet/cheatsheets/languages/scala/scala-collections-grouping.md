...
- `./scala-collections-operations.md` - операции над коллекциями
...
- [Scala Collections Documentation](https://docs.scala-lang.org/overviews/collections-2.13/introduction.html)
- [Scala Collections API - groupBy](https://www.scala-lang.org/api/current/scala/collection/Iterable.html#groupBy[K](f:A=%3EK):scala.collection.immutable.Map[K,Repr])
