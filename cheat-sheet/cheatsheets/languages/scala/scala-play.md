...
tags: ["scala", "play", "web-framework", "http", "rest-api"]
...
- `./scala-slick.md` - работа с базами данных
...
Маршруты определяются в файле `conf/routes`:
...
Play Framework предоставляет мощный инструментарий для создания веб-приложений в Scala. Понимание маршрутизации, контроллеров, форм, работы с базами данных, асинхронной обработки, middleware, сессий, тестирования и создания REST API позволяет создавать масштабируемые и поддерживаемые веб-приложения. WebSockets, Dependency Injection, шаблоны, работа с файлами, интернационализация, безопасность, развертывание, мониторинг и оптимизация производительности расширяют возможности фреймворка для создания современных веб-приложений.
...
Play Framework предоставляет мощный и гибкий инструментарий для создания современных веб-приложений в Scala. Понимание всех аспектов фреймворка, от базовой маршрутизации и контроллеров до продвинутых тем, таких как WebSockets, Akka интеграция, безопасность, развертывание, мониторинг, Event Sourcing, CQRS, микросервисная архитектура, очереди сообщений, оптимизация производительности, Action Composition, WebSockets для реального времени, создания микросервисов и практических применений позволяет создавать масштабируемые, надежные и поддерживаемые веб-приложения. Play Framework следует принципам функционального программирования и реактивного программирования, что делает его идеальным выбором для создания современных веб-приложений, которые должны обрабатывать множество одновременных запросов, интегрироваться с различными внешними сервисами, обеспечивать реальное время взаимодействие и создавать микросервисную архитектуру.
...
- [Play Framework Documentation](https://www.playframework.com/documentation)
- [Play Framework Tutorial](https://www.playframework.com/documentation/latest/Tutorials)
- [Play Framework Best Practices](https://www.playframework.com/documentation/latest/BestPractices)
- [Play Framework Reactive Streams](https://www.playframework.com/documentation/latest/ReactiveStreams)
- [Play Framework Security](https://www.playframework.com/documentation/latest/SecurityHeaders)
- [Play Framework Testing](https://www.playframework.com/documentation/latest/ScalaTesting)
