...
- [Scala DSL](https://docs.scala-lang.org/overviews/core/implicit-classes.html)

### См. также
- `./scala-basics.md` - основы Scala
- `./scala-implicit.md` - implicit механизм
...
- [Scala DSL Documentation](https://docs.scala-lang.org/overviews/core/implicit-classes.html)
- [Type-Safe Builders in Scala](https://docs.scala-lang.org/overviews/core/implicit-classes.html)
- [Scala DSL Examples](https://github.com/scala/scala/tree/2.13.x/src/library/scala)
