...
### См. также
- `./scala-fp-basics.md` - функциональное программирование
- `./scala-collections.md` - коллекции
...
- [Scala School - For Comprehensions](https://twitter.github.io/scala_school/collections.html#for)
