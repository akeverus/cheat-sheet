...
next: ["scala/scala-reactive-akka-streams.md", "scala/scala-reactive-rxscala.md"]
updated: "2025-01-16"
...
- `./scala-akka.md` - Akka Actors
- `./scala-reactive-akka-streams.md` - Akka Streams детально
- `./scala-reactive-rxscala.md` - RxScala детально
...
- [Reactive Programming Patterns](https://www.reactivedesignpatterns.com/)
