...
- Руководство по PriorityBlockingQueue
- Руководство по SynchronousQueue
- Руководство по TransferQueue
...
**Использование ограниченной очереди -** хороший способ разработки параллельных программ, потому что, когда мы вставляем элемент в уже заполненную очередь, эти операции должны ждать, пока потребители догонят и освободят место в очереди. Это дает нам дросселирование без каких-либо усилий с нашей стороны**.
