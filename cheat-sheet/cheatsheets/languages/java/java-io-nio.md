...
- [Java IO Package](https://docs.oracle.com/javase/8/docs/api/java/io/package-summary.html) - Пакет java.io
- [Java NIO Package](https://docs.oracle.com/javase/8/docs/api/java/nio/package-summary.html) - Пакет java.nio
- [Java NIO.2](https://docs.oracle.com/javase/tutorial/essential/io/index.html) - Современный IO API

### Дополнительные ресурсы
- [Baeldung IO](https://www.baeldung.com/java-io) - Статьи по Java IO
- [Java NIO Tutorial](https://www.baeldung.com/java-nio2-file-api) - Руководство по NIO.2
- [Performance Tuning IO](https://www.oracle.com/technical-resources/articles/javase/perftuning.html) - Оптимизация производительности
...
- [Буферы и каналы](#буферы-и-каналы)
...
**Java IO (Input/Output)** — это набор классов и интерфейсов для работы с потоками данных, файлами и сетевыми соединениями. Java предоставляет три основных подхода к IO:
...
[⬆️ Наверх](../README.md) | [Следующий: Исключения](../java-exceptions.md)
