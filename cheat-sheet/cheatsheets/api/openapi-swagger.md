...
- [OpenAPI 3.0 Guide](https://swagger.io/docs/specification/basic-structure/)
...
- [GraphQL](graphql.md) - Альтернативный подход к API
- [gRPC](grpc.md) - Высокопроизводительные API
- [API Security](security/api-security.md) - Безопасность API
