...
Kubernetes становится стандартом для оркестрации контейнеров в облачных средах. Этот документ охватывает managed Kubernetes сервисы (EKS, AKS, GKE), best practices для cloud-native deployments, multi-cloud стратегии и интеграцию с облачными сервисами. Документ дополняет [Kubernetes Advanced](devops/kubernetes-advanced.md) фокусом на облачные аспекты.
...
## См. также
- [AWS Services](cloud/aws-services.md) - Сервисы AWS
- [Azure Services](cloud/azure-services.md) - Сервисы Azure
- [GCP Services](cloud/gcp-services.md) - Сервисы GCP
- [Kubernetes Advanced](devops/kubernetes-advanced.md) - Kubernetes
- [Istio Service Mesh](devops/kubernetes-service-mesh.md) - Service Mesh
- [Terraform](devops/terraform.md) - Infrastructure as Code
