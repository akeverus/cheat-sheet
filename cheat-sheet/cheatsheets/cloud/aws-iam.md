...
- [Access Analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer.html)
...
- [CloudTrail](cloud/cloudtrail.md) - Аудит и мониторинг
- [KMS](security/kms.md) - Управление ключами
