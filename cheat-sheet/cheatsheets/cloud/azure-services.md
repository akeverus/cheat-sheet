...
## Полезные ссылки
- [Azure Services Documentation](https://docs.microsoft.com/en-us/azure/)
...
- [Azure IAM](azure-iam.md) - Управление доступом
- [Terraform](devops/terraform.md) - Infrastructure as Code
- [Azure Resource Manager](azure-arm.md) - Управление ресурсами