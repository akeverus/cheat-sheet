...
- [Creating Tables](https://clickhouse.com/docs/sql-reference/statements/create/table/)

### Baeldung
- [ClickHouse Table Engines](https://www.baeldung.com/clickhouse-table-engines)

### См. также
- `databases/clickhouse-basics.md` - Основы ClickHouse
- `databases/clickhouse-queries.md` - Работа с данными
...
- [Table Engines](https://clickhouse.com/docs/engines/table-engines/)
- [Data Types](https://clickhouse.com/docs/sql-reference/data-types/)
- [Table Design](https://clickhouse.com/docs/best-practices/table-design)

### Руководства
- [Schema Design](https://clickhouse.com/docs/best-practices/schema-design)
- [Performance Optimization](https://clickhouse.com/docs/best-practices/performance)

### Примеры
- [ClickHouse Examples](https://github.com/ClickHouse/ClickHouse/tree/master/examples)
- [Real-world Schemas](https://github.com/ClickHouse/examples)
