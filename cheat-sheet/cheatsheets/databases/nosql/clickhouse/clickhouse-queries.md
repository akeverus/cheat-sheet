...
- [Query Syntax](https://clickhouse.com/docs/sql-reference/statements/select/)
- [Functions](https://clickhouse.com/docs/sql-reference/functions/)

### Baeldung
- [ClickHouse SQL Queries](https://www.baeldung.com/clickhouse-sql)

### См. также
- `databases/clickhouse-tables.md` - Создание таблиц
- `databases/clickhouse-indexes.md` - Оптимизация запросов
...
- [SQL for Analytics](https://clickhouse.com/docs/best-practices/sql-for-analytics)

### Примеры
- [ClickHouse Examples](https://github.com/ClickHouse/examples)
