...
- [Indexes](https://clickhouse.com/docs/engines/table-engines/mergetree-family/mergetree#table_engine-mergetree-data_skipping-indexes)
- [Partitioning](https://clickhouse.com/docs/engines/table-engines/mergetree-family/custom-partitioning-key)
- [Query Optimization](https://clickhouse.com/docs/best-practices/query-optimization)

### Baeldung
- [ClickHouse Indexing](https://www.baeldung.com/clickhouse-indexing)

### См. также
- `databases/clickhouse-queries.md` - Оптимизация запросов
- `databases/clickhouse-performance.md` - Производительность и мониторинг
...
│ Партиция: 2024-01                   │
│ │                                  │
│ └─ Первичный ключ: date, user_id   │
│    │                               │
│    └─ Вторичные индексы           │
│       (bloom filters, minmax)      │
│                                   │
│ Результат: Чтение только нужных   │
│ блоков данных                     │
└─────────────────────────────────────┘
```
...
### Руководства
- [Index Best Practices](https://clickhouse.com/docs/best-practices/indexing)
- [Partitioning Guide](https://clickhouse.com/docs/best-practices/partitioning)

### Инструменты
- [ClickHouse Benchmark](https://github.com/ClickHouse/ClickHouse/tree/master/benchmark)
