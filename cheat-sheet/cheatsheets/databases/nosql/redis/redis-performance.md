...
- [Redis Benchmarking](https://redis.io/docs/manual/benchmarks/)
...
- [Введение в оптимизацию производительности Redis](#�-ведение-в-оп�-имиза�-и�-п�-оизводи�-ел�-но�-�-и-redis)
  - [Факторы производительности](#�-ак�-о�-�-п�-оизводи�-ел�-но�-�-и)
- [Бенчмаркинг](#�-ен�-ма�-кинг)
