...
- [Redis Monitoring](https://redis.io/docs/manual/optimization/)
...
- [Введение в мониторинг Redis](#�-ведение-в-мони�-о�-инг-redis)
  - [Ключевые метрики для мониторинга](#�-л�-�-ев�-е-ме�-�-ики-для-мони�-о�-инга)
- [Базовые команды мониторинга](#�-азов�-е-команд�-мони�-о�-инга)
