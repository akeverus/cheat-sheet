...
- [Redis RDB](https://redis.io/docs/manual/persistence/#rdb-snapshots)
- [Redis AOF](https://redis.io/docs/manual/persistence/#append-only-file)
...
- [Введение в персистентность Redis](#�-ведение-в-пе�-�-и�-�-ен�-но�-�-�-redis)
  - [Типы персистентности](#�-ип�-пе�-�-и�-�-ен�-но�-�-и)
  - [Выбор стратегии персистентности](#�-�-бо�-�-�-�-а�-егии-пе�-�-и�-�-ен�-но�-�-и)
- [RDB (Redis Database Backup)](#rdb-redis-database-backup)
  - [Настройка RDB](#�-а�-�-�-ойка-rdb)
