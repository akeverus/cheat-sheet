...
- [CQL Data Modeling](https://cassandra.apache.org/doc/latest/cassandra/cql/index.html)
- [Data Modeling Best Practices](https://docs.datastax.com/en/dse/6.8/dse-dev/datamodeling/index.html)

### Дизайн и архитектура
- [Cassandra Data Modeling Guide](https://www.datastax.com/learn/data-modeling)
...
- [KDMG (Cassandra Data Model Generator)](https://github.com/Orange-OpenSource/kdmg)
- [Cassandra Designer](https://cassandra-designer.com/)

### См. также
- `databases/cassandra-basics.md` - Основы Cassandra
- `databases/cassandra-queries.md` - CQL запросы и оптимизация
- `databases/cassandra-clustering.md` - Кластеризация и масштабирование
- `databases/mongodb-design.md` - Сравнение с MongoDB
