...
- [Cassandra Operations](https://cassandra.apache.org/doc/latest/cassandra/operating/index.html)
- [Cassandra Administration](https://docs.datastax.com/en/dse/6.8/dse-admin/index.html)
- [nodetool Documentation](https://cassandra.apache.org/doc/latest/tools/nodetool/nodetool.html)

### Дизайн и эксплуатация
- [Cassandra Production Checklist](https://docs.datastax.com/en/dse/6.8/dse-admin/datastax_enterprise/operations/opsDSE.html)
- [Operational Best Practices](https://docs.datastax.com/en/dse/6.8/dse-admin/datastax_enterprise/operations/opsBestPractice.html)
- [Cassandra Anti-Patterns](https://docs.datastax.com/en/dse-planning/doc/planning/antiPatterns.html)
...
- [Cassandra Logging](https://cassandra.apache.org/doc/latest/cassandra/troubleshooting/logging.html)
...
- [Automation и DevOps](#automation-и-devops)
...
**Следующие шаги:**
1. **Elasticsearch** - начать создание файлов
2. Обновить EXPANSION_PLAN.md
3. Продолжить с другими базами данных
