...
- [Cassandra Query Language (CQL)](https://cassandra.apache.org/doc/cql/)
...
- [Cassandra with Spring Boot](https://www.baeldung.com/spring-data-cassandra-tutorial)
...
### См. также
- `databases/mysql-basics.md` - Сравнение с реляционными базами
- `databases/mongodb-basics.md` - Сравнение с документными базами
- `databases/cassandra-data-modeling.md` - Моделирование данных в Cassandra
...
- `databases/cassandra-clustering.md` - Кластеризация и масштабирование
- `databases/cassandra-performance.md` - Производительность и тюнинг
- `databases/cassandra-admin.md` - Администрирование Cassandra
