...
- [CQL Commands](https://cassandra.apache.org/doc/latest/cassandra/cql/commands.html)
- [Querying Data](https://cassandra.apache.org/doc/latest/cassandra/cql/querying.html)

### Дизайн и оптимизация
- [Query Best Practices](https://docs.datastax.com/en/dse/6.8/dse-dev/datamodeling/bestPractices.html)
- [CQL Performance Tuning](https://docs.datastax.com/en/dse/6.8/dse-admin/datastax_enterprise/tools/toolsPerformance.html)
- [Cassandra Query Patterns](https://www.datastax.com/blog/2015/09/cassandra-query-patterns)

### Инструменты
- [DataStax Studio](https://www.datastax.com/products/datastax-studio)
- [Cassandra Query Language Shell (cqlsh)](https://cassandra.apache.org/doc/latest/tools/cqlsh.html)
- [Cassandra Python Driver](https://docs.datastax.com/en/developer/python-driver/3.25/)

### См. также
- `databases/cassandra-basics.md` - Основы Cassandra
- `databases/cassandra-data-modeling.md` - Моделирование данных
- `databases/cassandra-clustering.md` - Кластеризация и масштабирование
- `databases/cassandra-performance.md` - Производительность и оптимизация
