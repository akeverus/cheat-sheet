...
### Baeldung
- [MongoDB CRUD Operations with Spring Boot](https://www.baeldung.com/spring-data-mongodb-tutorial)

### См. также
- `databases/mongodb/mongodb-basics.md` - Основы MongoDB
- `databases/mongodb/mongodb-queries.md` - Продвинутые запросы
...
- [Write Concern и настройки](#write-concern-и-настройки)
- [Best Practices для CRUD операций](#best-practices-для-crud-операций)
...
## Best Practices для CRUD операций
