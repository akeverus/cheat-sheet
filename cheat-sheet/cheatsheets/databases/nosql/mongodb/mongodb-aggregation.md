...
### Baeldung
- [MongoDB Aggregation Framework](https://www.baeldung.com/mongodb-aggregation)

### См. также
- `databases/mongodb/mongodb-queries.md` - Основы запросов
- `databases/mongodb/mongodb-performance.md` - Оптимизация производительности
