...
- [Index Strategies](https://docs.mongodb.com/manual/core/indexes/index-strategies/)
- [Index Types](https://docs.mongodb.com/manual/core/index-types/)

### Baeldung
- [MongoDB Indexes](https://www.baeldung.com/mongodb-indexes)

### См. также
- `databases/mongodb/mongodb-queries.md` - Оптимизация запросов
- `databases/mongodb/mongodb-performance.md` - Производительность и мониторинг

## Содержание

- [Введение в индексы MongoDB](#введение-в-индексы-mongodb)
- [Типы индексов в MongoDB](#типы-индексов-в-mongodb)
- [Single Field и Compound индексы](#single-field-и-compound-индексы)
- [Multikey индексы](#multikey-индексы)
- [Text индексы](#text-индексы)
- [Geospatial индексы](#geospatial-индексы)
- [Partial индексы](#partial-индексы)
...
- [Best Practices по индексации](#best-practices-по-индексации)
