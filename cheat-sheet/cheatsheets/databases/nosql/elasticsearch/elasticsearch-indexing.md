...
### Инструменты
- [Elasticsearch Bulk Processor](https://www.elastic.co/guide/en/elasticsearch/client/java-api/current/_bulk_processing.html)
- [Logstash](https://www.elastic.co/products/logstash) - ETL инструмент
- [Beats](https://www.elastic.co/products/beats) - Легковесные shippers
