...
- [Spring Boot Elasticsearch](https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#data.nosql.elasticsearch)

### Инструменты и утилиты
- [Kibana](https://www.elastic.co/kibana) - Визуализация и управление
