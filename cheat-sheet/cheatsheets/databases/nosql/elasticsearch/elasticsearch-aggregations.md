...
- [Aggregation Performance](https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-performance.html)
- [Data Visualization](https://www.elastic.co/guide/en/kibana/current/visualize.html)
- [Real-time Analytics](https://www.elastic.co/blog/elasticsearch-as-a-time-series-data-store)

### Инструменты
- [Kibana Lens](https://www.elastic.co/guide/en/kibana/current/lens.html) - Drag-and-drop визуализация
- [Elasticsearch SQL](https://www.elastic.co/guide/en/elasticsearch/reference/current/sql-aggregations.html)
...
- `databases/elasticsearch/elasticsearch-queries.md` - Поиск и запросы
