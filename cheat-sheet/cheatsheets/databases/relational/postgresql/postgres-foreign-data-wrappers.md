...
``````java
// Использование FDW из Java приложения
import java.sql.*;
...
- [Введение в Foreign Data Wrappers](#�-ведение-в-foreign-data-wrappers)
  - [Преимущества FDW](#�-�-еим�-�-е�-�-ва-fdw)
- [Установка и настройка FDW](#�-�-�-ановка-и-на�-�-�-ойка-fdw)
  - [Установка расширения](#�-�-�-ановка-�-а�-�-и�-ения)
