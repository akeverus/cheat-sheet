...
next: ["databases/postgres-high-availability.md", "databases/postgres-backup-restore.md"]
updated: "2026-01-16"
...
- [pg_auto_failover Documentation](https://github.com/citusdata/pg_auto_failover)
...
- [Введение в репликацию PostgreSQL](#�-ведение-в-�-еплика�-и�-postgresql)
  - [Типы репликации](#�-ип�-�-еплика�-ии)
  - [Преимущества репликации](#�-�-еим�-�-е�-�-ва-�-еплика�-ии)
- [Streaming Replication (физическая репликация)](#streaming-replication-�-изи�-е�-кая-�-еплика�-ия)
  - [Архитектура Streaming Replication](#�-�-�-и�-ек�-�-�-а-streaming-replication)
