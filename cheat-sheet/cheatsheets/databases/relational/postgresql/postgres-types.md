...
- [PostgreSQL Advanced Data Types](https://www.postgresqltutorial.com/postgresql-data-types/)
- [JSONB Performance Tips](https://www.citusdata.com/blog/2016/07/14/choosing-nosql-hstore-json-jsonb/)
- [Full Text Search Tutorial](https://www.postgresqltutorial.com/postgresql-full-text-search/)
- [PostgreSQL Extensions](https://www.postgresql.org/docs/current/contrib.html)

См. также: `postgres-basics.md`, `postgres-design.md`, `postgres-joins.md`.
...
BEGIN
    ...
    RETURN QUERY SELECT
        ...
        CASE WHEN version = 1 THEN
            to_timestamp(timestamp_microsecs / 10000000.0)
        ELSE NULL END,
        CASE WHEN version = 1 THEN
...
public class Article {
    ...
    private String metadata; // Или использовать JsonNode
