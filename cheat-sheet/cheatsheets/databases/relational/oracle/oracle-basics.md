...
- [Oracle Database Documentation](https://docs.oracle.com/en/database/) - Официальная документация
- [Oracle Database GitHub](https://github.com/oracle/docker-images) - Docker образы Oracle
- [Oracle Learning Library](https://apexapps.oracle.com/pls/apex/f?p=44785:1) - Обучающие материалы

### См. также
- `../../postgresql/postgres-basics.md` - PostgreSQL основы
- `../../mysql/mysql-basics.md` - MySQL основы
