...
- [Server Tuning](https://dev.mysql.com/doc/refman/8.0/en/server-tuning.html)
- [Performance Tuning](https://dev.mysql.com/doc/refman/8.0/en/performance-tuning.html)
...
- `databases/mysql-indexes.md` - Индексы и их оптимизация
- `databases/mysql-queries.md` - Оптимизация запросов
