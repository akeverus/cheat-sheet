...
- [EXPLAIN Output](https://dev.mysql.com/doc/refman/8.0/en/explain.html)
- [Index Usage](https://dev.mysql.com/doc/refman/8.0/en/indexes.html)
...
- `databases/mysql-design.md` - Проектирование баз данных
- `databases/mysql-indexes.md` - Индексы и производительность
- `databases/postgres-queries.md` - Сравнение с PostgreSQL
...
**Следующие темы:**
- `mysql-indexes.md` - Подробно об индексах и их оптимизации
- `mysql-performance.md` - Производительность и тюнинг сервера
