...
- [InnoDB Cluster](https://dev.mysql.com/doc/refman/8.0/en/mysql-innodb-cluster.html)
- [MySQL Router](https://dev.mysql.com/doc/refman/8.0/en/mysql-router.html)
...
- `databases/mysql-admin.md` - Администрирование MySQL
- `infrastructure/high-availability.md` - Общие принципы высокой доступности
...
**Следующие темы:**
- `databases/mysql-performance.md` - Производительность и тюнинг сервера MySQL
- `databases/mysql-admin.md` - Администрирование и обслуживание MySQL
- `infrastructure/high-availability.md` - Общие принципы высокой доступности
