...
- [MySQL Administration](https://dev.mysql.com/doc/refman/8.0/en/administration.html)
...
- `databases/mysql-performance.md` - Производительность и тюнинг
- `databases/mysql-replication.md` - Репликация и высокая доступность
- `infrastructure/monitoring.md` - Мониторинг инфраструктуры
...
**Следующие темы:**
- `infrastructure/monitoring.md` - Мониторинг инфраструктуры
- `infrastructure/high-availability.md` - Высокая доступность систем
- `infrastructure/backup-recovery.md` - Стратегии резервного копирования
