...
- [Database Design](https://dev.mysql.com/doc/refman/8.0/en/database-design.html)
- [Data Types](https://dev.mysql.com/doc/refman/8.0/en/data-types.html)
- [CREATE TABLE](https://dev.mysql.com/doc/refman/8.0/en/create-table.html)

### Дизайн и архитектура
- [Database Normalization](https://en.wikipedia.org/wiki/Database_normalization)
- [MySQL Schema Design](https://www.mysql.com/products/workbench/design/)
- [Data Modeling Best Practices](https://www.lucidchart.com/pages/database-diagram/database-design)
...
- `databases/mysql-indexes.md` - Индексы и оптимизация
- `databases/postgres-design.md` - Сравнение с PostgreSQL
...
**Следующие темы:**
- `mysql-queries.md` - Запросы и оптимизация SQL
- `mysql-indexes.md` - Индексы и производительность
- `mysql-replication.md` - Репликация и высокая доступность
- `mysql-performance.md` - Производительность и тюнинг
- `mysql-admin.md` - Администрирование и обслуживание

Проектирование баз данных — это баланс между идеальной нормализацией и практическими требованиями производительности и удобства использования. 🏗️
