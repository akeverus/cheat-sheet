...
- [JOOQ](https://www.jooq.org/) - jOOQ type-safe SQL

### См. также
- `../../frameworks/java-frameworks/spring/spring-data-jpa.md` - Spring Data JPA
- `../../libraries/java-jooq.md` - jOOQ библиотека
...
3. **Использование @Transactional** для управления транзакциями
