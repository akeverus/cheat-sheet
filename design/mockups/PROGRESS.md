...
|---|---|---|---|
| **Экран вопроса (эталон)** | `focus-question.html` | 🟡 draft v1 · detector✅ | chrome-devtools скрины (5 вьюпортов × 2 темы) + AA, затем полиш; добавить zone-chip/hint, флешкарт/study состояния |
...
- **it.1** — бутстрап: `tokens.css` (OKLCH light+dark), `DESIGN.md`, `PRODUCT.md`,
  ...
  Дальше: chrome-devtools скрины (375/768/1280/1440/1920 × 2 темы) + AA-сверка.
