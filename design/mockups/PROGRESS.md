...
|---|---|---|---|
| **Экран вопроса (эталон)** | `focus-question.html` | 🟢 draft v1 · detector✅ · QA✅ | **Язык принят С ПРАВКАМИ (юзер, it.2).** Жду конкретный список правок — НЕ гадать, НЕ трогать эталон. После правок → полиш (zone-chip/hint, флешкарт/study, keyboard-hints touch-gate) → Фаза B |
