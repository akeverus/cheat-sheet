...
- **310+ тем** из 25 категорий (JVM, базы данных, system design, фреймворки, алгоритмы, security, messaging и т.д.) — вопросы импортируются из markdown-шпаргалок `cheatsheets/interview/`.
