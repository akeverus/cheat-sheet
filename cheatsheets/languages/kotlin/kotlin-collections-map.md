...
- [Java Collections Map](../java/java-collections-map.md)
...
- [Продвинутые техники работы с Map](#продвинутые-техники-работы-с-map-1)
...
- [Дополнительные техники Map](#дополнительные-техники-map-1)
...
- [Практические примеры использования](#практические-примеры-использования)
  ...
  - [Работа с вложенными Map](#работа-с-вложенными-map-1)
  - [Операции с несколькими Map](#операции-с-несколькими-map-1)
