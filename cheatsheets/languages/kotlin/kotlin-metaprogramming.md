...
- [**KAPT** (**Kotlin Annotation Processing Tool**)](#kapt-kotlin-annotation-processing-tool)
  ...
  - [Ограничения KAPT](#ограничения-kapt)
- [KSP (Kotlin Symbol Processing)](#ksp-kotlin-symbol-processing)
  - [Преимущества KSP](#преимущества-ksp)
  - [Настройка KSP](#настройка-ksp)
  - [Создание KSP Processor](#создание-ksp-processor)
  - [Регистрация Processor](#регистрация-processor)
  - [Пример: Генерация Builder](#пример-генерация-builder)
- [Code Generation](#code-generation)
  - [Генерация кода во время компиляции](#генерация-кода-во-время-компиляции)
  - [Генерация через Template](#генерация-через-template)
- [Reflection-based метапрограммирование](#reflection-based-метапрограммирование)
  - [Runtime Code Generation](#runtime-code-generation)
  - [Dynamic Method Invocation](#dynamic-method-invocation)
  - [Property Delegation для метапрограммирования](#property-delegation-для-метапрограммирования)
- [Лучшие практики](#лучшие-практики)
  - [Используйте KSP вместо KAPT](#используйте-ksp-вместо-kapt)
  - [Кэшируйте результаты обработки](#кэшируйте-результаты-обработки)
  - [Валидация входных данных](#валидация-входных-данных)
  - [Логирование и отладка](#логирование-и-отладка)
  - [Генерация читаемого кода](#генерация-читаемого-кода)
- [Продвинутые техники метапрограммирования](#продвинутые-техники-метапрограммирования)
  - [Генерация кода на основе аннотаций](#генерация-кода-на-основе-аннотаций)
  - [Рефлексия во время выполнения](#рефлексия-во-время-выполнения)
  - [Динамическая генерация классов](#динамическая-генерация-классов)
- [Инструменты и библиотеки](#инструменты-и-библиотеки)
  - [KotlinPoet для генерации кода](#kotlinpoet-для-генерации-кода)
  - [Bytecode Manipulation](#bytecode-manipulation)
- [Оптимизация производительности](#оптимизация-производительности)
  - [Кэширование результатов рефлексии](#кэширование-результатов-рефлексии)
  - [Ленивая инициализация процессоров](#ленивая-инициализация-процессоров)
  - [Обработка ошибок](#обработка-ошибок)
  - [Документирование сгенерированного кода](#документирование-сгенерированного-кода)
- [Интеграция с системами сборки](#интеграция-с-системами-сборки)
  - [Gradle плагины для генерации кода](#gradle-плагины-для-генерации-кода)
  - [Maven плагины для генерации кода](#maven-плагины-для-генерации-кода)
- [Генерация кода для различных сценариев](#генерация-кода-для-различных-сценариев)
  - [Генерация DTO классов](#генерация-dto-классов)
  - [Генерация API клиентов](#генерация-api-клиентов)
  - [Генерация тестовых классов](#генерация-тестовых-классов)
  - [Генерация документации](#генерация-документации)
- [Инструменты для метапрограммирования](#инструменты-для-метапрограммирования)
- [Дополнительные техники метапрограммирования](#дополнительные-техники-метапрограммирования)
  - [Генерация кода для различных паттернов](#генерация-кода-для-различных-паттернов)
...
- [Практические примеры использования](#практические-примеры-использования)
  - [Генерация валидаторов](#генерация-валидаторов)
  - [Генерация Builder классов](#генерация-builder-классов)
  - [Генерация Mapper классов](#генерация-mapper-классов)
  - [Практические примеры: Генерация DTO классов](#практические-примеры-генерация-dto-классов)
  - [Практические примеры: Генерация Repository классов](#практические-примеры-генерация-repository-классов)
  - [Практические примеры: Генерация тестов](#практические-примеры-генерация-тестов)
  - [Практические примеры: Генерация API документации](#практические-примеры-генерация-api-документации)
