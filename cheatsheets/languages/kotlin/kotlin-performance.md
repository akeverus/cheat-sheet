...
- [Дополнительные техники оптимизации](#дополнительные-техники-оптимизации)
  ...
  - [Оптимизация компиляции](#оптимизация-компиляции-1)
- [Дополнительные техники оптимизации](#дополнительные-техники-оптимизации-1)
...
- [Практические примеры использования](#практические-примеры-использования)
  ...
  - [Оптимизация работы с памятью](#оптимизация-работы-с-памятью-1)
  - [Оптимизация строковых операций](#оптимизация-строковых-операций)
  - [Оптимизация работы с коллекциями](#оптимизация-работы-с-коллекциями-1)
