...
- [Группировка](#группировка)
  - [groupBy](#groupby)
  - [groupBy с фильтрацией](#groupby-с-фильтрацией)
- [GroupingBy](#groupingby)
  - [Базовое использование](#базовое-использование)
  - [eachCount](#eachcount)
  - [eachFold](#eachfold)
  - [eachReduce](#eachreduce)
  - [aggregate](#aggregate)
- [Агрегация](#агрегация)
  - [Суммирование по группам](#суммирование-по-группам)
  - [Среднее по группам](#среднее-по-группам)
- [Подсчет](#подсчет)
  - [Подсчет уникальных значений](#подсчет-уникальных-значений)
- [Суммирование](#суммирование)
  - [Сумма по группам](#сумма-по-группам)
  - [Сумма с условием](#сумма-с-условием)
- [Минимум и максимум](#минимум-и-максимум)
  - [Минимум и максимум по группам](#минимум-и-максимум-по-группам)
- [Fold и Reduce в группировке](#fold-и-reduce-в-группировке)
  - [Fold с начальным значением](#fold-с-начальным-значением)
  - [Reduce без начального значения](#reduce-без-начального-значения)
- [Продвинутые операции](#продвинутые-операции)
  - [Множественная группировка](#множественная-группировка)
  - [Группировка с трансформацией](#группировка-с-трансформацией)
  - [Фильтрация групп](#фильтрация-групп)
- [Лучшие практики](#лучшие-практики)
  - [Выбор метода группировки](#выбор-метода-группировки)
  - [Производительность](#производительность)
  - [Идиоматичный Kotlin](#идиоматичный-kotlin)
- [Продвинутые техники группировки](#продвинутые-техники-группировки)
  - [Многоуровневая группировка](#многоуровневая-группировка)
  - [Группировка с условиями](#группировка-с-условиями)
  - [Группировка с сортировкой](#группировка-с-сортировкой)
- [Анализ данных](#анализ-данных)
  - [Статистический анализ](#статистический-анализ)
  - [Временной анализ](#временной-анализ)
- [Производительность группировки](#производительность-группировки)
  - [Оптимизация больших коллекций](#оптимизация-больших-коллекций)
  - [Кэширование результатов группировки](#кэширование-результатов-группировки)
- [Продвинутые техники агрегации](#продвинутые-техники-агрегации)
  - [Кастомные агрегатные функции](#кастомные-агрегатные-функции)
  - [Сложные агрегации](#сложные-агрегации)
- [Работа с большими данными](#работа-с-большими-данными)
  - [Стриминговая агрегация](#стриминговая-агрегация)
  - [Инкрементальная агрегация](#инкрементальная-агрегация)
- [Работа с временными рядами](#работа-с-временными-рядами)
  - [Агрегация временных данных](#агрегация-временных-данных)
  - [Скользящие окна для временных рядов](#скользящие-окна-для-временных-рядов)
- [Дополнительные техники агрегации](#дополнительные-техники-агрегации)
  - [Работа с накоплением данных](#работа-с-накоплением-данных)
  - [Работа с окнами данных](#работа-с-окнами-данных)
  - [Работа с гистограммами](#работа-с-гистограммами)
- [Troubleshooting](#troubleshooting)
- [FAQ](#faq)
- [Заключение](#заключение)
- [Практические примеры использования](#практические-примеры-использования)
  - [Анализ продаж по категориям](#анализ-продаж-по-категориям)
  - [Агрегация временных рядов](#агрегация-временных-рядов)
  - [Условная группировка](#условная-группировка)
