...
- [CRUD операции](#crud-операции)
  - [Вставка данных (Insert):](#вставка-данных-insert-1)
  - [Чтение данных (Select):](#чтение-данных-select)
  - [Обновление данных (Update):](#обновление-данных-update-1)
  - [Удаление данных (Delete):](#удаление-данных-delete-1)
...
- [Продвинутые техники сериализации](#продвинутые-техники-сериализации)
  - [Кастомная сериализация](#кастомная-сериализация-2)
...
- [Продвинутые техники сериализации](#продвинутые-техники-сериализации-1)
...
- [Интеграция с внешними системами](#интеграция-с-внешними-системами-1)
...
- [Дополнительные паттерны и техники](#дополнительные-паттерны-и-техники-1)
  - [Template Method Pattern](#template-method-pattern)
  - [Visitor Pattern](#visitor-pattern)
- [Дополнительные паттерны](#дополнительные-паттерны-1)
...
- [Kotlin Collections: Operations](kotlin-collections-operations.md)
