...
- [Лучшие практики](#лучшие-практики)
  - [Использование явных типов для публичных **API**](#использование-явных-типов-для-публичных-api)
...
- [Дополнительные продвинутые возможности системы типов](#дополнительные-продвинутые-возможности-системы-типов)
  ...
  - [Практические примеры: Работа с **Type Lambdas**](#практические-примеры-работа-с-type-lambdas)
  - [Использование с различными техниками для типобезопасности](#использование-с-различными-техниками-для-типобезопасности)
  - [Использование с различными техниками для **type-level** вычислений](#использование-с-различными-техниками-для-type-level-вычислений)
...
- [Scala Type System Documentation](https://docs.scala-lang.org/overviews/core/value-classes.html)
- [Scala Type System Advanced](https://docs.scala-lang.org/sips/index.html)
- [Type-Level Programming in Scala](https://apollux.dev/blog/2019/type-level-programming-scala/)
