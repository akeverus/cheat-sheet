...
tags: ["languages", "scala", "scala-scalaz"]
...
**Scalaz** - это мощная библиотека функционального программирования для **Scala**, которая предоставляет множество абстракций для создания чистого функционального кода. Понимание **Type Classes**, **Monads**, **Functors**, **Applicative**, **Validation**, **Lens**, **Reader Monad** для **dependency injection**, **State Monad**, **Kleisli** для композиции функций и их практических применений позволяет создавать композируемый, типобезопасный и выразительный код.
