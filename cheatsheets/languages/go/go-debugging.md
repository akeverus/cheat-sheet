...
- [Go: отладка](#go-отладка)
- [Введение в отладку](#введение-в-отладку)
  - [Основные инструменты](#основные-инструменты)
- [Delve](#delve)
  - [Установка](#установка)
  - [Базовое использование](#базовое-использование)
- [Запуск программы под отладчиком](#запуск-программы-под-отладчиком)
- [Установка breakpoint](#установка-breakpoint)
...
- [Список breakpoints](#список-breakpoints)
- [Удаление breakpoint](#удаление-breakpoint)
- [Продолжение выполнения](#продолжение-выполнения)
- [Выход](#выход)
- [GDB](#gdb)
  - [Использование GDB](#использование-gdb)
- [Компиляция с отладочной информацией](#компиляция-с-отладочной-информацией)
- [Запуск под GDB](#запуск-под-gdb)
...
- [Пошаговое выполнение (step into)](#пошаговое-выполнение-step-into)
- [Следующая строка (step over)](#следующая-строка-step-over)
- [Выход из функции (step out)](#выход-из-функции-step-out)
- [Просмотр переменной в формате](#просмотр-переменной-в-формате)
- [Просмотр типа переменной](#просмотр-типа-переменной)
- [Просмотр стека вызовов](#просмотр-стека-вызовов)
- [Просмотр локальных переменных](#просмотр-локальных-переменных)
- [Просмотр аргументов функции](#просмотр-аргументов-функции)
- [Просмотр исходного кода](#просмотр-исходного-кода)
- [Просмотр определенной строки](#просмотр-определенной-строки)
- [Просмотр функции](#просмотр-функции)
  - [Установка breakpoints](#установка-breakpoints)
- [Breakpoint на строке](#breakpoint-на-строке)
- [Breakpoint на функции](#breakpoint-на-функции)
- [Breakpoint с условием](#breakpoint-с-условием)
- [Breakpoint на регулярном выражении](#breakpoint-на-регулярном-выражении)
- [Удаление всех breakpoints](#удаление-всех-breakpoints)
- [Включение/выключение breakpoint](#включениевыключение-breakpoint)
  - [Просмотр и изменение переменных](#просмотр-и-изменение-переменных)
- [Просмотр переменной](#просмотр-переменной)
- [Просмотр структуры](#просмотр-структуры)
- [Просмотр массива/слайса](#просмотр-массиваслайса)
- [Изменение переменной](#изменение-переменной)
- [Просмотр выражения](#просмотр-выражения)
  - [Условная отладка](#условная-отладка)
- [Условное выполнение](#условное-выполнение)
- [Команда при остановке](#команда-при-остановке)
  - [Remote debugging с Delve](#remote-debugging-с-delve)
- [Запуск Delve в headless режиме](#запуск-delve-в-headless-режиме)
- [Подключение к удаленному отладчику](#подключение-к-удаленному-отладчику)
  - [Практические примеры: Отладка горутин](#практические-примеры-отладка-горутин)
- [Отладка с просмотром горутин](#отладка-с-просмотром-горутин)
  - [Практические примеры: Отладка race conditions](#практические-примеры-отладка-race-conditions)
- [Компиляция с race detector](#компиляция-с-race-detector)
- [Запуск с race detector](#запуск-с-race-detector)
- [Race detector покажет место race condition](#race-detector-покажет-место-race-condition)
