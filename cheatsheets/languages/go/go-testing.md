...
- [Go: тестирование](#go-тестирование)
...
- [Запуск всех тестов в пакете](#запуск-всех-тестов-в-пакете)
...
- [Запуск с профилированием памяти](#запуск-с-профилированием-памяти)
...
- [Детальный отчет о покрытии](#детальный-отчет-о-покрытии)
- [Покрытие для всех пакетов](#покрытие-для-всех-пакетов)
  - [Целевое покрытие](#целевое-покрытие)
- [Проверка минимального покрытия](#проверка-минимального-покрытия)
