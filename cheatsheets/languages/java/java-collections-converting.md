...
- [Преобразование Array в List](#преобразование-array-в-list)
  ...
  - [Преобразование Array в List](#преобразование-array-в-list-1)
- [Преобразование Array в Set](#преобразование-array-в-set)
  - [Преобразование Array в Set](#преобразование-array-в-set-1)
...
- [Преобразование Map в String](#преобразование-map-в-string)
  - [Преобразование Map в String](#преобразование-map-в-string-1)
