...
- [Руководство по HashSet](#руководство-по-hashset)
  - [Метод add()](#метод-add-1)
  - [Метод contains()](#метод-contains-1)
  - [Метод remove()](#метод-remove-1)
  - [Метод clear()](#метод-clear)
  - [Метод size()](#метод-size-1)
  - [Метод isEmpty()](#метод-isempty-1)
  - [Метод iterator()](#метод-iterator-1)
