...
- [Четыре фазы MCTS](#четыре-фазы-mcts)
  - [1. Selection (Выбор)](#1-selection-выбор)
  - [2. Expansion (Расширение)](#2-expansion-расширение)
  - [3. Simulation (Симуляция)](#3-simulation-симуляция)
  - [4. Backpropagation (Обратное распространение)](#4-backpropagation-обратное-распространение)
...
- [Реализация на Kotlin](#реализация-на-kotlin)
  ...
  - [Класс State (Kotlin)](#класс-state-kotlin)
