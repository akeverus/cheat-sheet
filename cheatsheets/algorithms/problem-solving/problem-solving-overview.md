...
- [Стратегии решения](#стратегии-решения)
  - [1. Разделяй и властвуй (Divide and Conquer)](#1-разделяй-и-властвуй-divide-and-conquer)
  - [2. Динамическое программирование](#2-динамическое-программирование)
  - [3. Жадные алгоритмы](#3-жадные-алгоритмы)
  - [4. Поиск с возвратом (Backtracking)](#4-поиск-с-возвратом-backtracking)
