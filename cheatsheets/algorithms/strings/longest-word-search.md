...
tags: ["algorithms", "strings", "longest-word-search"]
...
- [Когда использовать](#когда-использовать)
  - [Используйте Stream API, когда:](#используйте-stream-api-когда)
  - [Используйте ручную обработку, когда:](#используйте-ручную-обработку-когда)
