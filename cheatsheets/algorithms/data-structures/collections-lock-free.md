...
- [Обзор](#обзор)
- [Блокировки vs Голодание](#блокировки-vs-голодание)
  - [Заблокированный поток](#заблокированный-поток)
  - [Голодающий поток](#голодающий-поток)
- [Уровни неблокирующих структур данных](#уровни-неблокирующих-структур-данных)
  - [1. Свобода от препятствий (Obstruction-Free)](#1-свобода-от-препятствий-obstruction-free)
  - [2. Свобода от блокировок (Lock-Free)](#2-свобода-от-блокировок-lock-free)
  - [3. Свобода от ожидания (Wait-Free)](#3-свобода-от-ожидания-wait-free)
- [Реализация на Java](#реализация-на-java)
  - [Операция сравнения и замены (CAS) (Java)](#операция-сравнения-и-замены-cas-java)
- [Проблема ABA](#проблема-aba)
  - [Решение проблемы ABA](#решение-проблемы-aba)
- [Реализация очереди без блокировок](#реализация-очереди-без-блокировок)
  - [Класс NonBlockingQueue](#класс-nonblockingqueue)
  - [Класс Node](#класс-node)
  - [Операция add](#операция-add)
  - [Операция get](#операция-get)
  - [ConcurrentLinkedQueue](#concurrentlinkedqueue)
- [Достижение свободы ожидания](#достижение-свободы-ожидания)
- [Сравнение подходов](#сравнение-подходов)
- [Когда использовать](#когда-использовать)
  - [Используйте lock-free структуры данных, когда:](#используйте-lock-free-структуры-данных-когда)
  - [Используйте wait-free структуры данных, когда:](#используйте-wait-free-структуры-данных-когда)
- [Лучшие практики](#лучшие-практики)
- [Решение проблем](#решение-проблем)
- [Частые вопросы](#частые-вопросы)
- [Резюме](#резюме)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Операция сравнения и замены (CAS) (Kotlin)](#операция-сравнения-и-замены-cas-kotlin)
  - [Решение проблемы ABA](#решение-проблемы-aba-1)
  - [Неблокирующая очередь](#неблокирующая-очередь)
