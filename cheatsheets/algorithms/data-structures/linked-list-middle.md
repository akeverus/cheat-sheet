...
- [Реализация на Java](#реализация-на-java)
  - [Подход 1: Использование размера списка (Java)](#подход-1-использование-размера-списка-java)
  - [Подход 2: Два указателя (один проход)](#подход-2-два-указателя-один-проход)
  - [Подход 3: Рекурсивный метод (Java)](#подход-3-рекурсивный-метод-java)
- [Полная реализация](#полная-реализация)
- [Сравнение подходов](#сравнение-подходов)
- [Рекомендации](#рекомендации)
- [Лучшие практики](#лучшие-практики)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Подход 1: Использование размера списка (Kotlin)](#подход-1-использование-размера-списка-kotlin)
  - [Подход 3: Рекурсивный метод (Kotlin)](#подход-3-рекурсивный-метод-kotlin)
  - [Вспомогательная функция для создания списка](#вспомогательная-функция-для-создания-списка)
