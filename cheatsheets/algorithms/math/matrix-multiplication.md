...
- [Реализация на Java](#реализация-на-java)
  ...
  - [Библиотеки для умножения матриц](#библиотеки-для-умножения-матриц)
    - [EJML](#ejml)
  - [ND4J](#nd4j)
  - [Apache Commons Math3](#apache-commons-math3)
  - [LA4J](#la4j)
  - [Colt](#colt)
- [Сравнение производительности](#сравнение-производительности)
  - [Малые матрицы (3×2 и 2×4)](#малые-матрицы-32-и-24)
  - [Большие матрицы (3000×3000)](#большие-матрицы-30003000)
- [Сложность](#сложность)
