...
tags: ["algorithms", "math", "age-calculation"]
...
- [Когда использовать](#когда-использовать)
  - [Используйте Java 8 Period, когда:](#используйте-java-8-period-когда)
  - [Используйте Joda-Time, когда:](#используйте-joda-time-когда)
  - [Используйте Java 7 Calendar, когда:](#используйте-java-7-calendar-когда)
