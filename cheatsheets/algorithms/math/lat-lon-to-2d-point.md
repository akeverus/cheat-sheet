...
- [Реализация на Java](#реализация-на-java)
  - [Сферическая проекция Меркатора (Java)](#сферическая-проекция-меркатора-java)
...
- [Варианты задачи](#варианты-задачи)
  - [Вариант 1: Обратное преобразование (2D Lat/Lon)](#вариант-1-обратное-преобразование-2d-latlon)
  - [Вариант 2: Преобразование с масштабированием](#вариант-2-преобразование-с-масштабированием)
  - [Вариант 3: Преобразование с центрированием](#вариант-3-преобразование-с-центрированием)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Сферическая проекция Меркатора (Kotlin)](#сферическая-проекция-меркатора-kotlin)
  - [Эллиптическая проекция Меркатора](#эллиптическая-проекция-меркатора-1)
