...
- [Реализация на Java](#реализация-на-java)
  - [Полный пример класса](#полный-пример-класса)
  - [Пример использования (Java)](#пример-использования-java)
- [Варианты задачи](#варианты-задачи)
  - [Вариант 1: Вычисление площади перекрытия](#вариант-1-вычисление-площади-перекрытия)
  - [Вариант 2: Получение прямоугольника перекрытия](#вариант-2-получение-прямоугольника-перекрытия)
  - [Вариант 3: Проверка полного содержания](#вариант-3-проверка-полного-содержания)
  - [Вариант 4: Проверка касания границ](#вариант-4-проверка-касания-границ)
