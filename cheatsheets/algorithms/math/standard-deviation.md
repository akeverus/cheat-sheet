...
- [Варианты реализации](#варианты-реализации)
  - [Вариант 1: Вычисление среднего отдельно](#вариант-1-вычисление-среднего-отдельно)
  - [Вариант 2: Выборочное стандартное отклонение (n−1)](#вариант-2-выборочное-стандартное-отклонение-n1)
  - [Вариант 3: Использование Java Streams](#вариант-3-использование-java-streams)
  - [Вариант 4: Вычисление дисперсии и стандартного отклонения](#вариант-4-вычисление-дисперсии-и-стандартного-отклонения)
