...
- [Обработка параллельных линий](#обработка-параллельных-линий)
  - [Улучшенная проверка параллельности](#улучшенная-проверка-параллельности)
- [Варианты задачи](#варианты-задачи)
  - [Вариант 1: Пересечение через две точки](#вариант-1-пересечение-через-две-точки)
  - [Вариант 2: Пересечение отрезков](#вариант-2-пересечение-отрезков)
  - [Вариант 3: Пересечение вертикальной и горизонтальной линий](#вариант-3-пересечение-вертикальной-и-горизонтальной-линий)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Улучшенная версия с epsilon](#улучшенная-версия-с-epsilon)
  - [Пересечение через две точки](#пересечение-через-две-точки)
