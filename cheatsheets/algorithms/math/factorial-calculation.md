...
- [Реализация на Java](#реализация-на-java)
  - [Подход 1: Цикл for](#подход-1-цикл-for)
  - [Обработка переполнения](#обработка-переполнения)
- [Подход 2: Stream API](#подход-2-stream-api)
- [Подход 3: Рекурсия](#подход-3-рекурсия)
  - [Улучшенная версия с базовым случаем](#улучшенная-версия-с-базовым-случаем)
  - [Хвостовая рекурсия (для больших чисел)](#хвостовая-рекурсия-для-больших-чисел)
- [Подход 4: Apache Commons Math](#подход-4-apache-commons-math)
- [Подход 5: Guava](#подход-5-guava)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Подход 2: Функциональный стиль](#подход-2-функциональный-стиль)
  - [Подход 3: Рекурсия](#подход-3-рекурсия-1)
  - [Подход 4: Хвостовая рекурсия](#подход-4-хвостовая-рекурсия)
  - [Подход 5: Использование BigInteger](#подход-5-использование-biginteger)
  - [Подход 6: Функциональный стиль с BigInteger](#подход-6-функциональный-стиль-с-biginteger)
  - [Подход 7: Мемоизация](#подход-7-мемоизация)
  - [Пример использования](#пример-использования)
- [Работа с большими числами](#работа-с-большими-числами)
  - [Оптимизированная версия с BigInteger](#оптимизированная-версия-с-biginteger)
- [Сравнение подходов](#сравнение-подходов)
- [Сложность](#сложность)
- [Особенности](#особенности)
- [Применение](#применение)
- [Варианты задачи](#варианты-задачи)
  - [Вариант 1: Двойной факториал](#вариант-1-двойной-факториал)
  - [Вариант 2: Факториал с мемоизацией](#вариант-2-факториал-с-мемоизацией)
  - [Вариант 3: Логарифм факториала](#вариант-3-логарифм-факториала)
