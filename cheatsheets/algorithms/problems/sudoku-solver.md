...
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Класс SudokuSolver](#класс-sudokusolver)
...
- [Тестирование](#тестирование)
  - [JUnit: решаемость и неразрешимость](#junit-решаемость-и-неразрешимость)
  - [Kotlin: проверка результата](#kotlin-проверка-результата)
...
- [Дополнительные примеры использования](#дополнительные-примеры-использования)
  ...
  - [Пример 4: CLI/логирование](#пример-4-cliлогирование)
