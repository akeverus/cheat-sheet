...
- [Стандартное отклонение](../math/standard-deviation.md) — стандартное отклонение
...
- [Подход 2: Две кучи](#подход-2-две-кучи)
  - [Пошаговый разбор](#пошаговый-разбор)
...
- [Альтернативы и оптимизации](#альтернативы-и-оптимизации)
  - [Пример: скользящая медиана](#пример-скользящая-медиана)
...
- [Проверка входа и контракты](#проверка-входа-и-контракты)
  - [Пример валидации](#пример-валидации)
- [Наблюдаемость и профилирование](#наблюдаемость-и-профилирование)
  - [Пример метрики в pseudo-code](#пример-метрики-в-pseudo-code)
