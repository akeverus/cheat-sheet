...
- [Реализация на Java](#реализация-на-java)
  - [Обнаружение предложений (Java)](#обнаружение-предложений-java)
...
- [Тегирование части речи (POS)](#тегирование-части-речи-pos)
- [Лемматизация](#лемматизация)
- [Чанкинг](#чанкинг)
- [Определение языка](#определение-языка)
- [Полный пример обработки текста](#полный-пример-обработки-текста)
- [Лучшие практики](#лучшие-практики)
- [Решение проблем](#решение-проблем)
- [Частые вопросы](#частые-вопросы)
- [Резюме](#резюме)
- [Реализация на Kotlin](#реализация-на-kotlin)
  - [Обнаружение предложений (Kotlin)](#обнаружение-предложений-kotlin)
  - [Токенизация](#токенизация-1)
  - [Распознавание именованных сущностей](#распознавание-именованных-сущностей)
  - [Тегирование части речи](#тегирование-части-речи)
