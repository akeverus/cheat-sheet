...
description: "Deeplearning4j (DL4J) — это современная и библиотека для машинного обучения на Java. В этой статье мы создадим простую нейронную сеть с помощью DL4J для классификации набора данных цветка ириса."
tags:
  - algorithms
  - ai-ml
  - deeplearning4j
...
Deeplearning4j (DL4J) — это современная и библиотека для машинного обучения на Java. В этой статье мы создадим простую нейронную сеть с помощью DL4J для классификации набора данных цветка ириса.
