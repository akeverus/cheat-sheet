...
- [Принцип работы](#принцип-работы)
  - [Таблица итераций](#таблица-итераций)
...
Обозначение B — 22: предшественник B, суммарное расстояние от A равно 22. Итоговые пути: B 10, C 15, D 22 (ABD), E 24 (ABDE), F 23 (ABDF).
