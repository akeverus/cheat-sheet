...
- [Реализация на Java](#реализация-на-java)
  - [Реализация для деревьев](#реализация-для-деревьев)
  - [Пример использования для деревьев](#пример-использования-для-деревьев)
  - [Реализация для графов](#реализация-для-графов)
  - [Пример использования для графов](#пример-использования-для-графов)
