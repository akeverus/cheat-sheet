...
- [Атаки на JWT](#атаки-на-jwt)
  - [alg: none](#alg-none)
  - [Key confusion (RSA HMAC)](#key-confusion-rsa-hmac)
  - [Утечка секретного ключа](#утечка-секретного-ключа)
  - [JWT в URL](#jwt-в-url)
  - [Слишком долгий TTL](#слишком-долгий-ttl)
  - [Отсутствие проверки aud и iss](#отсутствие-проверки-aud-и-iss)
...
- [Устаревшие flows](#устаревшие-flows)
  - [Implicit (не использовать)](#implicit-не-использовать)
  - [Resource Owner Password (не использовать)](#resource-owner-password-не-использовать)
- [OIDC как надстройка](#oidc-как-надстройка)
- [Spring Security Resource Server](#spring-security-resource-server)
  - [application.yml](#applicationyml)
  - [Security config](#security-config)
  - [Контроллер](#контроллер)
  - [Кастомный валидатор](#кастомный-валидатор)
- [Spring Authorization Server](#spring-authorization-server)
  - [Минимальный клиент в памяти](#минимальный-клиент-в-памяти)
  - [Ключи для подписи](#ключи-для-подписи)
  - [Конфиг security chain](#конфиг-security-chain)
