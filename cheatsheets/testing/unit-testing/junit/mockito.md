...
- [Примеры использования](#примеры-использования)
  - [Сервис с зависимостями](#сервис-с-зависимостями)
  - [ArgumentCaptor — несколько вызовов](#argumentcaptor-несколько-вызовов)
- [BDD, final/static, InOrder](#bdd-finalstatic-inorder)
