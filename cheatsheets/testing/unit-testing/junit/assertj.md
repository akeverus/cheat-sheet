...
- [Введение в AssertJ](#введение-в-assertj)
  - [Почему AssertJ](#почему-assertj)
- [Зависимости](#зависимости)
  - [Maven (основной модуль)](#maven-основной-модуль)
  - [BOM (управление версиями)](#bom-управление-версиями)
  - [Spring Boot](#spring-boot)
  - [Gradle](#gradle)
  - [Дополнительные модули](#дополнительные-модули)
  - [Решение проблем зависимостей](#решение-проблем-зависимостей)
- [Базовое использование](#базовое-использование)
- [Проверки по типам](#проверки-по-типам)
  - [Числа и boolean](#числа-и-boolean)
  - [Строки](#строки)
  - [Коллекции (List, Set, Map)](#коллекции-list-set-map)
  - [Объекты и рекурсивное сравнение](#объекты-и-рекурсивное-сравнение)
  - [Исключения](#исключения)
  - [Optional](#optional)
- [Мягкие и пользовательские проверки](#мягкие-и-пользовательские-проверки)
  - [Мягкие проверки (soft assertions)](#мягкие-проверки-soft-assertions)
  - [Пользовательские проверки](#пользовательские-проверки)
  - [Условные проверки](#условные-проверки)
  - [BDD-стиль (then/should)](#bdd-стиль-thenshould)
- [Spring Boot и JSON](#spring-boot-и-json)
  - [Spring MVC + AssertJ](#spring-mvc-assertj)
  - [Контекст Spring](#контекст-spring)
  - [JSON (модуль assertj-json)](#json-модуль-assertj-json)
  - [Файлы](#файлы)
...
- [Заключение](#заключение)
  - [Кратко по типам проверок](#кратко-по-типам-проверок)
