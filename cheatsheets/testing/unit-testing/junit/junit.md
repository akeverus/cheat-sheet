...
tags: ["testing", "unit-testing", "junit"]
...
- [Введение](#введение-в-junit-5)
- [Установка](#установка-и-настройка)
- [Аннотации и жизненный цикл](#основные-аннотации)
- [Проверки и допущения](#assertions-проверки)
- [Параметризованные и динамические тесты](#параметризованные-тесты)
