...
- [Введение](#введение)
  - [Зачем pytest](#зачем-pytest)
  - [Основные концепции](#основные-концепции)
- [Установка и настройка](#установка-и-настройка)
  - [Требования](#требования)
  - [Установка](#установка)
  - [Конфигурация (pytest.ini, pyproject.toml, setup.cfg)](#конфигурация-pytestini-pyprojecttoml-setupcfg)
  - [Виртуальное окружение](#виртуальное-окружение)
- [Базовое использование](#базовое-использование)
  - [Простой тест](#простой-тест)
  - [Assert и встроенные проверки](#assert-и-встроенные-проверки)
  - [Запуск тестов](#запуск-тестов)
- [Фикстуры](#фикстуры)
  - [Базовые фикстуры](#базовые-фикстуры)
  - [Scope фикстур](#scope-фикстур)
  - [Зависимости между фикстурами](#зависимости-между-фикстурами)
  - [autouse](#autouse)
- [Параметризация](#параметризация)
  - [@pytest.mark.parametrize](#pytestmarkparametrize)
  - [Множественные параметры](#множественные-параметры)
  - [ids для читаемости](#ids-для-читаемости)
- [Маркеры](#маркеры)
  - [Встроенные маркеры](#встроенные-маркеры)
  - [Кастомные маркеры](#кастомные-маркеры)
...
- [Асинхронные тесты](#асинхронные-тесты)
  - [pytest-asyncio](#pytest-asyncio-1)
  - [Таймауты](#таймауты)
- [Расширенные сценарии](#расширенные-сценарии)
  - [conftest.py](#conftestpy)
  - [Хуки pytest](#хуки-pytest)
  - [Тесты с подклассами](#тесты-с-подклассами)
