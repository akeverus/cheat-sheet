...
- [Введение](#введение)
  - [Зачем Jest](#зачем-jest)
  - [Основные концепции](#основные-концепции)
- [Установка и настройка](#установка-и-настройка)
  - [Требования](#требования)
  - [Установка](#установка)
  - [Конфигурация (jest.config.js)](#конфигурация-jestconfigjs)
- [Базовое использование](#базовое-использование)
  - [Простой тест](#простой-тест)
  - [Матчеры expect](#матчеры-expect)
...
- [Расширенные сценарии](#расширенные-сценарии)
  - [React (React Testing Library)](#react-react-testing-library)
  - [Vue (Vue Test Utils)](#vue-vue-test-utils)
  - [Параметризация (test.each)](#параметризация-testeach)
  - [Прочее](#прочее)
...
- [Решение проблем и FAQ](#решение-проблем-и-faq)
  ...
  - [Ключевые команды и API](#ключевые-команды-и-api)
