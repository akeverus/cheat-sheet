...
- [Введение](#введение)
  - [Зачем Gatling](#зачем-gatling)
  - [Основные концепции](#основные-концепции)
- [Установка и настройка](#установка-и-настройка)
  - [Требования](#требования)
  - [Установка через sbt](#установка-через-sbt)
  - [Установка через Maven](#установка-через-maven)
  - [Проверка](#проверка)
- [Структура Simulation](#структура-simulation)
  - [Scenario и exec](#scenario-и-exec)
  - [HTTP-запросы](#http-запросы)
  - [inject (профиль нагрузки)](#inject-профиль-нагрузки)
...
- [Глоссарий и таблицы](#глоссарий-и-таблицы)
  - [Глоссарий](#глоссарий)
  - [Основные методы inject](#основные-методы-inject)
  - [Основные check](#основные-check)
