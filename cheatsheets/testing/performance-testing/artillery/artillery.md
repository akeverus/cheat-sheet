...
- [Введение](#введение)
  - [Зачем Artillery](#зачем-artillery)
  - [Основные концепции](#основные-концепции)
- [Установка и настройка](#установка-и-настройка)
- [Структура теста (YAML)](#структура-теста-yaml)
  - [config, target, phases](#config-target-phases)
  - [scenarios](#scenarios)
- [HTTP-запросы](#http-запросы)
- [Processor и payload](#processor-и-payload)
- [Отчёты и метрики](#отчёты-и-метрики)
  - [ensure (пороги для CI)](#ensure-пороги-для-ci)
- [WebSocket](#websocket)
- [CI/CD](#cicd)
...
- [Глоссарий и команды](#глоссарий-и-команды)
  - [Термины](#термины)
  - [CLI](#cli)
