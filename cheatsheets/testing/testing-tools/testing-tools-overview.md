...
- [Отчёты и отчётность](#отчёты-и-отчётность)
  ...
  - [Стандартные отчёты JUnit (XML, HTML)](#стандартные-отчёты-junit-xml-html)
- [Покрытие кода](#покрытие-кода)
  - [JaCoCo](#jacoco)
- [Интеграция с CI/CD](#интеграция-с-cicd)
  - [Запуск тестов в пайплайне](#запуск-тестов-в-пайплайне)
  - [Публикация отчётов и артефактов](#публикация-отчётов-и-артефактов)
  - [Пример фрагмента GitLab CI](#пример-фрагмента-gitlab-ci)
