...
- [Основы Tekton](#основы-tekton)
  - [Архитектура Tekton](#архитектура-tekton)
  - [Core Concepts](#core-concepts)
- [Установка и настройка](#установка-и-настройка)
  - [Установка через Operator](#установка-через-operator)
  - [Manual установка](#manual-установка)
  - [Настройка Persistent Volumes](#настройка-persistent-volumes)
  - [RBAC настройка](#rbac-настройка)
- [Pipeline Resources](#pipeline-resources)
  - [Git ресурсы](#git-ресурсы)
  - [Container Image ресурсы](#container-image-ресурсы)
  - [Custom ресурсы](#custom-ресурсы)
- [Tasks и Pipelines](#tasks-и-pipelines)
  - [Advanced Task patterns](#advanced-task-patterns)
  - [Pipeline с DAG (Directed Acyclic Graph)](#pipeline-с-dag-directed-acyclic-graph)
  - [Pipeline Templates и Reusability](#pipeline-templates-и-reusability)
  - [Conditions и Gates](#conditions-и-gates)
- [Triggers и Event-driven Pipelines](#triggers-и-event-driven-pipelines)
  - [Trigger Templates и Bindings](#trigger-templates-и-bindings)
...
- [Monitoring и Observability](#monitoring-и-observability)
  ...
  - [Logging aggregation](#logging-aggregation)
  - [Distributed tracing](#distributed-tracing)
- [Security и Best Practices](#security-и-best-practices)
  - [RBAC и Security Contexts](#rbac-и-security-contexts)
