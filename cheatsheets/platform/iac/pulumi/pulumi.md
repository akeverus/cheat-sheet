...
- [Основы Pulumi](#основы-pulumi)
  - [Установка и настройка](#установка-и-настройка)
    - [Установка Pulumi CLI](#установка-pulumi-cli)
    - [Настройка облачного провайдера](#настройка-облачного-провайдера)
  - [Структура проекта](#структура-проекта)
    - [Базовый проект](#базовый-проект)
    - [Pulumi.yaml](#pulumiyaml)
    - [package.json для Node.js проекта](#packagejson-для-nodejs-проекта)
