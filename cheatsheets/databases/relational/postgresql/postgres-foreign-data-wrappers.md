...
- [postgres_fdw](#postgres_fdw)
  - [Настройка подключения](#настройка-подключения)
    - [1. Создать Foreign Server](#1-создать-foreign-server)
    - [2. Создать User Mapping](#2-создать-user-mapping)
    - [3. Создать Foreign Table](#3-создать-foreign-table)
  - [Использование Foreign Table](#использование-foreign-table)
  - [Импорт схемы](#импорт-схемы)
  - [Оптимизация производительности](#оптимизация-производительности)
- [file_fdw](#file_fdw)
  - [Настройка file_fdw](#настройка-file_fdw)
    - [1. Создать Foreign Server](#1-создать-foreign-server-1)
    - [2. Создать Foreign Table для CSV](#2-создать-foreign-table-для-csv)
...
- [Advanced postgres_fdw](#advanced-postgres_fdw)
...
- [Advanced file_fdw](#advanced-file_fdw)
...
- [Дополнительные FDW](#дополнительные-fdw)
  - [redis_fdw](#redis_fdw)
  - [clickhouse_fdw](#clickhouse_fdw)
  - [multicorn_fdw](#multicorn_fdw)
