...
- [Введение в расширения PostgreSQL](#введение-в-расширения-postgresql)
  - [Преимущества расширений](#преимущества-расширений)
- [Управление расширениями](#управление-расширениями)
  - [Просмотр доступных расширений](#просмотр-доступных-расширений)
  - [Установка расширений](#установка-расширений)
  - [Обновление расширений](#обновление-расширений)
...
- [Популярные расширения](#популярные-расширения)
  ...
  - [pg_trgm (Trigram)](#pg_trgm-trigram)
...
- [Создание собственных расширений](#создание-собственных-расширений)
  - [Структура расширения](#структура-расширения)
  - [Создание простого расширения](#создание-простого-расширения)
    - [1. Создать файл my_extension.control](#1-создать-файл-my_extensioncontrol)
    - [2. Создать файл my_extension--1.0.sql](#2-создать-файл-my_extension-10sql)
    - [3. Создать Makefile](#3-создать-makefile)
    - [4. Установить расширение](#4-установить-расширение)
- [Лучшие практики](#лучшие-практики)
  - [Управление расширениями](#управление-расширениями-1)
  - [Производительность](#производительность)
- [Дополнительные популярные расширения](#дополнительные-популярные-расширения)
  - [pg_buffercache](#pg_buffercache)
  - [pg_freespacemap](#pg_freespacemap)
  - [pg_prewarm](#pg_prewarm)
  - [pgstattuple](#pgstattuple)
  - [pgrowlocks](#pgrowlocks)
  - [pg_trgm (расширенное использование)](#pg_trgm-расширенное-использование)
  - [PostGIS (расширенное использование)](#postgis-расширенное-использование)
  - [pg_cron (расширенное использование)](#pg_cron-расширенное-использование)
...
- [Advanced Extension Development](#advanced-extension-development)
  - [Создание расширения с типами данных](#создание-расширения-с-типами-данных)
  - [Создание расширения с операторами](#создание-расширения-с-операторами)
  - [Создание расширения с функциями на C](#создание-расширения-с-функциями-на-c)
  - [Создание расширения с индексами](#создание-расширения-с-индексами)
- [Extension Management](#extension-management)
  - [Автоматическая установка расширений](#автоматическая-установка-расширений)
  - [Мониторинг расширений](#мониторинг-расширений)
  - [Управление версиями расширений](#управление-версиями-расширений)
- [Best Practices Summary](#best-practices-summary)
  - [Установка расширений](#установка-расширений-1)
  - [Управление расширениями](#управление-расширениями-2)
  - [Разработка расширений](#разработка-расширений)
- [Real-World Use Cases](#real-world-use-cases)
  - [Use Case 1: Аналитика с pg_stat_statements](#use-case-1-аналитика-с-pg_stat_statements)
  - [Use Case 2: Поиск с pg_trgm](#use-case-2-поиск-с-pg_trgm)
  - [Use Case 3: Геолокация с PostGIS](#use-case-3-геолокация-с-postgis)
  - [Use Case 4: Автоматизация с pg_cron](#use-case-4-автоматизация-с-pg_cron)
  - [Use Case 5: Временные ряды с TimescaleDB](#use-case-5-временные-ряды-с-timescaledb)
- [Решение проблем расширений](#решение-проблем-расширений)
  - [Проблема: Расширение не устанавливается](#проблема-расширение-не-устанавливается)
  - [Проблема: Расширение работает медленно](#проблема-расширение-работает-медленно)
  - [Проблема: Конфликты версий](#проблема-конфликты-версий)
- [Extension Performance Tuning](#extension-performance-tuning)
  - [Оптимизация pg_stat_statements](#оптимизация-pg_stat_statements)
  - [Оптимизация pg_trgm](#оптимизация-pg_trgm)
  - [Оптимизация PostGIS](#оптимизация-postgis)
- [Extension Security](#extension-security)
  - [Безопасная установка расширений](#безопасная-установка-расширений)
  - [Аудит использования расширений](#аудит-использования-расширений)
- [Extension Migration Strategies](#extension-migration-strategies)
  - [Стратегия 1: Постепенная миграция](#стратегия-1-постепенная-миграция)
  - [Стратегия 2: Откат изменений](#стратегия-2-откат-изменений)
- [Extension Development Best Practices](#extension-development-best-practices)
  - [Структура проекта](#структура-проекта)
  - [Тестирование расширений](#тестирование-расширений)
  - [Документирование расширений](#документирование-расширений)
- [Extension Packaging](#extension-packaging)
  - [Создание пакета расширения](#создание-пакета-расширения)
  - [Распространение расширения](#распространение-расширения)
- [Monitoring Extensions](#monitoring-extensions)
  - [Мониторинг использования](#мониторинг-использования)
  - [Алерты для расширений](#алерты-для-расширений)
- [Extension Maintenance](#extension-maintenance)
  - [Регулярное обслуживание](#регулярное-обслуживание)
  - [Очистка неиспользуемых расширений](#очистка-неиспользуемых-расширений)
- [Extension Comparison](#extension-comparison)
  - [Сравнение расширений для похожих задач](#сравнение-расширений-для-похожих-задач)
    - [UUID генерация](#uuid-генерация)
...
- [Extension Performance Benchmarks](#extension-performance-benchmarks)
  - [Бенчмарк pg_trgm](#бенчмарк-pg_trgm)
  - [Бенчмарк PostGIS](#бенчмарк-postgis)
- [Extension Security Best Practices](#extension-security-best-practices)
  - [Минимизация привилегий](#минимизация-привилегий)
  - [Аудит расширений](#аудит-расширений)
...
- [Extension Deployment](#extension-deployment)
  ...
  - [CI/CD для расширений](#cicd-для-расширений)
...
**Просмотр доступных и установленных расширений:**
