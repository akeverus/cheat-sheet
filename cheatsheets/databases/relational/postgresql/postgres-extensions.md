...
- [Real-World Use Cases](#real-world-use-cases)
  - [Use Case 1: Аналитика с pg_stat_statements](#use-case-1-аналитика-с-pgstatstatements)
  - [Use Case 2: Поиск с pg_trgm](#use-case-2-поиск-с-pgtrgm)
  - [Use Case 3: Геолокация с PostGIS](#use-case-3-геолокация-с-postgis)
  - [Use Case 4: Автоматизация с pg_cron](#use-case-4-автоматизация-с-pgcron)
...
- [Extension Performance Tuning](#extension-performance-tuning)
  - [Оптимизация pg_stat_statements](#оптимизация-pgstatstatements)
  - [Оптимизация pg_trgm](#оптимизация-pgtrgm)
...
- [Extension Performance Benchmarks](#extension-performance-benchmarks)
  - [Бенчмарк pg_trgm](#бенчмарк-pgtrgm)
