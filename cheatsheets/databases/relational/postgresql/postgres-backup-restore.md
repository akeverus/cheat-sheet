...
- [Логический дамп: pg_dump](#логический-дамп-pg_dump)
  - [Основные сценарии pg_dump](#основные-сценарии-pg_dump)
    - [1. Текстовый дамп (SQL)](#1-текстовый-дамп-sql)
    - [2. Custom формат (сжатый бинарный)](#2-custom-формат-сжатый-бинарный)
    - [3. Directory формат (параллельный дамп)](#3-directory-формат-параллельный-дамп)
    - [4. Tar формат](#4-tar-формат)
  - [Опции pg_dump](#опции-pg_dump)
    - [Выбор объектов](#выбор-объектов)
    - [Дополнительные опции](#дополнительные-опции)
  - [Восстановление из pg_dump](#восстановление-из-pg_dump)
    - [Восстановление из SQL дампа](#восстановление-из-sql-дампа)
    - [Восстановление из Custom дампа](#восстановление-из-custom-дампа)
    - [Восстановление из Directory дампа](#восстановление-из-directory-дампа)
  - [pg_dumpall](#pg_dumpall)
- [Физический снимок: pg_basebackup](#физический-снимок-pg_basebackup)
  - [Основные сценарии pg_basebackup](#основные-сценарии-pg_basebackup)
    - [1. Базовый снимок](#1-базовый-снимок)
    - [2. Опции pg_basebackup](#2-опции-pg_basebackup)
    - [3. Восстановление из pg_basebackup](#3-восстановление-из-pg_basebackup)
- [Continuous Archiving и Point-in-Time Recovery (PITR)](#continuous-archiving-и-point-in-time-recovery-pitr)
  - [Настройка Continuous Archiving](#настройка-continuous-archiving)
    - [1. Параметры postgresql.conf](#1-параметры-postgresqlconf)
    - [2. Создание каталога архива WAL](#2-создание-каталога-архива-wal)
    - [3. Кастомная архивация через shell-скрипт](#3-кастомная-архивация-через-shell-скрипт)
  - [Point-in-Time Recovery (PITR)](#point-in-time-recovery-pitr)
    - [1. Создание базового снимка](#1-создание-базового-снимка)
    - [2. Восстановление на заданный момент времени](#2-восстановление-на-заданный-момент-времени)
    - [3. Параметры восстановления](#3-параметры-восстановления)
...
- [Примеры скриптов резервного копирования](#примеры-скриптов-резервного-копирования)
  ...
  - [Комбинированная стратегия](#комбинированная-стратегия)
- [Автоматизация резервного копирования](#автоматизация-резервного-копирования)
  - [Планировщик cron](#планировщик-cron)
  - [Планировщик systemd timer](#планировщик-systemd-timer)
- [Восстановление из бэкапов](#восстановление-из-бэкапов)
  - [Восстановление полной базы данных](#восстановление-полной-базы-данных)
  - [Восстановление отдельных таблиц](#восстановление-отдельных-таблиц)
  - [Восстановление на другой сервер](#восстановление-на-другой-сервер)
- [Проверка восстановления](#проверка-восстановления)
  - [Тест восстановления бэкапа](#тест-восстановления-бэкапа)
  - [Автоматическая проверка восстановления](#автоматическая-проверка-восстановления)
- [Мониторинг резервного копирования](#мониторинг-резервного-копирования)
  - [Проверка статуса бэкапов](#проверка-статуса-бэкапов)
  - [Система алертов](#система-алертов)
- [Лучшие практики](#лучшие-практики)
  - [Стратегия и регламент](#стратегия-и-регламент)
  - [Безопасность](#безопасность)
  - [Отказоустойчивость](#отказоустойчивость)
- [Решение проблем](#решение-проблем)
  - [Проблема: pg_dump завершается с ошибкой](#проблема-pg_dump-завершается-с-ошибкой)
