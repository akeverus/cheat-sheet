...
- [Обслуживание партиций](#обслуживание-партиций)
  ...
  - [Индексы на партициях](#индексы-на-партициях-1)
...
- [Производительность и оптимизация](#производительность-и-оптимизация)
  - [Оптимизация запросов к партиционированным таблицам](#оптимизация-запросов-к-партиционированным-таблицам-1)
...
- [Решение проблем распространенных проблем](#решение-проблем-распространенных-проблем)
