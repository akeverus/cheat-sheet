...
- [PostgreSQL: Высокая доступность](#postgresql-высокая-доступность)
...
- [Установить Patroni](#установить-patroni)
- [или](#или)
  - [Конфигурация Patroni](#конфигурация-patroni)
    - [patroni.yml](#patroniyml)
  - [Запуск Patroni](#запуск-patroni)
- [Запустить Patroni](#запустить-patroni)
- [Или как systemd service](#или-как-systemd-service)
  - [Управление через REST API](#управление-через-rest-api)
- [Проверить статус](#проверить-статус)
- [Промоутить standby в primary](#промоутить-standby-в-primary)
...
- [Создать monitor](#создать-monitor)
...
- [В postgresql.conf на Primary](#в-postgresqlconf-на-primary)
...
- [Load balancing для read-only запросов](#load-balancing-для-read-only-запросов)
...
- [Создать сертификаты](#создать-сертификаты)
- [Настроить с SSL](#настроить-с-ssl)
...
- [PostgreSQL Primary (write)](#postgresql-primary-write)
...
- [backup_strategy.sh](#backup_strategysh)
- [Ежедневный полный бэкап](#ежедневный-полный-бэкап)
- [Еженедельный бэкап с архивированием](#еженедельный-бэкап-с-архивированием)
- [Удаление старых бэкапов](#удаление-старых-бэкапов)
  - [Point-in-Time Recovery](#point-in-time-recovery)
- [Восстановление на определенный момент времени](#восстановление-на-определенный-момент-времени)
- [Настроить recovery.conf](#настроить-recoveryconf)
- [Запустить восстановление](#запустить-восстановление)
- [Тестирование HA](#тестирование-ha)
  - [Тестирование Failover](#тестирование-failover)
- [test_failover.sh](#test_failoversh)
- [1. Проверить текущее состояние](#1-проверить-текущее-состояние)
- [2. Остановить Primary](#2-остановить-primary)
- [3. Подождать failover](#3-подождать-failover)
- [4. Проверить новый Primary](#4-проверить-новый-primary)
- [5. Восстановить старый Primary как Standby](#5-восстановить-старый-primary-как-standby)
  - [Нагрузочное тестирование](#нагрузочное-тестирование)
- [load_test.sh](#load_testsh)
- [Использовать pgbench для нагрузочного тестирования](#использовать-pgbench-для-нагрузочного-тестирования)
- [Тестирование read-only запросов на репликах](#тестирование-read-only-запросов-на-репликах)
- [Troubleshooting](#решение-проблем)
  - [Проблема: Failover не происходит](#проблема-failover-не-происходит)
- [Проверить статус Patroni](#проверить-статус-patroni)
- [Проверить логи](#проверить-логи)
- [Проверить etcd/consul](#проверить-etcdconsul)
- [Проверить сетевую связность](#проверить-сетевую-связность)
- [Проверить firewall](#проверить-firewall)
  - [Проблема: Большой lag после failover](#проблема-большой-lag-после-failover)
  - [Проблема: Split-brain](#проблема-split-brain)
- [Определить правильный Primary](#определить-правильный-primary)
- [Остановить неправильный Primary](#остановить-неправильный-primary)
- [Использовать pg_rewind для синхронизации](#использовать-pg_rewind-для-синхронизации)
  - [Проблема: Медленный failover](#проблема-медленный-failover)
- [Уменьшить TTL в Patroni](#уменьшить-ttl-в-patroni)
...
- [Регион 1: US-East](#регион-1-us-east)
- [Регион 2: EU-West](#регион-2-eu-west)
- [Регион 3: Asia-Pacific](#регион-3-asia-pacific)
