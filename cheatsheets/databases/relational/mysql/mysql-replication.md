...
- [Архитектура репликации](#архитектура-репликации)
  ...
  - [Типы топологий репликации](#типы-топологий-репликации)
    - [Один Master — Множество Slaves](#один-master-множество-slaves)
...
- [InnoDB Cluster](#innodb-cluster)
  ...
  - [Создание InnoDB Cluster](#создание-innodb-cluster)
    - [Подготовка серверов](#подготовка-серверов-1)
...
- [Failover и восстановление](#failover-и-восстановление)
  ...
  - [Восстановление после сбоя](#восстановление-после-сбоя-1)
...
- [Производительность репликации](#производительность-репликации)
  ...
  - [Оптимизация Slave](#оптимизация-slave)
    - [Конфигурация Slave](#конфигурация-slave-1)
...
- [Решение проблем](#решение-проблем)
  ...
  - [Автоматическое восстановление](#автоматическое-восстановление-1)
...
Репликация **MySQL** продолжает развиваться, предлагая все более надежные и простые в управлении решения для высокой доступности баз данных.
