...
tags: ["databases", "relational", "mysql-performance"]
...
- [Рекомендуемая конфигурация буферного пула](#рекомендуемая-конфигурация-буферного-пула)
- [70-80% от доступной памяти для выделенных серверов](#70-80-от-доступной-памяти-для-выделенных-серверов)
- [Размер экземпляра (для больших пулов)](#размер-экземпляра-для-больших-пулов)
- [Размер чанка (должен быть кратен instances)](#размер-чанка-должен-быть-кратен-instances)
- [Предварительная загрузка страниц](#предварительная-загрузка-страниц)
- [Очистка буфера](#очистка-буфера)
    - [Лог файлы](#лог-файлы)
- [Оптимизация redo logs](#оптимизация-redo-logs)
- [Размер лог файла (25% от buffer pool)](#размер-лог-файла-25-от-buffer-pool)
- [Количество лог файлов](#количество-лог-файлов)
- [Синхронизация логов](#синхронизация-логов)
- [Буфер логов](#буфер-логов)
    - [Прочие настройки **InnoDB**](#прочие-настройки-innodb)
- [Дополнительные оптимизации](#дополнительные-оптимизации)
- [Flush метод](#flush-метод)
- [Не флашить соседей (для SSD)](#не-флашить-соседей-для-ssd)
- [Размер страницы](#размер-страницы)
- [Адаптивный хэш индекс](#адаптивный-хэш-индекс)
- [Read ahead](#read-ahead)
  - [Оптимизация подключений](#оптимизация-подключений)
    - [**Thread pool**](#thread-pool)
- [Настройки подключений](#настройки-подключений)
- [Максимальное количество подключений](#максимальное-количество-подключений)
- [Размер стека потока](#размер-стека-потока)
- [Кэш таблиц](#кэш-таблиц)
...
- [Размер буфера для сортировки](#размер-буфера-для-сортировки)
- [Буфер случайного чтения](#буфер-случайного-чтения)
...
- [Конфигурация query cache](#конфигурация-query-cache)
...
- [Вывод топ запросов по времени выполнения](#вывод-топ-запросов-по-времени-выполнения)
- [Анализ по времени](#анализ-по-времени)
...
- [Предложения по индексам](#предложения-по-индексам)
