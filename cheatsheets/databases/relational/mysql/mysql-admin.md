...
tags: ["databases", "relational", "mysql-admin"]
...
- [Включение автозапуска](#включение-автозапуска)
- [Безопасная настройка (интерактивно)](#безопасная-настройка-интерактивно)
- [Или ручная настройка](#или-ручная-настройка)
    - [**CentOS**/**RHEL**](#centosrhel)
- [Установка из репозитория](#установка-из-репозитория)
- [Или для CentOS 8+](#или-для-centos-8)
- [Запуск сервиса](#запуск-сервиса)
- [Получение временного пароля](#получение-временного-пароля)
...
- [/etc/mysql/mysql.conf.d/mysqld.cnf или /etc/my.cnf](#etcmysqlmysqlconfdmysqldcnf-или-etcmycnf)
- [Основные настройки](#основные-настройки)
- [Данные](#данные)
- [Логирование](#логирование)
- [Безопасность](#безопасность)
- [InnoDB настройки](#innodb-настройки)
- [MyISAM (если используется)](#myisam-если-используется)
...
- [Проверка синтаксиса конфигурации](#проверка-синтаксиса-конфигурации)
...
- [MyISAM для аналитики](#myisam-для-аналитики)
...
- [Только структура (без данных)](#только-структура-без-данных)
- [Только данные (без структуры)](#только-данные-без-структуры)
...
- [Подготовка бэкапа](#подготовка-бэкапа)
- [Инкрементальный бэкап](#инкрементальный-бэкап)
- [Подготовка инкрементального бэкапа](#подготовка-инкрементального-бэкапа)
    - [Восстановление из **XtraBackup**](#восстановление-из-xtrabackup)
- [Остановка MySQL](#остановка-mysql)
- [Удаление старых данных](#удаление-старых-данных)
- [Восстановление](#восстановление)
- [Исправление прав](#исправление-прав)
- [Запуск MySQL](#запуск-mysql)
...
- [Ежедневный бэкап в 2:00](#ежедневный-бэкап-в-200)
- [Ежечасный бэкап binary logs](#ежечасный-бэкап-binary-logs)
...
- [Остановка приложений](#остановка-приложений)
[...](#)
- [Или для конкретной базы](#или-для-конкретной-базы)
- [Проверка](#проверка)
- [Восстановление полного бэкапа](#восстановление-полного-бэкапа)
- [Применение binary logs до нужного момента](#применение-binary-logs-до-нужного-момента)
- [Или по позиции](#или-по-позиции)
    - [Быстрое восстановление](#быстрое-восстановление)
- [Переименование старого datadir](#переименование-старого-datadir)
  - [Восстановление отдельных таблиц](#восстановление-отдельных-таблиц)
    - [Из полного бэкапа](#из-полного-бэкапа)
- [Извлечение таблицы из бэкапа](#извлечение-таблицы-из-бэкапа)
- [Создание временной базы](#создание-временной-базы)
- [Восстановление таблицы](#восстановление-таблицы)
...
- [Или](#или)
- [Ротация slow query log](#ротация-slow-query-log)
- [Настройка logrotate](#настройка-logrotate)
...
- [Установка MySQL Exporter](#установка-mysql-exporter)
- [Создание пользователя для мониторинга](#создание-пользователя-для-мониторинга)
- [Создание сервиса systemd](#создание-сервиса-systemd)
- [Конфигурационный файл](#конфигурационный-файл)
    - [**Dashboard** в **Grafana**](#dashboard-в-grafana)
  - [Защита сервера](#защита-сервера)
    - [**Firewall** настройки](#firewall-настройки)
- [Разрешить только локальные подключения](#разрешить-только-локальные-подключения)
- [Для приложений на том же сервере](#для-приложений-на-том-же-сервере)
- [Запретить внешние подключения](#запретить-внешние-подключения)
- [Проверка правил](#проверка-правил)
    - [**SSL**/**TLS** шифрование](#ssltls-шифрование)
- [Путь к сертификатам](#путь-к-сертификатам)
...
- [Обновление на Ubuntu/Debian](#обновление-на-ubuntudebian)
- [Обновление на CentOS/RHEL](#обновление-на-centosrhel)
- [Проверка известных уязвимостей](#проверка-известных-уязвимостей)
- [Используйте инструменты вроде OpenVAS или Nessus](#используйте-инструменты-вроде-openvas-или-nessus)
    - [Безопасная конфигурация](#безопасная-конфигурация)
- [Отключение опасных функций](#отключение-опасных-функций)
- [Ограничение ресурсов](#ограничение-ресурсов)
- [Безопасные пароли](#безопасные-пароли)
- [Отключение старых протоколов](#отключение-старых-протоколов)
...
- [Установка ProxySQL](#установка-proxysql)
- [Настройка](#настройка)
- [Подключение к административной консоли](#подключение-к-административной-консоли)
...
- [Web интерфейс: http://localhost:3000](#web-интерфейс-httplocalhost3000)
...
- [daily_mysql_maintenance.sh](#daily_mysql_maintenancesh)
- [Анализ таблиц](#анализ-таблиц)
- [Оптимизация фрагментированных таблиц](#оптимизация-фрагментированных-таблиц)
- [Очистка старых бэкапов (если автоматизированы)](#очистка-старых-бэкапов-если-автоматизированы)
    - [Мониторинг с алертами](#мониторинг-с-алертами)
- [mysql_monitor.sh](#mysql_monitorsh)
- [Пороги](#пороги)
