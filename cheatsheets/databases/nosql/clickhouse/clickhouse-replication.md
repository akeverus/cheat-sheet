...
- [Архитектура репликации](#архитектура-репликации)
  ...
  - [Роли в репликации](#роли-в-репликации)
    - [Leader Replica](#leader-replica)
    - [Follower Replicas](#follower-replicas)
...
- [ReplicatedMergeTree движок](#replicatedmergetree-движок)
  - [Создание реплицированной таблицы](#создание-реплицированной-таблицы)
  - [Параметры ReplicatedMergeTree](#параметры-replicatedmergetree)
  - [Создание реплик](#создание-реплик)
- [Настройка кластера](#настройка-кластера)
  - [Конфигурация кластера](#конфигурация-кластера)
  - [Создание таблиц на кластере](#создание-таблиц-на-кластере)
  - [Управление шардами](#управление-шардами)
- [Распределенные таблицы](#распределенные-таблицы)
  - [Создание распределенной таблицы](#создание-распределенной-таблицы)
  - [Функции шардирования](#функции-шардирования)
  - [Запросы к распределенным таблицам](#запросы-к-распределенным-таблицам)
- [Отказоустойчивость](#отказоустойчивость)
  - [Обработка отказов реплик](#обработка-отказов-реплик)
