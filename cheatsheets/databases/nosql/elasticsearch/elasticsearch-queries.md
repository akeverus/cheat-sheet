---
title: "Elasticsearch: Поиск и запросы - Полное руководство по поисковым запросам"
description: "Комплексное руководство по поисковым запросам Elasticsearch: от базовых до сложных запросов, фильтрация, сортировка, пагинация и оптимизация производительности поиска."
tags: ["databases", "nosql", "elasticsearch-queries"]
...
- [Search Best Practices](https://www.elastic.co/guide/en/elasticsearch/reference/current/tune-for-search-speed.html)
- [Query Optimization](https://www.elastic.co/guide/en/elasticsearch/reference/current/tune-for-search-speed.html)
- [Relevance Tuning](https://www.elastic.co/guide/en/elasticsearch/reference/current/index-modules-similarity.html)
...
- [Поиск всех документов](#поиск-всех-документов)
- [Поиск с q параметром](#поиск-с-q-параметром)
- [Поиск в нескольких индексах](#поиск-в-нескольких-индексах)
- [Поиск с лимитом](#поиск-с-лимитом)
- [Поиск с пагинацией](#поиск-с-пагинацией)
    - [**Request Body Search**](#request-body-search)
- [Поиск с request body](#поиск-с-request-body)
- [Поиск с сортировкой](#поиск-с-сортировкой)
- [Поиск с source filtering](#поиск-с-source-filtering)
  - [**Search Parameters**](#search-parameters)
    - [**Common Parameters**](#common-parameters)
- [Timeout](#timeout)
- [Routing](#routing)
- [Search type](#search-type)
- [Allow partial search results](#allow-partial-search-results)
- [**Query DSL**](#query-dsl)
  - [**Structure** of **Queries**](#structure-of-queries)
    - [**Query Context** vs **Filter Context**](#query-context-vs-filter-context)
    - [**Query** vs **Filter Performance**](#query-vs-filter-performance)
- [**Term Queries**](#term-queries)
  - [**Exact Value Queries**](#exact-value-queries)
    - [**Term Query**](#term-query)
- [Точное совпадение](#точное-совпадение)
- [Term с boost](#term-с-boost)
    - [**Terms Query**](#terms-query)
- [Несколько значений](#несколько-значений)
- [Terms lookup (динамические значения из другого документа)](#terms-lookup-динамические-значения-из-другого-документа)
    - [**Range Query**](#range-query)
- [Числовой диапазон](#числовой-диапазон)
- [Диапазон дат](#диапазон-дат)
- [Диапазон с относительными датами](#диапазон-с-относительными-датами)
    - [**Exists Query**](#exists-query)
- [Документы с непустым полем](#документы-с-непустым-полем)
- [Документы без поля](#документы-без-поля)
  - [**Prefix**, **Wildcard**, **and Regexp**](#prefix-wildcard-and-regexp)
    - [**Prefix Query**](#prefix-query)
- [Поиск по префиксу](#поиск-по-префиксу)
- [Prefix с boost](#prefix-с-boost)
    - [**Wildcard Query**](#wildcard-query)
- [Wildcard поиск](#wildcard-поиск)
- [Несколько wildcards](#несколько-wildcards)
    - [**Regexp Query**](#regexp-query)
- [Регулярные выражения](#регулярные-выражения)
- [Case-insensitive regexp](#case-insensitive-regexp)
- [**Full-text Queries**](#full-text-queries)
  - [**Match Queries**](#match-queries)
    - [**Match Query**](#match-query)
- [Базовый match](#базовый-match)
- [Match с параметрами](#match-с-параметрами)
    - [**Match Phrase**](#match-phrase)
- [Точная фраза](#точная-фраза)
- [Match phrase с slop](#match-phrase-с-slop)
...
- [Поиск в нескольких полях](#поиск-в-нескольких-полях)
- [Cross-fields search](#cross-fields-search)
- [Phrase search в нескольких полях](#phrase-search-в-нескольких-полях)
...
- [Must, should, must_not, filter](#must-should-must_not-filter)
    - [**Nested Bool Queries**](#nested-bool-queries)
- [Сложные логические выражения](#сложные-логические-выражения)
  - [**Boosting Query**](#boosting-query)
    - [**Negative Boosting**](#negative-boosting)
- [Повышение релевантности одних документов над другими](#повышение-релевантности-одних-документов-над-другими)
  - [**Constant Score Query**](#constant-score-query)
    - [**Filter** as **Query**](#filter-as-query)
- [Преобразование фильтра в запрос с постоянным score](#преобразование-фильтра-в-запрос-с-постоянным-score)
- [Использование для кэшированных фильтров](#использование-для-кэшированных-фильтров)
  - [**Disjunction Max Query**](#disjunction-max-query)
    - [**Best Fields Search**](#best-fields-search)
- [Поиск лучшего поля](#поиск-лучшего-поля)
- [**Geo Queries**](#geo-queries)
  - [**Geo-point Queries**](#geo-point-queries)
    - [**Geo Distance Query**](#geo-distance-query)
- [Поиск в радиусе](#поиск-в-радиусе)
- [Сортировка по расстоянию](#сортировка-по-расстоянию)
    - [**Geo Bounding Box**](#geo-bounding-box)
- [Прямоугольная область](#прямоугольная-область)
- [Well-known text (WKT)](#well-known-text-wkt)
  - [**Geo-shape Queries**](#geo-shape-queries)
    - [**Complex Shapes**](#complex-shapes)
- [Geo shape с polygon](#geo-shape-с-polygon)
- [Geo shape с stored shapes](#geo-shape-с-stored-shapes)
- [**Nested Queries**](#nested-queries)
  - [**Nested Objects Search**](#nested-objects-search)
    - [**Nested Query**](#nested-query)
- [Поиск в nested объектах](#поиск-в-nested-объектах)
- [Nested с inner hits](#nested-с-inner-hits)
    - [**Parent-Child Relationships**](#parent-child-relationships)
- [Join queries (parent-child)](#join-queries-parent-child)
- [Child с parent](#child-с-parent)
- [**Function Score Queries**](#function-score-queries)
  - [**Score Modification**](#score-modification)
    - [**Boost** by **Field Value**](#boost-by-field-value)
- [Boost на основе числового поля](#boost-на-основе-числового-поля)
    - [**Time-based Decay**](#time-based-decay)
- [Decay по времени (свежие документы получают boost)](#decay-по-времени-свежие-документы-получают-boost)
    - [**Custom Scoring Scripts**](#custom-scoring-scripts)
- [Пользовательские scoring функции](#пользовательские-scoring-функции)
- [**Filtering** и **Post-filtering**](#filtering-и-post-filtering)
  - [**Pre-filtering** vs **Post-filtering**](#pre-filtering-vs-post-filtering)
    - [**Search with Filters**](#search-with-filters)
- [Pre-filtering (рекомендуется)](#pre-filtering-рекомендуется)
- [Post-filtering (для фасетов)](#post-filtering-для-фасетов)
- [**Sorting** и **Relevance**](#sorting-и-relevance)
  - [**Sort Options**](#sort-options)
    - [**Field-based Sorting**](#field-based-sorting)
- [Сортировка по полю](#сортировка-по-полю)
- [Сортировка с missing values](#сортировка-с-missing-values)
    - [**Script-based Sorting**](#script-based-sorting)
- [Сортировка с script](#сортировка-с-script)
  - [**Relevance Tuning**](#relevance-tuning)
    - [**Custom Scoring**](#custom-scoring)
- [Explicit score](#explicit-score)
    - [**Explain API**](#explain-api)
- [Получить объяснение scoring](#получить-объяснение-scoring)
- [Explain для конкретного документа](#explain-для-конкретного-документа)
- [**Pagination**](#pagination)
  - [**From**/**Size Pagination**](#fromsize-pagination)
    - [**Basic Pagination**](#basic-pagination)
- [Первая страница](#первая-страница)
- [Вторая страница](#вторая-страница)
  - [**Search After**](#search-after)
    - [**Cursor-based Pagination**](#cursor-based-pagination)
- [Вторая страница (используя последний _id первой страницы)](#вторая-страница-используя-последний-_id-первой-страницы)
  - [**Scroll API**](#scroll-api)
    - [**Deep Pagination**](#deep-pagination)
- [Инициализация scroll](#инициализация-scroll)
- [Получение следующей порции (используя scroll_id из ответа)](#получение-следующей-порции-используя-scroll_id-из-ответа)
- [Очистка scroll context](#очистка-scroll-context)
- [**Search Templates**](#search-templates)
  - [**Mustache Templates**](#mustache-templates)
    - [**Template Definition**](#template-definition)
- [Сохранение шаблона](#сохранение-шаблона)
- [Использование шаблона](#использование-шаблона)
  - [**Stored Scripts**](#stored-scripts)
    - [**Script Management**](#script-management)
- [Список всех scripts](#список-всех-scripts)
- [Получение script](#получение-script)
- [Удаление script](#удаление-script)
...
**Медленные поисковые запросы:** уменьшите размер выборки и число полей в `_source`, используйте `filter` вместо `query` там, где не нужна оценка релевантности. Добавьте кэширование для повторяющихся фильтров. Проверьте размер индекса и при необходимости разбейте по шардам или используйте rollup.

**Таймауты (timeout):** увеличьте `timeout` в запросе для тяжёлых запросов, но в приоритете — оптимизация: ограничьте `size`/`from`, используйте `search_after` вместо глубокой пагинации, уберите тяжёлые агрегации или вынесите их в отдельные запросы.

**Ошибки circuit breaker или OutOfMemory:** уменьшите размер батчей при индексации, увеличьте heap для узлов или добавьте узлы. Проверьте агрегации с большими кардинальностями — ограничьте `size` в terms-агрегации, используйте composite aggregation для глубоких разбиений.
