...
tags: ["databases", "nosql", "elasticsearch-clustering"]
...
- [elasticsearch.yml for master-eligible node](#elasticsearchyml-for-master-eligible-node)
- [Master node settings](#master-node-settings)
- [JVM settings for master nodes](#jvm-settings-for-master-nodes)
- [Disable data operations](#disable-data-operations)
    - [**Master Election Process**](#master-election-process)
- [elasticsearch.yml for data node](#elasticsearchyml-for-data-node)
- [Data node settings](#data-node-settings)
- [JVM settings for data nodes (higher memory)](#jvm-settings-for-data-nodes-higher-memory)
- [Thread pools for data operations](#thread-pools-for-data-operations)
- [Disable master operations](#disable-master-operations)
  - [**Coordinating Nodes**](#coordinating-nodes)
    - [**Load Balancer Configuration**](#load-balancer-configuration)
- [elasticsearch.yml for coordinating node](#elasticsearchyml-for-coordinating-node)
- [Coordinating node settings](#coordinating-node-settings)
- [JVM settings](#jvm-settings)
- [Thread pools for coordination](#thread-pools-for-coordination)
- [Disable data and master operations](#disable-data-and-master-operations)
  - [**Ingest Nodes**](#ingest-nodes)
    - [**Data Processing Configuration**](#data-processing-configuration)
- [elasticsearch.yml for ingest node](#elasticsearchyml-for-ingest-node)
- [Ingest node settings](#ingest-node-settings)
- [Pipeline configurations](#pipeline-configurations)
- [Thread pools for ingest](#thread-pools-for-ingest)
...
- [For cloud environments](#for-cloud-environments)
- [EC2 discovery settings](#ec2-discovery-settings)
  - [**Cluster Bootstrap**](#cluster-bootstrap)
    - [**Initial Cluster Formation**](#initial-cluster-formation)
- [Start first master-eligible node](#start-first-master-eligible-node)
- [Start second master-eligible node](#start-second-master-eligible-node)
- [Start third master-eligible node](#start-third-master-eligible-node)
...
- [Check current allocation](#check-current-allocation)
- [Move shard manually](#move-shard-manually)
...
- [1. Prepare new node](#1-prepare-new-node)
- [Configure elasticsearch.yml](#configure-elasticsearchyml)
- [2. Start new node](#2-start-new-node)
- [3. Verify node joined cluster](#3-verify-node-joined-cluster)
- [4. Check shard allocation](#4-check-shard-allocation)
- [5. Force rebalancing if needed](#5-force-rebalancing-if-needed)
    - [**Automated Node Provisioning**](#automated-node-provisioning)
  - [**Vertical Scaling**](#vertical-scaling)
    - [**Node Upgrade**](#node-upgrade)
- [1. Disable shard allocation](#1-disable-shard-allocation)
- [2. Stop node](#2-stop-node)
- [3. Upgrade infrastructure (CPU, RAM, disk)](#3-upgrade-infrastructure-cpu-ram-disk)
- [This is done at the VM/hypervisor level](#this-is-done-at-the-vmhypervisor-level)
- [4. Start node](#4-start-node)
- [5. Enable shard allocation](#5-enable-shard-allocation)
- [6. Wait for cluster to stabilize](#6-wait-for-cluster-to-stabilize)
- [Мониторинг кластера](#мониторинг-кластера)
  - [**Cluster Health API**](#cluster-health-api)
    - [**Health Monitoring**](#health-monitoring)
- [Basic cluster health](#basic-cluster-health)
- [Detailed health with explanations](#detailed-health-with-explanations)
- [Wait for specific status](#wait-for-specific-status)
- [Health for specific indices](#health-for-specific-indices)
...
- [Hot nodes](#hot-nodes)
- [Warm nodes](#warm-nodes)
- [Cold nodes](#cold-nodes)
...
- [Update transient settings](#update-transient-settings)
- [Update persistent settings](#update-persistent-settings)
    - [**Cluster Reroute API**](#cluster-reroute-api)
- [Manual shard allocation](#manual-shard-allocation)
  - [**Node APIs**](#node-apis)
    - [**Node Information**](#node-information)
- [Node info](#node-info)
- [Specific node info](#specific-node-info)
- [Node stats](#node-stats)
- [Node JVM stats](#node-jvm-stats)
- [Node OS stats](#node-os-stats)
  - [**Cluster State API**](#cluster-state-api)
    - [**State Information**](#state-information)
- [Get cluster state](#get-cluster-state)
- [State with specific metrics](#state-with-specific-metrics)
- [State for specific indices](#state-for-specific-indices)
- [**Troubleshooting**](#решение-проблем)
  - [**Common Cluster Issues**](#common-cluster-issues)
    - [**Red Cluster Status**](#red-cluster-status)
- [Check unassigned shards](#check-unassigned-shards)
- [Common reasons for unassigned shards:](#common-reasons-for-unassigned-shards)
- [Try to allocate unassigned shards](#try-to-allocate-unassigned-shards)
    - [**Yellow Cluster Status**](#yellow-cluster-status)
- [Yellow status means some replicas are unassigned](#yellow-status-means-some-replicas-are-unassigned)
- [This is normal for single-node clusters](#this-is-normal-for-single-node-clusters)
- [Check shard allocation](#check-shard-allocation)
- [For multi-node clusters, ensure replicas can be allocated](#for-multi-node-clusters-ensure-replicas-can-be-allocated)
    - [**High CPU Usage**](#high-cpu-usage)
- [Check hot threads](#check-hot-threads)
- [Check thread pools](#check-thread-pools)
- [Check slow queries](#check-slow-queries)
    - [**Memory Issues**](#memory-issues)
- [Check JVM memory](#check-jvm-memory)
- [Check circuit breaker](#check-circuit-breaker)
- [Force garbage collection (use carefully)](#force-garbage-collection-use-carefully)
...
- [Check cluster name match](#check-cluster-name-match)
- [Check seed hosts](#check-seed-hosts)
...
- [Check thread dumps](#check-thread-dumps)
  - [**Index Issues**](#index-issues)
    - [**Index Creation Failures**](#index-creation-failures)
- [Check index settings](#check-index-settings)
- [Check disk space](#check-disk-space)
    - [**Search Issues**](#search-issues)
- [Enable slow log](#enable-slow-log)
- [Check search stats](#check-search-stats)
