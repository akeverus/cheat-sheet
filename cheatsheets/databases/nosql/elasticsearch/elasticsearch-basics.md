...
- [Создание пользователя elasticsearch](#создание-пользователя-elasticsearch)
...
- [Discovery (single node)](#discovery-single-node)
...
- [Установка паролей](#установка-паролей)
...
- [Создание индекса с настройками по умолчанию](#создание-индекса-с-настройками-по-умолчанию)
- [Создание индекса с кастомными настройками](#создание-индекса-с-кастомными-настройками)
    - [**Index Templates**](#index-templates)
- [Создание шаблона для индексов логов](#создание-шаблона-для-индексов-логов)
- [Index Lifecycle Management (ILM)](#index-lifecycle-management-ilm)
  - [Управление индексами](#управление-индексами)
    - [**Index Operations**](#index-operations)
- [Получение информации об индексе](#получение-информации-об-индексе)
- [Получение настроек индекса](#получение-настроек-индекса)
- [Получение mapping индекса](#получение-mapping-индекса)
- [Изменение настроек индекса](#изменение-настроек-индекса)
- [Закрытие индекса](#закрытие-индекса)
- [Открытие индекса](#открытие-индекса)
- [Удаление индекса](#удаление-индекса)
    - [**Index Aliases**](#index-aliases)
- [Создание алиаса](#создание-алиаса)
- [Алиас с фильтром](#алиас-с-фильтром)
- [Переключение алиаса (blue-green deployment)](#переключение-алиаса-blue-green-deployment)
