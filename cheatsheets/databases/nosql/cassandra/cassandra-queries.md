...
- [Подключение к локальному кластеру](#подключение-к-локальному-кластеру)
- [Подключение к удаленному кластеру](#подключение-к-удаленному-кластеру)
- [Выполнение файла с запросами](#выполнение-файла-с-запросами)
- [Выполнение одиночного запроса](#выполнение-одиночного-запроса)
- [Подключение с SSL](#подключение-с-ssl)
    - [Конфигурация cqlsh](#конфигурация-cqlsh)
- [Создание конфигурационного файла ~/.cassandra/cqlshrc](#создание-конфигурационного-файла-cassandracqlshrc)
