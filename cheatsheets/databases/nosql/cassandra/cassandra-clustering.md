---
title: "Cassandra: Кластеризация - Управление узлами и масштабирование"
description: "Комплексное руководство по развертыванию, управлению и масштабированию кластеров Apache Cassandra: топологии, стратегии репликации, балансировка нагрузки и отказоустойчивость."
tags: ["databases", "nosql", "cassandra-clustering"]
...
- [Operating Cassandra](https://cassandra.apache.org/doc/latest/operating/)
- [Cassandra Cluster Management](https://cassandra.apache.org/doc/latest/operating/nodes.html)

### Дизайн и архитектура
- [DataStax Architecture Guide](https://docs.datastax.com/en/dse-planning/doc/planning/planningArchitecture.html)
- [Cassandra Ring Architecture](https://cassandra.apache.org/doc/latest/architecture/dynamo.html)
...
- [Архитектура кластера](#архитектура-кластера)
  ...
  - [**Seed Nodes**](#seed-nodes)
    - [Конфигурация **seed nodes**](#конфигурация-seed-nodes)
- [cassandra.yaml](#cassandrayaml)
- [Рекомендации по выбору seed nodes](#рекомендации-по-выбору-seed-nodes)
    - [Управление **seed nodes**](#управление-seed-nodes)
- [Топологии развертывания](#топологии-развертывания)
  - [**Single Data Center**](#single-data-center)
    - [Простая топология](#простая-топология)
- [Топология: 1 датацентр, 3 узла](#топология-1-датацентр-3-узла)
- [Использование: development, small production](#использование-development-small-production)
- [Конфигурация узлов](#конфигурация-узлов)
- [Node 1: seed node](#node-1-seed-node)
- [Node 2](#node-2)
- [Node 3](#node-3)
    - [Настройка **keyspace**](#настройка-keyspace)
  - [**Multiple Data Centers**](#multiple-data-centers)
    - [**Active-Active** топология](#active-active-топология)
- [Топология: 2 датацентра, по 3 узла в каждом](#топология-2-датацентра-по-3-узла-в-каждом)
- [Использование: global applications, disaster recovery](#использование-global-applications-disaster-recovery)
- [Data Center 1 (US-West)](#data-center-1-us-west)
- [Node 1-1: seed node DC1](#node-1-1-seed-node-dc1)
- [Node 1-2](#node-1-2)
- [Node 1-3](#node-1-3)
- [Data Center 2 (US-East)](#data-center-2-us-east)
- [Node 2-1: seed node DC2](#node-2-1-seed-node-dc2)
- [Node 2-2](#node-2-2)
- [Node 2-3](#node-2-3)
    - [Настройка **keyspace** для **multi-DC**](#настройка-keyspace-для-multi-dc)
  - [**Hybrid Cloud Topologies**](#hybrid-cloud-topologies)
    - [**On-Premise** + **Cloud**](#on-premise-cloud)
- [cassandra.yaml для hybrid deployment](#cassandrayaml-для-hybrid-deployment)
- [Data Center 1: On-premise](#data-center-1-on-premise)
- [Data Center 2: AWS](#data-center-2-aws)
- [Data Center 3: Azure](#data-center-3-azure)
- [Endpoint snitch для определения DC на основе IP](#endpoint-snitch-для-определения-dc-на-основе-ip)
- [PropertyFileSnitch для определения DC/rack](#propertyfilesnitch-для-определения-dcrack)
- [/etc/cassandra/cassandra-topology.properties](#etccassandracassandra-topologyproperties)
- [192.168.1.10=DC1:RAC1](#192168110dc1rac1)
- [192.168.1.11=DC1:RAC1](#192168111dc1rac1)
- [10.0.1.10=DC2:RAC2     # AWS](#100110dc2rac2-aws)
- [10.0.1.11=DC2:RAC2     # AWS](#100111dc2rac2-aws)
- [10.0.2.10=DC3:RAC3     # Azure](#100210dc3rac3-azure)
- [10.0.2.11=DC3:RAC3     # Azure](#100211dc3rac3-azure)
- [Управление узлами](#управление-узлами)
  - [Добавление узла](#добавление-узла)
    - [Процесс добавления](#процесс-добавления)
- [1. Подготовка нового узла](#1-подготовка-нового-узла)
- [Установка Cassandra](#установка-cassandra)
- [2. Конфигурация cassandra.yaml](#2-конфигурация-cassandrayaml)
- [3. Запуск узла](#3-запуск-узла)
- [4. Проверка статуса](#4-проверка-статуса)
- [5. Ожидание завершения bootstrap](#5-ожидание-завершения-bootstrap)
    - [Автоматизированное добавление](#автоматизированное-добавление)
  - [Удаление узла](#удаление-узла)
    - [**Graceful decommission**](#graceful-decommission)
- [1. Проверка возможности удаления](#1-проверка-возможности-удаления)
- [2. Запуск decommission](#2-запуск-decommission)
- [3. Мониторинг процесса](#3-мониторинг-процесса)
- [4. Ожидание завершения](#4-ожидание-завершения)
...
- [3. Очистка данных (если необходимо)](#3-очистка-данных-если-необходимо)
- [4. Проверка распределения данных](#4-проверка-распределения-данных)
    - [Автоматизированное удаление](#автоматизированное-удаление)
  - [Замена узла](#замена-узла)
    - [Процесс замены](#процесс-замены)
- [Конфигурация как у заменяемого узла](#конфигурация-как-у-заменяемого-узла)
- [Но с новым IP адресом](#но-с-новым-ip-адресом)
- [2. Запуск нового узла](#2-запуск-нового-узла)
- [3. Ожидание присоединения](#3-ожидание-присоединения)
- [4. Удаление старого узла](#4-удаление-старого-узла)
...
- [Стратегии репликации](#стратегии-репликации)
  - [**NetworkTopologyStrategy**](#networktopologystrategy)
    - [Конфигурация для разных топологий](#конфигурация-для-разных-топологий)
    - [Расчет оптимального **replication factor**](#расчет-оптимального-replication-factor)
  - [**Consistency Levels**](#consistency-levels)
    - [Настройка консистентности](#настройка-консистентности)
    - [Программная настройка консистентности](#программная-настройка-консистентности)
- [Балансировка нагрузки](#балансировка-нагрузки)
  - [**Token Distribution**](#token-distribution)
    - [**Vnodes** vs **Single Token**](#vnodes-vs-single-token)
  - [**Rebalancing**](#rebalancing)
    - [Ручное перебалансирование](#ручное-перебалансирование)
- [1. Проверка текущего распределения](#1-проверка-текущего-распределения)
- [2. Проверка распределения токенов](#2-проверка-распределения-токенов)
- [3. Перемещение токенов (если необходимо)](#3-перемещение-токенов-если-необходимо)
- [5. Запуск cleanup на всех узлах](#5-запуск-cleanup-на-всех-узлах)
    - [Автоматизированное перебалансирование](#автоматизированное-перебалансирование)
- [Отказоустойчивость](#отказоустойчивость)
  - [**Failure Detection**](#failure-detection)
    - [**Phi Accrual Failure Detector**](#phi-accrual-failure-detector)
  - [**Hinted Handoff**](#hinted-handoff)
    - [Механизм **hinted handoff**](#механизм-hinted-handoff)
  - [**Read Repair**](#read-repair)
    - [Механизм **read repair**](#механизм-read-repair)
- [Масштабирование кластера](#масштабирование-кластера)
  - [**Horizontal Scaling**](#horizontal-scaling)
    - [Добавление датацентра](#добавление-датацентра)
- [1. Подготовка новых узлов](#1-подготовка-новых-узлов)
- [Конфигурация для нового DC](#конфигурация-для-нового-dc)
- [2. Запуск узлов нового DC](#2-запуск-узлов-нового-dc)
- [С правильной конфигурацией DC/rack](#с-правильной-конфигурацией-dcrack)
- [4. Обновление keyspaces для нового DC](#4-обновление-keyspaces-для-нового-dc)
- [5. Запуск repair для синхронизации данных](#5-запуск-repair-для-синхронизации-данных)
    - [Автоматизированное масштабирование](#автоматизированное-масштабирование)
  - [**Vertical Scaling**](#vertical-scaling)
    - [Увеличение ресурсов узла](#увеличение-ресурсов-узла)
- [1. Остановка Cassandra](#1-остановка-cassandra)
- [2. Увеличение ресурсов (CPU, RAM, Disk)](#2-увеличение-ресурсов-cpu-ram-disk)
- [На уровне виртуальной машины или физического сервера](#на-уровне-виртуальной-машины-или-физического-сервера)
- [3. Запуск Cassandra](#3-запуск-cassandra)
- [5. Rebalancing если необходимо](#5-rebalancing-если-необходимо)
- [Мониторинг кластера](#мониторинг-кластера)
  - [**Nodetool Commands**](#nodetool-commands)
    - [Основные команды мониторинга](#основные-команды-мониторинга)
- [Статус кластера](#статус-кластера)
- [Информация об узле](#информация-об-узле)
- [Статистика ring](#статистика-ring)
- [Статистика таблиц](#статистика-таблиц)
- [Статистика compaction](#статистика-compaction)
- [Статистика garbage collection](#статистика-garbage-collection)
- [Сетевая статистика](#сетевая-статистика)
- [Статистика потоков](#статистика-потоков)
    - [Продвинутые команды](#продвинутые-команды)
- [Детальная информация о таблице](#детальная-информация-о-таблице)
- [Статистика кэша](#статистика-кэша)
- [Статистика proxy](#статистика-proxy)
- [Снимок heap](#снимок-heap)
- [Проверка консистентности](#проверка-консистентности)
...
- [cassandra:latest](#cassandralatest)
    - [Конфигурация **JMX Exporter**](#конфигурация-jmx-exporter)
- [jmx-config.yml](#jmx-configyml)
- [Резервное копирование](#резервное-копирование)
  - [**Snapshot-based Backup**](#snapshot-based-backup)
    - [Создание **snapshot**](#создание-snapshot)
- [1. Создание snapshot для всех keyspaces](#1-создание-snapshot-для-всех-keyspaces)
- [2. Создание snapshot для конкретного keyspace](#2-создание-snapshot-для-конкретного-keyspace)
- [3. Создание именованного snapshot](#3-создание-именованного-snapshot)
- [4. Проверка snapshots](#4-проверка-snapshots)
- [5. Копирование файлов snapshot](#5-копирование-файлов-snapshot)
- [Из /var/lib/cassandra/data/ копировать .db файлы](#из-varlibcassandradata-копировать-db-файлы)
    - [Восстановление из **snapshot**](#восстановление-из-snapshot)
- [2. Очистка данных (если необходимо)](#2-очистка-данных-если-необходимо)
- [3. Копирование файлов snapshot](#3-копирование-файлов-snapshot)
- [В соответствующие директории таблиц](#в-соответствующие-директории-таблиц)
- [4. Запуск Cassandra](#4-запуск-cassandra)
- [5. Repair для восстановления консистентности](#5-repair-для-восстановления-консистентности)
  - [**Incremental Backup**](#incremental-backup)
    - [Настройка **incremental backup**](#настройка-incremental-backup)
- [Автоматическое создание incremental backups](#автоматическое-создание-incremental-backups)
- [Каждый compaction создает hard link на SSTable файлы](#каждый-compaction-создает-hard-link-на-sstable-файлы)
    - [Использование **incremental backup**](#использование-incremental-backup)
- [1. Поиск incremental backup файлов](#1-поиск-incremental-backup-файлов)
- [2. Копирование backup файлов](#2-копирование-backup-файлов)
- [Сохранять вместе со snapshot](#сохранять-вместе-со-snapshot)
- [3. Восстановление](#3-восстановление)
- [Сначала восстановить snapshot, затем скопировать incremental файлы](#сначала-восстановить-snapshot-затем-скопировать-incremental-файлы)
  - [**Medusa Backup Tool**](#medusa-backup-tool)
    - [Настройка **Medusa**](#настройка-medusa)
- [/etc/medusa/medusa.ini](#etcmedusamedusaini)
    - [Использование **Medusa**](#использование-medusa)
- [Создание backup](#создание-backup)
- [Список backups](#список-backups)
- [Восстановление](#восстановление)
- [Проверка статуса](#проверка-статуса)
- [Восстановление после сбоев](#восстановление-после-сбоев)
  - [**Node Recovery**](#node-recovery)
    - [Восстановление упавшего узла](#восстановление-упавшего-узла)
- [1. Проверка что узел недоступен](#1-проверка-что-узел-недоступен)
- [2. Запуск узла](#2-запуск-узла)
- [4. Проверка данных](#4-проверка-данных)
- [5. Repair для синхронизации](#5-repair-для-синхронизации)
    - [Полное восстановление узла](#полное-восстановление-узла)
- [2. Очистка данных](#2-очистка-данных)
- [3. Восстановление из backup](#3-восстановление-из-backup)
- [Копирование snapshot и incremental файлов](#копирование-snapshot-и-incremental-файлов)
- [5. Ожидание загрузки данных](#5-ожидание-загрузки-данных)
- [6. Repair](#6-repair)
  - [**Data Center Recovery**](#data-center-recovery)
    - [Восстановление датацентра](#восстановление-датацентра)
- [1. Проверка доступности DC](#1-проверка-доступности-dc)
- [2. Восстановление seed nodes](#2-восстановление-seed-nodes)
- [Запуск seed nodes в пострадавшем DC](#запуск-seed-nodes-в-пострадавшем-dc)
- [3. Восстановление остальных nodes](#3-восстановление-остальных-nodes)
- [По одному для предотвращения перегрузки](#по-одному-для-предотвращения-перегрузки)
- [4. Обновление replication factors если необходимо](#4-обновление-replication-factors-если-необходимо)
- [5. Синхронизация данных](#5-синхронизация-данных)
- [6. Восстановление полного RF](#6-восстановление-полного-rf)
  - [**Disaster Recovery**](#disaster-recovery)
    - [План **disaster recovery**](#план-disaster-recovery)
- [Лучшие практики](#лучшие-практики)
  - [Планирование кластера](#планирование-кластера)
    - [1. **Capacity Planning**](#1-capacity-planning)
    - [2. Топология](#2-топология)
  ...
  - [Масштабирование](#масштабирование)
    ...
    - [1. Стратегия **backup**](#1-стратегия-backup)
    - [2. **Disaster Recovery**](#2-disaster-recovery)
  - [Решение проблем](#решение-проблем)
    - [1. Распространенные проблемы](#1-распространенные-проблемы)
...
- [Решение проблем](#решение-проблем)
  ...
  - [Репликация и консистентность:](#репликация-и-консистентность)
  - [Масштабирование и балансировка:](#масштабирование-и-балансировка)
