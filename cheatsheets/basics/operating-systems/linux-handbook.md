...
- [Работа с процессами](#работа-с-процессами)
  ...
  - [Фон и job-control](#фон-и-job-control)
- [Сигналы](#сигналы)
- [Файловые дескрипторы и лимиты](#файловые-дескрипторы-и-лимиты)
  - [fd 0/1/2](#fd-012)
  - [Лимиты процесса (ulimit)](#лимиты-процесса-ulimit)
- [Bash: основы скриптования](#bash-основы-скриптования)
  - [Shebang и запуск](#shebang-и-запуск)
  - [Безопасные настройки](#безопасные-настройки)
...
- [Пайпы, редиректы, subshell](#пайпы-редиректы-subshell)
  - [Редиректы](#редиректы)
  - [Пайп](#пайп)
  - [Subshell vs source](#subshell-vs-source)
  - [trap — cleanup при выходе](#trap-cleanup-при-выходе)
- [Поиск файлов и текста](#поиск-файлов-и-текста)
  - [find](#find)
  - [grep / ripgrep](#grep-ripgrep)
  - [awk, sed](#awk-sed)
  - [xargs](#xargs)
- [systemd](#systemd)
  - [Управление сервисами](#управление-сервисами)
  - [Unit-файл сервиса](#unit-файл-сервиса)
  - [Типы сервисов](#типы-сервисов)
  - [Зависимости и порядок](#зависимости-и-порядок)
- [cron и systemd timers](#cron-и-systemd-timers)
  - [cron](#cron)
  - [systemd timer](#systemd-timer)
- [Логи и journald](#логи-и-journald)
  - [journalctl](#journalctl)
  - [Традиционные логи](#традиционные-логи)
  - [logrotate](#logrotate)
- [Сеть](#сеть)
  - [Интерфейсы и маршруты](#интерфейсы-и-маршруты)
  - [DNS](#dns)
  - [Диагностика доступности](#диагностика-доступности)
  - [Слушающие порты и соединения](#слушающие-порты-и-соединения)
  - [tcpdump](#tcpdump)
  - [Firewall](#firewall)
...
- [Производительность и профилирование](#производительность-и-профилирование)
  ...
  - [IO](#io)
  - [Сеть](#сеть-1)
  - [eBPF-инструменты](#ebpf-инструменты)
...
- [Переменные окружения и конфиги shell](#переменные-окружения-и-конфиги-shell)
  - [Какой файл читается когда](#какой-файл-читается-когда)
  - [Env variables](#env-variables)
  - [Системные env](#системные-env)
- [Типичные задачи на проде](#типичные-задачи-на-проде)
  - [«Диск забит»](#диск-забит)
  - [«Процесс съедает CPU/память»](#процесс-съедает-cpuпамять)
  - [«Процесс завис в D»](#процесс-завис-в-d)
  - [«Лог не крутится»](#лог-не-крутится)
  - [«SSH не логинит»](#ssh-не-логинит)
  - [Сбор thread-dump JVM](#сбор-thread-dump-jvm)
  - [Проверить слушающий порт снаружи](#проверить-слушающий-порт-снаружи)
  - [Траблшут скачка 5xx в nginx](#траблшут-скачка-5xx-в-nginx)
  - [Быстрый replace во многих файлах](#быстрый-replace-во-многих-файлах)
