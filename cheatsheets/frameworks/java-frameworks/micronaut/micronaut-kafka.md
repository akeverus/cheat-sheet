...
- [Kafka Producers](#kafka-producers)
  ...
  - [Producer с Callback](#producer-с-callback)
  - [Использование Producer](#использование-producer)
...
- [✅ Хорошо](#хорошо)
  ...
  - [5. Настраивайте transactions для критических операций](#5-настраивайте-transactions-для-критических-операций)
- [Kafka Streams Advanced](#kafka-streams-advanced)
  - [Stream Processing with State](#stream-processing-with-state)
