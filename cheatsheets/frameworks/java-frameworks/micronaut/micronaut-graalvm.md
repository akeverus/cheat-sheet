...
- [Используя SDKMAN](#используя-sdkman)
- [Или скачать с официального сайта](#или-скачать-с-официального-сайта)
- [https://www.graalvm.org/downloads/](#httpswwwgraalvmorgdownloads)
...
- [Включите verbose output](#включите-verbose-output)
- [Проверьте reflection configuration](#проверьте-reflection-configuration)
- [Проверьте resource inclusion](#проверьте-resource-inclusion)
...
- [Инкрементальная сборка (быстрее)](#инкрементальная-сборка-быстрее)
  - [Build Caching](#build-caching)
- [Runtime Configuration](#runtime-configuration)
  - [Runtime Options](#runtime-options)
- [Запуск с дополнительными опциями](#запуск-с-дополнительными-опциями)
...
- [Генерация build profile](#генерация-build-profile)
