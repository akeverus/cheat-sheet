...
- [Мониторинг и метрики](#мониторинг-и-метрики)
  - [R2DBC Metrics](#r2dbc-metrics)
- [Лучшие практики](#лучшие-практики)
  - [1. Используйте реактивные типы](#1-используйте-реактивные-типы)
  ...
  - [4. Настраивайте connection pooling](#4-настраивайте-connection-pooling)
  - [5. Используйте правильные типы данных](#5-используйте-правильные-типы-данных)
- [Продвинутые возможности](#продвинутые-возможности)
  - [Batch Operations](#batch-operations)
  - [Custom Row Mapping](#custom-row-mapping)
  - [Stored Procedures](#stored-procedures)
- [Интеграция с WebFlux](#интеграция-с-webflux)
...
- [Реактивные транзакции (расширенные)](#реактивные-транзакции-расширенные)
  - [Nested Transactions](#nested-transactions)
  - [Transaction Propagation](#transaction-propagation)
- [Реактивные миграции](#реактивные-миграции)
  - [Database Migrations](#database-migrations)
- [Продвинутые паттерны](#продвинутые-паттерны)
  - [Reactive Repository Customization](#reactive-repository-customization)
  - [Reactive Caching](#reactive-caching)
  - [Reactive Error Recovery](#reactive-error-recovery)
  - [Reactive Batch Processing](#reactive-batch-processing)
...
- [**R2DBC** Specification](https://r2dbc.io/spec/0.9.0.RELEASE/spec/)
