...
- [Quarkus](../../../basics/README.md) — построен на Vert.x
...
- Сравнение JVM-фреймворков — [README](../../../basics/README.md)
- Reactive patterns — [patterns](../../../basics/README.md)
- Messaging — [development/messaging](../../../basics/README.md)
