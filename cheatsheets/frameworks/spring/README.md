...
> **Внимание:** это legacy-папка. Основной, актуальный контент по Spring живёт в **[frameworks/java-frameworks/spring/](../java-frameworks/spring/README.md)** — там разделённые документы по Spring Core, Boot, MVC, WebFlux, Data JPA, Security, Cloud, Kafka, Actuator и другим модулям.
...
- [Spring (актуальный раздел)](../java-frameworks/spring/README.md) — полный индекс
...
|-------------|---------------------|
| `spring-core.md` | [../java-frameworks/spring/spring-core.md](../java-frameworks/spring/spring-core.md) |
| `spring-boot.md` | [../java-frameworks/spring/spring-boot.md](../java-frameworks/spring/spring-boot.md) |
| `spring-data.md` | [../java-frameworks/spring/spring-data-jpa.md](../java-frameworks/spring/spring-data-jpa.md) + [spring-data-jdbc.md](../java-frameworks/spring/spring-data-jdbc.md) + [spring-r2dbc.md](../java-frameworks/spring/spring-r2dbc.md) |
| Остальные модули | см. [../java-frameworks/spring/README.md](../java-frameworks/spring/README.md) |

## Маршруты чтения

- **Вы попали сюда по ссылке:** идите в [каноничный раздел](../java-frameworks/spring/README.md) — там структура актуальна.
