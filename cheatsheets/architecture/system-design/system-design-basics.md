...
- [Основы проектирования систем (System Design)](#основы-проектирования-систем-system-design)
...
**System Design** — это процесс проектирования архитектуры системы, которая должна удовлетворять функциональным и нефункциональным требованиям, включая масштабируемость, надёжность, производительность и безопасность.
