...
- [Введение в алертинг](#введение-в-алертинг)
  - [Почему важен алертинг](#почему-важен-алертинг)
  - [Типы алертов](#типы-алертов)
- [Alertmanager архитектура](#alertmanager-архитектура)
  - [Компоненты системы](#компоненты-системы)
  - [Жизненный цикл алерта](#жизненный-цикл-алерта)
- [Настройка Alertmanager](#настройка-alertmanager)
  - [Установка](#установка)
  - [Базовая конфигурация](#базовая-конфигурация)
- [Java-интеграция](#java-интеграция)
  - [Spring Boot Health и метрики](#spring-boot-health-и-метрики)
  - [Отправка алертов в Alertmanager](#отправка-алертов-в-alertmanager)
