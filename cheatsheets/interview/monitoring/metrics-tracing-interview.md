...
(!) Чем метрики отличаются от логов и трейсов?
...
(!) Что такое Micrometer и как он связан с Prometheus?
...
(!) Какие типы метрик бывают (counter, gauge, histogram, summary)?
...
(!) Что такое OpenTelemetry и как он связан с трассировкой?
