...
- Следование `codes of practice` (на 2026 — General-Purpose AI Code of Practice, опубликован 10 июля 2025).
...
**Colorado AI Act (SB 24-205)**, подписан в мае 2024, вступает в силу **30 июня 2026** (дату перенесли с 1 февраля 2026 на спецсессии Колорадо 2025 законом SB 25-318) — **первый комплексный** AI-закон в США.
...
| Texas | **TRAIGA** (HB 149, в силе с 1 января 2026) | Обязательства для high-risk AI |
...
- **California SB 942** — раскрытие AI-сгенерированного контента.
