...
**Где проходит граница с frontier.** Топовые закрытые модели для кода (актуальная линейка Anthropic — `Claude Opus 4.8` / `Sonnet 4.6`, плюс флагманские code-модели OpenAI) всё ещё впереди на сложных задачах — рефакторинг по нескольким файлам, agentic-кодинг с длинной цепочкой шагов. Но на однопроходных задачах (HumanEval, MBPP) open-source разрыв уже закрыл: для автодополнения и генерации отдельной функции локальная модель сопоставима с frontier.
...
- **Reasoning верхнего эшелона**: сложные многошаговые научные / математические задачи всё ещё за топовыми reasoning-моделями закрытых лабораторий (OpenAI o-серия, frontier Anthropic / Google).
...
- **Agentic / задачи с длинным горизонтом**: топовые закрытые модели (актуальная линейка Anthropic — `Claude Opus 4.8` / `Sonnet 4.6`, reasoning-модели OpenAI) превосходят на трейсах в 100 шагов, цепочках tool use.
