...
- [System Design: Доставка маркетплейса (Ozon / Яндекс Маркет / Wildberries)](design-ecommerce-delivery-interview.md) — модели фулфилмента FBO/FBS/DBS/FBY, сортировочные центры, магистраль,…
- [System Design: Распределённый Key-Value Store](design-key-value-store-interview.md) — consistent hashing, replication, quorum (R+W>N), vector clocks, gossip, LSM…
