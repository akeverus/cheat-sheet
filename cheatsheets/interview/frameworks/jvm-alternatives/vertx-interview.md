...
## Q5. Standard vs Worker vs Multi-Threaded Worker?
...
## Q7. (!) Golden rule: don't block the event loop
...
## Q8. (!) executeBlocking — для долгих операций?
...
## Q10. publish vs send vs request?
...
## Q11. Codecs для нестандартных типов?
...
## Q13. (!) Маршрутизация через Vert.x Web?
...
## Q20. Vert.x + RxJava / Mutiny / Kotlin coroutines?
...
## Q22. Cluster managers (Hazelcast, Infinispan, ZK)?
...
## Q25. Test verticles, async tests?
