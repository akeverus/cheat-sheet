...
- На [[behavioral-interview|поведенческом интервью]] часто спрашивают про коучинговые подходы
...
**Связь с другими метриками:** DORA дополняет, а не заменяет бизнес-метрики и метрики удовлетворённости команды (см. Q20). Подробнее о процессах доставки — в [[microservices-interview|вопросах по микросервисной архитектуре]].
...
- [[code-review-practices-interview|Практики code review]] — вопросы по практикам code review
- [[behavioral-interview|Поведенческое интервью]] — STAR-формат и ситуационные вопросы
- [[design-patterns-interview|Design Patterns]] — вопросы по паттернам проектирования
- [[microservices-interview|Микросервисная архитектура]] — архитектура микросервисов
- [[technical-debt-interview|Технический долг]] — управление техдолгом в команде
- [[pipeline-design-interview|Дизайн пайплайнов]] — DevOps и инженерные практики
