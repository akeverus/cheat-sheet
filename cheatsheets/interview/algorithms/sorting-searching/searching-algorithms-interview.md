...
(!) Сводная таблица поисковых алгоритмов?
...
Sentinel Linear Search — оптимизация?
...
(!) Какие подводные камни Binary Search?
