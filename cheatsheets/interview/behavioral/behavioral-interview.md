...
Связано с практиками [[code-review-practices-interview|код-ревью]] -- конфликты часто возникают именно на этапе ревью.
...
Вопрос проверяет проактивность и способность влиять без формальной власти -- ключевой навык для senior-разработчиков. Подробнее о лидерских качествах -- в [[team-leadership-interview|вопросах по лидерству в команде]].
...
Это пересекается с темой [[code-review-practices-interview|практик код-ревью]] -- лидерство часто проявляется именно в улучшении инженерных процессов.
...
Тема trade-off тесно связана с [[technical-debt-interview|управлением техдолгом]].
...
Один из маркеров зрелости разработчика. Обратная связь в [[code-review-practices-interview|код-ревью]] -- частный случай; здесь речь о любой рабочей обратной связи.
...
Тема пересекается с [[team-leadership-interview|лидерством в команде]] -- менторство это одна из ключевых лидерских практик.
...
Проверяет зрелость и фокус на результате, а не на эго. Тесно связано с практиками [[code-review-practices-interview|код-ревью]].
...
Проверяет прагматизм и умение балансировать quality vs. delivery. Тесно связано с [[technical-debt-interview|управлением техдолгом]].
...
Деликатная тема, которая проверяет лидерство и [[team-leadership-interview|умение управлять командной динамикой]].
...
Похож на Q16, но акцент на инициативе и вовлечении других. Показывает [[team-leadership-interview|лидерство без формальной роли]].
...
Подробнее о практиках ревью -- в [[code-review-practices-interview|вопросах по код-ревью]].
...
- [[team-leadership-interview|Лидерство в команде]] — вопросы по лидерству и управлению
- [[code-review-practices-interview|Практики code review]] — практики код-ревью и обратная связь через код
- [[interview-preparation|Подготовка к собеседованию]] — общая стратегия подготовки
- [[technical-debt-interview|Технический долг]] — прагматизм и компромиссы в разработке
- [[system-design-interview|System Design]] — проектирование систем: структурированный ответ
- [[algorithms-interview|Алгоритмы]] — алгоритмическая часть технического интервью
