...
- делит свои ресурсы на **task slots** (по умолчанию `taskmanager.numberOfTaskSlots` = 1; число слотов по числу ядер — частая рекомендация, а не значение по умолчанию);
