...
## Q2. Что нового в instanceof pattern matching?
...
## Q6. Что такое Guarded Patterns (with-clause)?
...
## Q7. Как обрабатывать null в pattern matching?
...
## Q8. Как использовать pattern matching для visitor-паттерна?
...
## Q9. Что такое yield в switch expression?
...
## Q10. Что такое Exhaustiveness Check?
...
## Q11. Как pattern matching работает с generic types?
...
## Q12. Какие практические применения pattern matching?
...
## Q14. Как pattern matching взаимодействует с преобразованием типов?
