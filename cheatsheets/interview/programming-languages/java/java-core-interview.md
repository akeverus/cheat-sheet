...
> - [ ] Метод без явного модификатора (`package-private`) виден только внутри своего класса. | Package-private даёт доступ всем классам **в том же пакете**, а не только внутри своего класса. Видимость только внутри класса — это `private`.
