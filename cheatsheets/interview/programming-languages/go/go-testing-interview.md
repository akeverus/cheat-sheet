...
## Q8. setup/teardown в Go (нет JUnit @Before)?
...
## Q9. (!) Параллельные тесты — t.Parallel?
...
## Q10. (!) Почему в стандарте нет assertions?
...
## Q12. (!) Mocking в Go — общие подходы?
...
## Q13. gomock vs mockery vs ручные моки?
...
## Q14. (!) httptest для HTTP handlers?
...
## Q15. httptest.NewServer для тестирования клиентов?
...
## Q17. (!) b.ResetTimer, b.ReportAllocs?
...
## Q19. benchstat — сравнение результатов?
...
## Q23. Coverage profile — как читать?
...
## Q24. (!) Build tags для разделения unit и integration?
...
## Q27. (!) testing.M — TestMain для setup всего пакета?
