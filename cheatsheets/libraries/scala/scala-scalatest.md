---
title: "ScalaTest"
description: "ScalaTest - это гибкий и мощный фреймворк для тестирования Scala приложений. Предоставляет множество стилей тестирования, богатый набор матчеров и отличную интеграцию с популярными инструментами сборки и CI/CD системами."
tags: ["libraries", "scala", "scala-scalatest"]
