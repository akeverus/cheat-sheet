---
title: "ZIO"
description: "ZIO - это мощная библиотека для функционального программирования в Scala, предоставляющая типобезопасный способ работы с эффектами, ошибками и контекстом. ZIO является альтернативой Cats Effect и других библиотек эффектов."
tags: ["libraries", "scala", "scala-zio"]
