...
- [Создание проекта](#создание-проекта)
  - [Установка](#установка)
- [Установка через sbt](#установка-через-sbt)
  - [Структура проекта](#структура-проекта)
- [Маршрутизация](#маршрутизация)
- [Маршруты](#маршруты)
- [Формат: HTTP_METHOD    PATH    CONTROLLER.METHOD(PARAMETERS)](#формат-http_method-path-controllermethodparameters)
...
- [Фиксированные значения](#фиксированные-значения)
...
- [Сборка production версии](#сборка-production-версии)
- [Создает архив в target/universal/](#создает-архив-в-targetuniversal)
- [Распаковка и запуск](#распаковка-и-запуск)
- [Database](#database)
- [Logging](#logging)
