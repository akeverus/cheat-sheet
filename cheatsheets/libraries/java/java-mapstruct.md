...
- [java-lombok](java-lombok.md) — совместное использование с Lombok
...
- [Базовые аннотации](#базовые-аннотации)
  - [@Mapping](#mapping)
  - [Обратный маппинг через @InheritInverseConfiguration](#обратный-маппинг-через-inheritinverseconfiguration)
- [Вложенные объекты](#вложенные-объекты)
  - [Плоский вложенный](#плоский-вложенный)
  - [Вложенный плоский](#вложенный-плоский)
  - [Маппер внутри маппера](#маппер-внутри-маппера)
...
- [qualifiedByName и @Named](#qualifiedbyname-и-named)
  - [Qualifier через аннотацию](#qualifier-через-аннотацию)
...
- [@MappingTarget: обновление объекта](#mappingtarget-обновление-объекта)
  - [Частичное обновление — только non-null](#частичное-обновление-только-non-null)
...
- [Игнорирование и дефолты](#игнорирование-и-дефолты)
  - [Игнор полей](#игнор-полей)
  - [Игнор неупомянутых target-полей](#игнор-неупомянутых-target-полей)
  - [Строгая проверка неиспользуемых source/target](#строгая-проверка-неиспользуемых-sourcetarget)
  - [Дефолты](#дефолты)
- [Условные маппинги](#условные-маппинги)
  - [@Condition — пропуск поля по условию](#condition-пропуск-поля-по-условию)
  - [Для конкретного свойства](#для-конкретного-свойства)
...
- [java-lombok](java-lombok.md) — совместное использование
