...
- [Группы валидации](#группы-валидации)
  - [GroupSequence — упорядоченные проверки](#groupsequence-упорядоченные-проверки)
- [Custom constraint](#custom-constraint)
  - [Шаг 1: аннотация](#шаг-1-аннотация)
  - [Шаг 2: валидатор](#шаг-2-валидатор)
  - [Шаг 3: использование](#шаг-3-использование)
  - [Динамическое сообщение](#динамическое-сообщение)
...
- [Сообщения об ошибках и i18n](#сообщения-об-ошибках-и-i18n)
  - [Inline-сообщения](#inline-сообщения)
  - [Через messages.properties](#через-messagesproperties)
  - [Локализация](#локализация)
- [Programmatic Validator API](#programmatic-validator-api)
  - [Валидация одного свойства](#валидация-одного-свойства)
  - [Валидация значения без объекта](#валидация-значения-без-объекта)
