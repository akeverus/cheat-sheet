...
- [Code generation](../code-generation/README.md) — Lombok заменяет часть boilerplate
- [Java (язык)](../../languages/java/README.md)
...
- Язык Java — [languages/java](../../languages/java/README.md)
