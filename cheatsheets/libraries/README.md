...
Обзор шпаргалок по библиотекам для **Java**, **Kotlin** и **Scala**.

## Полезные ссылки

[Kotlin Libraries](kotlin/)
[Scala Libraries](scala/)
...
- [Lombok](code-generation/java-lombok.md)
- [MapStruct](code-generation/java-mapstruct.md)
