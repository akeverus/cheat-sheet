...
tags: ["development", "web-backend", "backend-basics"]
...
- [API](../api/README.md) — REST, OpenAPI
- [Frameworks](../../frameworks/java-frameworks/README.md) — Spring и Java-фреймворки
- [Security](../../security/README.md) — OAuth2, Spring Security
...
Подробнее: [Messaging](../messaging/README.md) — Kafka, RabbitMQ.
