...
- [OpenAPI 3.0.x (recommended)](#openapi-30x-recommended)
- [OpenAPI 3.1.x (latest)](#openapi-31x-latest)
  - [**Basic Structure**](#basic-structure)
- [Структура **OpenAPI** документа](#структура-openapi-документа)
  - [**Info Object**](#info-object)
  - [**Servers Object**](#servers-object)
  - [**External Documentation**](#external-documentation)
- [Multiple external docs](#multiple-external-docs)
  - [**Extensions**](#extensions)
- [OpenAPI extensions (x-*)](#openapi-extensions-x)
- [**Paths** и **Operations**](#paths-и-operations)
  - [**Path Templates**](#path-templates)
  - [**Operations**](#operations)
  - [**Tags** и **Grouping**](#tags-и-grouping)
- [Tags for logical grouping](#tags-for-logical-grouping)
- [Operations with tags](#operations-with-tags)
- [**Parameters** и **Request Bodies**](#parameters-и-request-bodies)
  - [**Parameter Types**](#parameter-types)
- [Path parameters](#path-parameters)
- [Query parameters with arrays](#query-parameters-with-arrays)
- [Header parameters](#header-parameters)
  - [**Request Bodies**](#request-bodies)
- [Simple request body](#simple-request-body)
...
- [Complex schemas with polymorphism](#complex-schemas-with-polymorphism)
- [**Security**](#security)
  - [**Security Schemes**](#security-schemes)
- [Global security](#global-security)
- [Operation-level security](#operation-level-security)
  - [**Security Requirements**](#security-requirements)
- [Multiple security requirements (OR logic)](#multiple-security-requirements-or-logic)
- [Specific scopes](#specific-scopes)
...
- [Validate OpenAPI spec with swagger-cli](#validate-openapi-spec-with-swagger-cli)
- [Validate with openapi-cli](#validate-with-openapi-cli)
- [Validate specific version](#validate-specific-version)
- [Use Spectral for advanced linting](#use-spectral-for-advanced-linting)
- [Custom Spectral rules](#custom-spectral-rules)
- [Validate against OpenAPI 3.0 schema](#validate-against-openapi-30-schema)
  - [**Common Validation Issues**](#common-validation-issues)
- [Fix common issues](#fix-common-issues)
- [1. Missing operationId](#1-missing-operationid)
- [2. Invalid parameter reference](#2-invalid-parameter-reference)
- [3. Missing required properties](#3-missing-required-properties)
- [4. Invalid schema references](#4-invalid-schema-references)
- [5. Missing content type](#5-missing-content-type)
