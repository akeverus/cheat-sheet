...
- [Установка и настройка](#установка-и-настройка)
  ...
  - [Multi-node кластер](#multi-node-кластер)
  - [KRaft mode (Kafka без Zookeeper)](#kraft-mode-kafka-без-zookeeper)
...
- [Spring Kafka интеграция](#spring-kafka-интеграция)
  ...
  - [Advanced Spring Kafka](#advanced-spring-kafka)
...
- [Безопасность](#безопасность)
  - [SSL/TLS шифрование](#ssl-tls-шифрование)
  - [SASL аутентификация](#sasl-аутентификация)
  - [ACL авторизация](#acl-авторизация)
- [Мониторинг и управление](#мониторинг-и-управление)
  - [Metrics](#metrics)
  - [Consumer Lag мониторинг](#consumer-lag-мониторинг)
  - [Kafka Admin Client](#kafka-admin-client)
- [Производительность и оптимизация](#производительность-и-оптимизация)
  - [Producer оптимизация](#producer-оптимизация)
  - [Consumer оптимизация](#consumer-оптимизация)
  - [Cluster оптимизация](#cluster-оптимизация)
- [Тестирование](#тестирование)
  - [Модульное тестирование](#модульное-тестирование)
  - [Интеграционное тестирование](#интеграционное-тестирование)
- [Решение проблем](#решение-проблем)
  - [Распространенные проблемы](#распространенные-проблемы)
  - [Debug инструменты](#debug-инструменты)
...
- [Заключение](#заключение)
  - [Ключевые преимущества Kafka:](#ключевые-преимущества-kafka)
