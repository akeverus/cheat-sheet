...
- **Оптимизация hot-path:** `Double-Checked Locking` -> `Read-Write Lock` -> профилирование в [../../monitoring/apm/README.md](../../monitoring/apm/README.md).

## Куда идти дальше

- Реактивные стеки — [../../languages/java/java-concurrency-advanced.md](../../languages/java/java-concurrency-advanced.md)
- Архитектура и масштабирование — [../../architecture/scalability/README.md](../../architecture/scalability/README.md)
- Очереди и стриминг — [../../development/messaging/README.md](../../development/messaging/README.md)
