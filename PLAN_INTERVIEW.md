...
| 5 | `project-reactor` | reactive | 48 | 47 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q10 audited (R8 chunk1). Baseline худший после dp/sql: CORRECT_LONGEST 0.917, STYLE 0.92, AVG 2.425, seq=48, freshness отсутствовал. Подняты все 30 дистракторов (25 text + 5 dict-spec); reviewer 10/10 VERDICT, MULTI/BSM нет; фиксы: Q4-A OOM-retry абсурд → буферизация-миф; Q6-A/Q7-D enumeration-parity (отравленные перечисления); Q10-C/D дубль → Stream.generate-перенос; Q9-C кроет оба метода; кванторы Q5 смягчены. После chunk1: LONGEST 0.75, AVG 1.871, STYLE 0.76 (интерим). Сайдкары созданы (freshness 6 claims). ЗАПАС AVG огромный — wrong-пул наращивать ещё ~8 сл/опцию. ОСТАЛОСЬ: Q11-Q48 (4 чанка) + POS (seq=48); skel-gate PASS 48/48 (LLM-SKEL ещё нужен) |
