...
| 5 | `project-reactor` | reactive | 48 | 47 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q20 audited (R8 chunk1 64e1a8d7 + chunk2 098484fb). Baseline худший после dp/sql: LONGEST 0.917, STYLE 0.92, AVG 2.425, seq=48, freshness отсутствовал. Подняты 60 дистракторов (49 text + 11 dict-spec); blind-reviewer 20/20 VERDICT; chunk2-фиксы: Q11-A/Q18-A swap-карикатуры → мифы, Q12-A+Q19-A кросс-дубль «синонимы» → prefetch-миф и zip-padding, Q14-C DUP+generics-tell, Q15-B/Q16-A anti-enumeration-tell, Q17-D пре-эмпт. SKEL-пасс: 11 HARD-блоков Q1-Q20 выровнены (Q1-Q20 HARD-чист). Интерим: LONGEST 0.562, AVG 1.463, STYLE 0.715. ⚠️ SKEL-прогон 68444a1b: битая разметка починена (0f66cadf: 12 опций reactor + 7 dp из 68444a1b^), но 36 correct-опций reactor деградированы (вырезаны сигнатуры/глоссы/скобки) — ждёт решения пользователя о восстановлении. ОСТАЛОСЬ: Q21-Q48 (3 чанка; там же re-raise correct-точности после решения) + POS (seq=48) |
