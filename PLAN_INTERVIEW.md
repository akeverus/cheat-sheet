...
| 5 | `project-reactor` | reactive | 48 | 47 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q40 audited (R8 chunks 1-4). Baseline: LONGEST 0.917, STYLE 0.92, AVG 2.425, seq=48. Подняты 120 дистракторов (104 text + 16 dict-spec); blind-reviewer 40/40 VERDICT. Chunks 3-4: 18 correct-восстановлений из 68444a1b^ (CORRECT_EDITS whitelist, деградация SKEL-прогона доказана по теории). После chunk4: LONGEST 0.188 PASS, AVG 0.976 PASS, STYLE 0.505 (length-guess 0.21; хвост по code-spans), DUP 0, CV 0.162, SKEL Q1-Q40 HARD-чист. ОСТАЛОСЬ: Q41-Q48 (финальный чанк) + POS (seq=48) |
