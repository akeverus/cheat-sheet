...
| 8 | `application-security` | security | 45 | 45 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | R8 c1 Q1-Q10: 30 raised (text-only), blind 10/10 (Q3/Q6/Q9 verdict 4); фиксы: Q1 тон-асимметрия, Q2 зеркало «это другое», Q4-C де-карикатура, Q5 паритет перечислений, Q10 мини-определения; hard 42→33 (Q1-Q10 =0), CV-запас 0.14-0.24 заложен; LONGEST 0.933→0.733, AVG 1.798→1.589 (интерим); freshness создан; ОСТАЛОСЬ Q11-Q45 + POS |
