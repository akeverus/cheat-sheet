...
| `C-FRM` | correct не выделяется длиной, структурой, тоном, punctuation, code-density |
...
| `W-FRM` | wrong options сопоставимы с correct по форме и насыщенности |
...
- все обязательные колонки мастер-таблицы `✅`;
