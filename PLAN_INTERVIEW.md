...
| 4 | `sql` | databases | 53 | 47 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q20 audited (R8 chunk1-2). Chunk2: подняты 21 дистрактор+2 dict-spec; НАХОДКА — существующий BSM Q16-B (текст «MERGE делает INSERT и UPDATE за проход» был защитимо-истинным, переписан под sections-заблуждение); correct-precision Q14-B (PG/MySQL допускают GROUP BY-алиасы как расширение, whitelist); Q16-C де-карикатура (DO NOTHING→sequence-миф), Q20-C развод с A (→«RETURNING нельзя в CTE»). Reviewer 8/8 VERDICT, MULTI 0. ФАЙЛ УЖЕ В PASS: CORRECT_LONGEST 0.377, STYLE 0.387, CORRECT_WRONG_AVG 1.042, CV 0.168, DUP 0, freshness 12 claims. ОСТАЛОСЬ: Q21-Q53 (чанки 3-6) + POS de-cycle (seq=53) |
