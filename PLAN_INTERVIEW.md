...
_Сводка: сидеров=318 · ✅DONE=9 · 🔄WIP=0 · ⬜QUEUED=309 · остаток визуально-палящих блоков (по не-DONE)=8889. Проверка каждого файла — против `docs/golden-examples.md`._
...
| 252 | `spring-cache` | spring | 18 | 18 | ⬜ |
| 253 | `strangler-fig` | architecture | 18 | 18 | ⬜ |
| 254 | `linkerd` | devops | 20 | 17 | ✅ |
| 255 | `kotlin-flow` | kotlin | 17 | 17 | ⬜ |
| 256 | `rest-maturity` | api | 17 | 17 | ⬜ |
| 257 | `design-uber` | system-design | 30 | 16 | ⬜ |
| 258 | `rag` | ai-ml | 30 | 16 | ⬜ |
| 259 | `spring-ai` | spring | 18 | 16 | ⬜ |
| 260 | `java-reflection` | java | 16 | 16 | ⬜ |
| 261 | `spring-data-jdbc` | spring | 16 | 16 | ⬜ |
| 262 | `spring-events` | spring | 16 | 16 | ⬜ |
| 263 | `spring-scheduling` | spring | 16 | 16 | ⬜ |
| 264 | `spring-validation` | spring | 16 | 16 | ⬜ |
| 265 | `aws` | cloud | 34 | 15 | ⬜ |
| 266 | `design-typeahead` | system-design | 30 | 15 | ⬜ |
| 267 | `spring-testing` | spring | 16 | 15 | ⬜ |
| 268 | `graalvm-native` | jvm | 15 | 15 | ⬜ |
| 269 | `hibernate-caching` | databases | 15 | 15 | ⬜ |
| 270 | `java-optional` | java | 15 | 15 | ⬜ |
| 271 | `java-pattern-matching` | java | 15 | 15 | ⬜ |
| 272 | `java-records` | java | 15 | 15 | ⬜ |
| 273 | `java-virtual-threads` | java | 15 | 15 | ⬜ |
| 274 | `junit` | testing | 15 | 15 | ⬜ |
| 275 | `kotlin-sealed-classes` | kotlin | 15 | 15 | ⬜ |
| 276 | `kotlin-spring` | kotlin | 15 | 15 | ⬜ |
| 277 | `rest-assured` | testing | 15 | 15 | ⬜ |
| 278 | `spring-async` | spring | 15 | 15 | ⬜ |
| 279 | `spring-boot-3-migration` | spring | 15 | 15 | ⬜ |
| 280 | `spring-graphql` | spring | 15 | 15 | ⬜ |
| 281 | `spring-integration` | spring | 15 | 15 | ⬜ |
| 282 | `spring-kafka` | spring | 15 | 15 | ⬜ |
| 283 | `spring-messaging` | spring | 15 | 15 | ⬜ |
| 284 | `spring-modulith` | spring | 15 | 15 | ⬜ |
| 285 | `spring-r2dbc` | spring | 15 | 15 | ⬜ |
| 286 | `spring-session` | spring | 15 | 15 | ⬜ |
| 287 | `spring-state-machine` | spring | 15 | 15 | ⬜ |
| 288 | `spring-transaction` | spring | 15 | 15 | ⬜ |
| 289 | `spring-vault` | spring | 15 | 15 | ⬜ |
| 290 | `agentic-patterns` | ai-ml | 30 | 14 | ⬜ |
| 291 | `resilience4j` | spring | 20 | 14 | ✅ |
| 292 | `hibernate-jpql-criteria` | databases | 16 | 14 | ⬜ |
| 293 | `kotlin-value-classes` | kotlin | 15 | 14 | ⬜ |
| 294 | `spring-rest-client` | spring | 13 | 13 | ⬜ |
| 295 | `hibernate-relationships` | databases | 15 | 11 | ⬜ |
| 296 | `java-completable-future` | java | 15 | 11 | ⬜ |
| 297 | `mentoring` | leadership | 25 | 10 | ⬜ |
| 298 | `java-22-25` | java | 22 | 10 | ⬜ |
| 299 | `api-versioning` | api | 20 | 10 | ✅ |
| 300 | `algorithms` | algorithms | 16 | 7 | ⬜ |
| 301 | `crac` | jvm | 16 | 6 | ⬜ |
