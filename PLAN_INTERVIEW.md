...
_Сводка: сидеров=318 · ✅DONE=10 · 🔄WIP=0 · ⬜QUEUED=308 · остаток визуально-палящих блоков (по не-DONE)=8871. Проверка каждого файла — против `docs/golden-examples.md`._
...
| 252 | `strangler-fig` | architecture | 18 | 18 | ⬜ |
| 253 | `linkerd` | devops | 20 | 17 | ✅ |
| 254 | `kotlin-flow` | kotlin | 17 | 17 | ⬜ |
| 255 | `rest-maturity` | api | 17 | 17 | ⬜ |
| 256 | `design-uber` | system-design | 30 | 16 | ⬜ |
| 257 | `rag` | ai-ml | 30 | 16 | ⬜ |
| 258 | `spring-ai` | spring | 18 | 16 | ⬜ |
| 259 | `java-reflection` | java | 16 | 16 | ⬜ |
| 260 | `spring-data-jdbc` | spring | 16 | 16 | ⬜ |
| 261 | `spring-events` | spring | 16 | 16 | ⬜ |
| 262 | `spring-scheduling` | spring | 16 | 16 | ⬜ |
| 263 | `spring-validation` | spring | 16 | 16 | ⬜ |
| 264 | `aws` | cloud | 34 | 15 | ⬜ |
| 265 | `design-typeahead` | system-design | 30 | 15 | ⬜ |
| 266 | `spring-testing` | spring | 16 | 15 | ⬜ |
| 267 | `graalvm-native` | jvm | 15 | 15 | ⬜ |
| 268 | `hibernate-caching` | databases | 15 | 15 | ⬜ |
| 269 | `java-optional` | java | 15 | 15 | ⬜ |
| 270 | `java-pattern-matching` | java | 15 | 15 | ⬜ |
| 271 | `java-records` | java | 15 | 15 | ⬜ |
| 272 | `java-virtual-threads` | java | 15 | 15 | ⬜ |
| 273 | `junit` | testing | 15 | 15 | ⬜ |
| 274 | `kotlin-sealed-classes` | kotlin | 15 | 15 | ⬜ |
| 275 | `kotlin-spring` | kotlin | 15 | 15 | ⬜ |
| 276 | `rest-assured` | testing | 15 | 15 | ⬜ |
| 277 | `spring-async` | spring | 15 | 15 | ⬜ |
| 278 | `spring-boot-3-migration` | spring | 15 | 15 | ⬜ |
| 279 | `spring-graphql` | spring | 15 | 15 | ⬜ |
| 280 | `spring-integration` | spring | 15 | 15 | ⬜ |
| 281 | `spring-kafka` | spring | 15 | 15 | ⬜ |
| 282 | `spring-messaging` | spring | 15 | 15 | ⬜ |
| 283 | `spring-modulith` | spring | 15 | 15 | ⬜ |
| 284 | `spring-r2dbc` | spring | 15 | 15 | ⬜ |
| 285 | `spring-session` | spring | 15 | 15 | ⬜ |
| 286 | `spring-state-machine` | spring | 15 | 15 | ⬜ |
| 287 | `spring-transaction` | spring | 15 | 15 | ⬜ |
| 288 | `spring-vault` | spring | 15 | 15 | ⬜ |
| 289 | `agentic-patterns` | ai-ml | 30 | 14 | ⬜ |
| 290 | `resilience4j` | spring | 20 | 14 | ✅ |
| 291 | `hibernate-jpql-criteria` | databases | 16 | 14 | ⬜ |
| 292 | `kotlin-value-classes` | kotlin | 15 | 14 | ⬜ |
| 293 | `spring-rest-client` | spring | 13 | 13 | ⬜ |
| 294 | `hibernate-relationships` | databases | 15 | 11 | ⬜ |
| 295 | `java-completable-future` | java | 15 | 11 | ⬜ |
| 296 | `mentoring` | leadership | 25 | 10 | ⬜ |
| 297 | `java-22-25` | java | 22 | 10 | ⬜ |
| 298 | `api-versioning` | api | 20 | 10 | ✅ |
| 299 | `algorithms` | algorithms | 16 | 7 | ⬜ |
| 300 | `spring-cache` | spring | 18 | 6 | ✅ |
| 301 | `crac` | jvm | 16 | 6 | ⬜ |
| 302 | `micrometer` | monitoring | 20 | 5 | ⬜ |
| 303 | `mutation-testing` | testing | 20 | 5 | ⬜ |
| 304 | `langchain4j` | ai-ml | 18 | 5 | ⬜ |
