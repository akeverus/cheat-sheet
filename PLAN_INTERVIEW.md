...
| 6 | `hibernate` | databases | 50 | 46 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q20 audited (R8 chunks 1-2). Baseline: LONGEST 0.76, AVG 1.617, STYLE 0.81, seq=50, skel hard=29. Подняты 57 дистракторов (49 text + 8 dict-spec); blind-reviewer 20/20 VERDICT; 68444a1b файл не трогал. Chunk2-фиксы: DUP Q14/Q19 развязаны, Q20-B де-карикатура, Q18-C абсолютив снят. После chunk2: LONGEST 0.42, AVG 1.164, STYLE 0.48 (интерим), SKEL Q1-Q20 hard=0 (остаток 17 — зона Q21-Q50), freshness 12 claims. ОСТАЛОСЬ: Q21-Q50 + POS |
