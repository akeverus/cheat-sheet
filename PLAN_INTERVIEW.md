...
| 14 | `tls-ssl` | security | 45 | 45 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | R8 c1-c3 (Q1-Q30, 90 дистракторов, blind clean): file-hard 42→25→~18; Q11 parity-fix по фидбеку; c3 (Q21-Q30) — все 10 блоков имели грубый Q11-дефект (correct лоне-длиннее ×2.5-3), подняты все 30 дистракторов до full mental models, 3-проходный blind вычистил guessable_by_form на Q24/Q29/Q30; Q30 остаточный intrinsic tell (задокументирован). Остаток c4-c5, POS (SEQ=45), FINAL |
