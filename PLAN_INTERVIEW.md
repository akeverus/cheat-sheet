...
| 4 | `sql` | databases | 53 | 47 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q30 audited (R8 chunk1-3). Chunk3: подняты 22 дистрактора+2 dict-spec (Q24/Q28 уже в паритете); reviewer 8/8 VERDICT, MULTI 0; фиксы — Q21-C дубль outer→миф «FULL=CROSS», Q22-D мета-пара с A→миф «диалектная особенность», Q27-B кванторы против functional-dependency, Q30-C перефраз (дубль с Q33-B, DUP 3→0). Гейты: CORRECT_LONGEST 0.264, STYLE 0.354, AVG 0.952, CV 0.151 (⚠ близко к 0.14 — чанкам 4-6 не выравнивать длины), DUP 0. ОСТАЛОСЬ: Q31-Q53 (чанки 4-6) + POS de-cycle (seq=53) |
