...
| 2 | `design-patterns` | design-patterns | 48 | 48 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q38/48 (R8 chunk1-4): Golden AP#1 — подняты дистракторы, correct-longest 38/38→11/38, CORRECT_LONGEST_RATE ВПЕРВЫЕ PASS (0.354). De-caricature Q4-B, Q30-D. Reviewer поймал 2 BSM (Q6-C,Q9-B). Correct-precision Q20-D. Факты GoF/JDK/Spring verified (Template=наследование, Visitor double-dispatch, Integer.valueOf=Flyweight, @Transactional=Proxy, DI-vs-SL, GoF-vs-Spring singleton). STYLE 0.84→0.493, DUP ok, CV 0.188. Дальше Q39-Q48+POS |
