...
| 6 | `hibernate` | databases | 50 | 46 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q10 audited (R8 chunk1). Baseline: LONGEST 0.76, AVG 1.617, STYLE 0.81, seq=50, skel hard=29, freshness отсутствовал; 68444a1b файл не трогал (correct-восстановления не нужны). Подняты 27 дистракторов (24 text + 3 dict-spec: Q4-C «Session=HTTP-сессия», Q6-C «Dialect вместо драйвера», Q10-D инверсия null/exception); Q5 оставлен (terse-parallel golden). Blind-reviewer 10/10 VERDICT; DUP Q4/Q10 развязаны, Q6-C де-карикатура. После chunk1: LONGEST 0.60, AVG 1.355, STYLE 0.66 (интерим), SKEL Q1-Q10 hard=0, сайдкары созданы (freshness 7 claims). ОСТАЛОСЬ: Q11-Q50 + POS |
