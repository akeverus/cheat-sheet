...
| 6 | `hibernate` | databases | 50 | 46 | ◐ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ◐ Q1-Q30 audited (R8 chunks 1-3). Baseline: LONGEST 0.76, AVG 1.617, STYLE 0.81, seq=50, skel hard=29. Подняты 87 дистракторов (71 text + 16 dict-spec); blind-reviewer 30/30 VERDICT; 68444a1b файл не трогал. Chunk3-фиксы: DUP wrong-wrong Q24/Q27 развязаны, mirror-DUP Q21/Q22/Q23/Q30 уведены на другие оси, CAR Q21-D/Q25-D де-карикатура, BSM Q25/Q29 закрыт смягчением кванторов. После chunk3: LONGEST 0.26, AVG 1.029, STYLE 0.418 (интерим), SKEL Q1-Q30 hard=0 (остаток 11 — зона Q31-Q50), freshness 18 claims. ОСТАЛОСЬ: Q31-Q50 + POS |
