...
3. **mermaid отменён полностью** (LANE 8A). Критерий C6 старого ULTRATHINK («Mermaid diagrams 1–3 на файл») **ОТМЕНЁН и инвертирован**: диаграмм быть не должно; архитектура/flow — русской прозой + markdown-списками/таблицами.
...
- **C6** ~~Mermaid diagrams~~ → **ОТМЕНЕНО** (§1.3): диаграмм нет; архитектура/flow — прозой + списками/таблицами.
